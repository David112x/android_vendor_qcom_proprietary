...
public:
   ...
   void setAnotherActiveDefaultCallPresent(bool val) {isAnyActiveDefaultCall = val;}
   bool getAnotherActiveDefaultCallPresent() {return isAnyActiveDefaultCall;}
private:
  ...
  bool ignoreRilTech;
  bool isAnyActiveDefaultCall; //set to TRUE if there is a connected call with apntype = default
};
