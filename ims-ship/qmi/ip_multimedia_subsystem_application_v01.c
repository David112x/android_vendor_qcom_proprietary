...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/imsa/src/ip_multimedia_subsystem_application_v01.c#27 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t imsa_get_registration_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsa_get_registration_status_resp_msg_v01, uri_list) - QMI_IDL_OFFSET16RELATIVE(imsa_get_registration_status_resp_msg_v01, uri_list_valid)),
  0x15,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsa_get_registration_status_resp_msg_v01, registration_rat) - QMI_IDL_OFFSET16RELATIVE(imsa_get_registration_status_resp_msg_v01, registration_rat_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(imsa_get_registration_status_resp_msg_v01, registration_rat)
};
...
static const uint8_t imsa_get_service_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, vs_service_rat) - QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, vs_service_rat_valid)),
  0x19,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, vs_service_rat),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, callcomposer_service_status) - QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, callcomposer_service_status_valid)),
  0x1A,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, callcomposer_service_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, callcomposer_service_rat) - QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, callcomposer_service_rat_valid)),
  0x1B,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, callcomposer_service_rat),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_status) - QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_status_valid)),
  0x1C,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_rat) - QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_rat_valid)),
  0x1D,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_service_status_resp_msg_v01, ussd_service_rat)
};
...
static const uint8_t imsa_ind_reg_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, gps_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, gps_config_valid)),
  0x1F,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, gps_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, modem_feature_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, modem_feature_config_valid)),
  0x20,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, modem_feature_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, call_info_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, call_info_config_valid)),
  0x21,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, call_info_config),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, token_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, token_config_valid)),
  0x22,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, token_config)
};
...
static const uint8_t imsa_registration_status_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsa_registration_status_ind_msg_v01, uri_list) - QMI_IDL_OFFSET16RELATIVE(imsa_registration_status_ind_msg_v01, uri_list_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsa_registration_status_ind_msg_v01, registration_rat) - QMI_IDL_OFFSET16RELATIVE(imsa_registration_status_ind_msg_v01, registration_rat_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(imsa_registration_status_ind_msg_v01, registration_rat)
};
...
static const uint8_t imsa_service_status_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, vs_service_rat) - QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, vs_service_rat_valid)),
  0x19,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, vs_service_rat),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, callcomposer_service_status) - QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, callcomposer_service_status_valid)),
  0x1A,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, callcomposer_service_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, callcomposer_service_rat) - QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, callcomposer_service_rat_valid)),
  0x1B,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, callcomposer_service_rat),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_status) - QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_status_valid)),
  0x1C,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_rat) - QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_rat_valid)),
  0x1D,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_service_status_ind_msg_v01, ussd_service_rat)
};
...
static const uint8_t imsa_pdp_status_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_pdp_status_ind_msg_v01, pdp_failure_network) - QMI_IDL_OFFSET8(imsa_pdp_status_ind_msg_v01, pdp_failure_network_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_pdp_status_ind_msg_v01, pdp_failure_network),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_pdp_status_ind_msg_v01, apninfo) - QMI_IDL_OFFSET8(imsa_pdp_status_ind_msg_v01, apninfo_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
  QMI_IDL_OFFSET8(imsa_pdp_status_ind_msg_v01, apninfo),
  IMSA_APN_NAME_LEN_V01
};
...
static const uint8_t imsa_get_pdp_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_pdp_status_resp_msg_v01, pdp_failure_network) - QMI_IDL_OFFSET8(imsa_get_pdp_status_resp_msg_v01, pdp_failure_network_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_get_pdp_status_resp_msg_v01, pdp_failure_network),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_get_pdp_status_resp_msg_v01, apninfo) - QMI_IDL_OFFSET8(imsa_get_pdp_status_resp_msg_v01, apninfo_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
  QMI_IDL_OFFSET8(imsa_get_pdp_status_resp_msg_v01, apninfo),
  IMSA_APN_NAME_LEN_V01
};
...
static const uint8_t imsa_gps_error_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_gps_error_ind_msg_v01, gps_error_reason),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_gps_error_ind_msg_v01, lock_state) - QMI_IDL_OFFSET8(imsa_gps_error_ind_msg_v01, lock_state_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsa_gps_error_ind_msg_v01, lock_state)
};
...
static const uint8_t imsa_call_info_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_call_info_ind_msg_v01, rat_info)
};

static const uint8_t imsa_acs_token_req_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_acs_token_req_ind_msg_v01, token_type),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_acs_token_req_ind_msg_v01, token_reason),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_acs_token_req_ind_msg_v01, token_requestid) - QMI_IDL_OFFSET8(imsa_acs_token_req_ind_msg_v01, token_requestid_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsa_acs_token_req_ind_msg_v01, token_requestid)
};
...
static const qmi_idl_message_table_entry imsa_message_table_v01[] = {
  ...
  {sizeof(imsa_gps_error_ind_msg_v01), imsa_gps_error_ind_msg_data_v01},
  {sizeof(imsa_modem_feature_info_ind_v01), imsa_modem_feature_info_ind_data_v01},
  {sizeof(imsa_call_info_ind_msg_v01), imsa_call_info_ind_msg_data_v01},
  {sizeof(imsa_acs_token_req_ind_msg_v01), imsa_acs_token_req_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry imsa_service_command_messages_v01[] = {
  ...
  {QMI_IMSA_IND_REG_REQ_V01, QMI_IDL_TYPE16(0, 4), 76},
  ...
  {QMI_IMSA_SET_GEO_LOC_REQ_V01, QMI_IDL_TYPE16(0, 21), 542},
  ...
  {QMI_IMSA_RESET_IMS_BLOCKING_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 38), 8},
  {QMI_IMSA_GET_VIRTUAL_LINE_REQ_V01, QMI_IDL_TYPE16(0, 40), 23}
};
...
static const qmi_idl_service_message_table_entry imsa_service_response_messages_v01[] = {
  ...
  {QMI_IMSA_GET_REGISTRATION_STATUS_RSP_V01, QMI_IDL_TYPE16(0, 1), 7979},
  {QMI_IMSA_GET_SERVICE_STATUS_RSP_V01, QMI_IDL_TYPE16(0, 3), 105},
  {QMI_IMSA_IND_REG_RSP_V01, QMI_IDL_TYPE16(0, 5), 7},
  {QMI_IMSA_GET_PDP_STATUS_RSP_V01, QMI_IDL_TYPE16(0, 12), 137},
  ...
  {QMI_IMSA_RESET_IMS_BLOCKING_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 39), 7},
  {QMI_IMSA_GET_VIRTUAL_LINE_RSP_V01, QMI_IDL_TYPE16(0, 41), 2059}
};

static const qmi_idl_service_message_table_entry imsa_service_indication_messages_v01[] = {
  {QMI_IMSA_REGISTRATION_STATUS_IND_V01, QMI_IDL_TYPE16(0, 6), 7972},
  {QMI_IMSA_SERVICE_STATUS_IND_V01, QMI_IDL_TYPE16(0, 7), 98},
  {QMI_IMSA_RAT_HANDOVER_STATUS_IND_V01, QMI_IDL_TYPE16(0, 8), 150},
  {QMI_IMSA_PDP_STATUS_IND_V01, QMI_IDL_TYPE16(0, 9), 130},
  ...
  {QMI_IMSA_GPS_INFO_IND_V01, QMI_IDL_TYPE16(0, 45), 11},
  {QMI_IMSA_MODEM_FEATURE_INFO_IND_V01, QMI_IDL_TYPE16(0, 46), 11},
  {QMI_IMSA_CALL_INFO_IND_V01, QMI_IDL_TYPE16(0, 47), 7},
  {QMI_IMSA_ACS_TOKEN_REQ_IND_V01, QMI_IDL_TYPE16(0, 48), 21}
};
