...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7.9/imss/api/ip_multimedia_subsystem_settings_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define IMSS_V01_IDL_MINOR_VERS 0x5B
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSS_V01_MAX_MESSAGE_ID 0x00A9
/**
    @}
  */
...
#define IMS_SETTINGS_XML_DATA_LEN_MAX_V01 1024
#define IMS_SETTINGS_XML_STRING_LEN_MAX_V01 127
#define IMS_SETTINGS_TOKEN_LEN_V01 512
/**
    @}
  */
...
/** @addtogroup imss_qmi_enums
  ...
  */
typedef enum {
  IMS_HANDOVER_WLAN_EPS_IN_ROAMING_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_SETTINGS_HO_WLAN_EPS_ROAMING_IDLE_ONLY_V01 = 0, /**<  Roaming is allowed in idle only between WLAN and EPS  */
  IMS_SETTINGS_HO_WLAN_EPS_ROAMING_ENABLE_ALL_V01 = 1, /**<  Roaming is enabled between WLAN and EPS */
  IMS_SETTINGS_HO_WLAN_EPS_ROAMING_DISABLE_ALL_V01 = 2, /**<  Roaming is disabled between WLAN and EPS */
  IMS_HANDOVER_WLAN_EPS_IN_ROAMING_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}ims_handover_wlan_eps_in_roaming_v01;
/**
    @}
  */
...
/** @addtogroup imss_qmi_enums
  ...
  */
typedef enum {
  IMS_SETTINGS_TOKEN_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_APP_TOKEN_V01 = 0, /**<  APP token */
  IMS_AUTH_TOKEN_V01 = 1, /**<  Auth token  */
  IMS_CLIENT_TOKEN_V01 = 2, /**<  Client token  */
  IMS_SETTINGS_TOKEN_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}ims_settings_token_type_v01;
/**
    @}
  */
...
/** @addtogroup imss_qmi_enums
  ...
  */
typedef enum {
  IMS_SETTINGS_TOKEN_STATUS_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_TOKEN_SUCCESS_V01 = 0, /**<  Success  */
  IMS_TOKEN_FAILED_V01 = 1, /**<  Failed  */
  IMS_TOKEN_IN_PROGRESS_V01 = 2, /**<  In progress */
  IMS_TOKEN_SECURITY_FAILURE_V01 = 3, /**<  Security failure */
  IMS_TOKEN_ILLEGAL_PARAM_V01 = 4, /**<  Illegal parameter  */
  IMS_TOKEN_ILLEGAL_STATE_V01 = 5, /**<  Illegal state  */
  IMS_TOKEN_NULL_CURSOR_V01 = 6, /**<  Null cursor  */
  IMS_TOKEN_APP_NOT_AVAILABLE_V01 = 7, /**<  Application not available  */
  IMS_SETTINGS_TOKEN_STATUS_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}ims_settings_token_status_v01;
/**
    @}
  */
...
#define IMS_SETTINGS_OMADM_SERVICES_VONR_RESTRICT_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x800ull) /**<  VoNR service restrict  */
#define IMS_SETTINGS_OMADM_SERVICES_VINR_RESTRICT_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x1000ull) /**<  VINR service restrict  */
#define IMS_SETTINGS_OMADM_SERVICES_VONR_RESTRICT_ROAMING_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x2000ull) /**<  VoNR service restrict roaming  */
#define IMS_SETTINGS_OMADM_SERVICES_VINR_RESTRICT_ROAMING_BIT_MASK_V01 ((ims_settings_omadm_services_type_mask_v01)0x4000ull) /**<  VINR service restrict roaming  */
...
typedef struct {
  ...
  */
  ...
  uint8_t seq_num;
  /**<   Starts with 1, increments by 1, the last seq_num is the same as the total 
      segments composing the content of seg_count. If same seq_num and ref_num 
...
/** @addtogroup imss_qmi_aggregates
    @{
  */
/**  Structures required by XML data for handling fragemented packets
 
 */
typedef struct {

  uint16_t total_message_size;
  /**<   Total XML size in bytes. 
    */

  uint16_t current_message_sequence_number;
  /**<   Current message sequence number.
         sequence number start from one and have linear increment
    */

  uint16_t highest_message_sequence_number;
  /**<   Highest message sequence number.
         Highest sequence number of fragmented
    */
}ims_settings_xml_optional_data_v01;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  /* Optional */
  /*  Handover Configuration between WLAN and EPS in Roaming */
  uint8_t wlan_eps_ho_in_roaming_valid;  /**< Must be set to true if wlan_eps_ho_in_roaming is being passed */
  ims_handover_wlan_eps_in_roaming_v01 wlan_eps_ho_in_roaming;
  /**<   Handover in roaming. \n
	   Default value is IMS_SETTINGS_HO_WLAN_EPS_ROAMING_IDLE_ONLY(0). \n
    */
...
typedef struct {
  ...
  /* Optional */
  /*  Timer of Emergency Registration */
  uint8_t timer_emerg_reg_valid;  /**< Must be set to true if timer_emerg_reg is being passed */
  uint16_t timer_emerg_reg;
  /**<    The timer_emerg_reg is the maximum time from deciding that 
          an emergency service is to be established via the IM CN subsystem 
          until completion of the emergency registration procedure. Upon 
          timer expiry the UE considers the emergency REGISTER request attempt 
          as failed. The timer value is in seconds. The configurable value 
...
typedef struct {
  ...
  /**<    The timer_emerg_reg is the maximum time from deciding that 
          ...
          until completion of the emergency registration procedure. Upon 
          timer expiry the UE considers the emergency REGISTER request attempt 
          as failed. The timer value is in seconds.
    */
...
typedef struct {
  ...
  /**<   Enable or disable carrier configuration.
         Values: \n
        - TRUE (1) -- Enable  \n
        - FALSE (0) -- Disable (default)
    */
  ...
  /* Optional */
  /*  Call Composer Config */
  uint8_t mmtel_call_composer_config_enabled_valid;  /**< Must be set to true if mmtel_call_composer_config_enabled is being passed */
  uint8_t mmtel_call_composer_config_enabled;
  /**<   Enable or disable mmtel call composer configuraton.
         Values: \n
        - FALSE(0) -- Disable (default) \n
        - TRUE (1) -- Enable
    */
  ...
  /* Optional */
  /*  Options Config */
  uint8_t options_config_enabled_valid;  /**< Must be set to true if options_config_enabled is being passed */
  uint8_t options_config_enabled;
  /**<   Enable or disable options configuration.
         Values: \n
        - FALSE(0) -- Disable (default) \n
        - TRUE (1) -- Enable
    */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Sets up the autoconfig token. */
typedef struct {

  /* Mandatory */
  /*  Token Type */
  ims_settings_token_type_v01 token_type;
  /**<   Values:\n
      - IMS_APP_TOKEN (0) --  APP token
      - IMS_AUTH_TOKEN (1) --  Auth token 
      - IMS_CLIENT_TOKEN (2) --  Client token 
 */

  /* Mandatory */
  /*  Token Data */
  uint32_t token_len;  /**< Must be set to # of elements in token */
  uint8_t token[IMS_SETTINGS_TOKEN_LEN_V01];
  /**<   Request token data. 
    */

  /* Optional */
  /*  Token Request ID Data */
  uint8_t token_requestid_valid;  /**< Must be set to true if token_requestid is being passed */
  uint32_t token_requestid;
  /**<   Request ID for token.
    */
}ims_settings_set_acs_token_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Sets up the autoconfig token. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members: \n
       ...
       - qmi_error_type  -- Error code. Possible error code values are described 
                            ...
                            definition.
    */
}ims_settings_set_acs_token_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Updates current token status. */
typedef struct {
 ...
 */
  ...
  /* Mandatory */
  /*  Token Length */
  ims_settings_token_status_v01 token_status;
  /**<   Values:\n
     - length of token
  */
  ...
  uint32_t token_requestid;
  /**<   Request ID for token. */
}ims_settings_update_acs_token_status_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Updates current token status. */
typedef struct {
  ...
  /**<   Contains the following data members: \n
       ...
       - qmi_error_type  -- Error code. Possible error code values are described 
                            ...
                            definition.
    */
}ims_settings_update_acs_token_status_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Sets custom XML payload from the requesting control point. */
typedef struct {

  /* Mandatory */
  /*  Custom XML Payload Name */
  char custom_xml_payload_name[IMS_SETTINGS_XML_STRING_LEN_MAX_V01 + 1];
  /**<   XML payload name identifier. */

  /* Mandatory */
  /*  Payload ID */
  char payload_id[IMS_SETTINGS_XML_STRING_LEN_MAX_V01 + 1];
  /**<   Payload ID. */

  /* Mandatory */
  /*  Received XML Data */
  uint32_t xml_data_len;  /**< Must be set to # of elements in xml_data */
  uint8_t xml_data[IMS_SETTINGS_XML_DATA_LEN_MAX_V01];
  /**<   Actual data string received from the UE.
    */

  /* Optional */
  /*  Additional Accept Parameter */
  uint8_t additional_accept_parameter_valid;  /**< Must be set to true if additional_accept_parameter is being passed */
  char additional_accept_parameter[IMS_SETTINGS_XML_STRING_LEN_MAX_V01 + 1];
  /**<   Additional accept parameters identifier. */

  /* Optional */
  /*  Send XML Optional Data */
  uint8_t xml_optional_data_valid;  /**< Must be set to true if xml_optional_data is being passed */
  ims_settings_xml_optional_data_v01 xml_optional_data;
  /**<   XML optional data must be included,
         if the XML size exceeds IMS_SETTINGS_XML_STRING_LEN_MAX.
    */
}ims_settings_set_custom_xml_payload_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Sets custom XML payload from the requesting control point. */
typedef struct {
  ...
  /**<   A settings-specific error code is returned when the standard response
         error type is QMI_ERR_CAUSE_CODE.
    */
}ims_settings_set_custom_xml_payload_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Sends custom XML to network via INFO SIP method. */
typedef struct {
  ...
  char payload_id[IMS_SETTINGS_XML_STRING_LEN_MAX_V01 + 1];
  /**<   Payload ID. */
}ims_settings_send_custom_xml_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Sends custom XML to network via INFO SIP method. */
typedef struct {
  ...
  /**<   A settings-specific error code is returned when the standard response
         error type is QMI_ERR_CAUSE_CODE.
    */
}ims_settings_send_custom_xml_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Indication Message; Indicates the network response code for the custom
             XML INFO SIP method request sent to the network. */
typedef struct {
  ...
  /**<   SIP response code
       ...
       - 3xx -- Failure responses \n
       - 4xx -- Failure responses \n
       - 5xx -- Failure responses \n
       - 6xx -- Failure responses \n
       Its APP to interpret.
  */
}ims_settings_send_custom_xml_info_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; This request message set the duration of high priority data. 
    HLOS will send the user settings to IMS */
typedef struct {

  /* Mandatory */
  /*  Time duration of high priority data */
  uint16_t duration_time;
  /**<    The duration_time is the high priority data duration from deciding that 
          an early re-reg or re-subscribe been triggered. The duration value shall be 
          given in seconds. The configurable value should be less than 3600 seconds. 
    */
}ims_settings_high_priority_data_duration_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; This request message set the duration of high priority data. 
    HLOS will send the user settings to IMS */
typedef struct {
  ...
  /**<   Contains the following data members: \n
       ...
       - qmi_error_type  -- Error code. Possible error code values are described 
                            ...
                            definition.
    */
}ims_settings_high_priority_data_duration_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Indication Message; Indicates whether service has processed the request successfully or not. */
typedef struct {

  /* Mandatory */
  /*  Result response */
  uint8_t is_processed;
  /**<    Flag indicating whether service has processed the request or not. Values:\n
            - TRUE -- SUCCESS\n
            - FALSE -- FAILURE
    */
}ims_settings_high_priority_data_duration_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_IMS_SETTINGS_HIGH_PRIORITY_DATA_DURATION_V01
//#define REMOVE_QMI_IMS_SETTINGS_HIGH_PRIORITY_DATA_DURATION_IND_V01
...
//#define REMOVE_QMI_IMS_SETTINGS_SEND_CUSTOM_XML_INFO_V01
//#define REMOVE_QMI_IMS_SETTINGS_SEND_CUSTOM_XML_INFO_IND_V01
//#define REMOVE_QMI_IMS_SETTINGS_SEND_RTT_V01
//#define REMOVE_QMI_IMS_SETTINGS_SET_ACS_NETWORK_CONFIG_V01
//#define REMOVE_QMI_IMS_SETTINGS_SET_ACS_TOKEN_V01
...
//#define REMOVE_QMI_IMS_SETTINGS_SET_CUSTOM_XML_PAYLOAD_V01
...
//#define REMOVE_QMI_IMS_SETTINGS_UPDATE_ACS_TOKEN_STATUS_V01
...
#define QMI_IMS_SETTINGS_SET_CUSTOM_XML_PAYLOAD_REQ_V01 0x00A3
#define QMI_IMS_SETTINGS_SET_CUSTOM_XML_PAYLOAD_RESP_V01 0x00A3
#define QMI_IMS_SETTINGS_SEND_CUSTOM_XML_INFO_REQ_V01 0x00A4
#define QMI_IMS_SETTINGS_SEND_CUSTOM_XML_INFO_RSP_V01 0x00A4
#define QMI_IMS_SETTINGS_SEND_CUSTOM_XML_INFO_IND_V01 0x00A5
#define QMI_IMS_SETTINGS_SET_ACS_TOKEN_REQ_V01 0x00A6
#define QMI_IMS_SETTINGS_SET_ACS_TOKEN_RSP_V01 0x00A6
#define QMI_IMS_SETTINGS_UPDATE_ACS_TOKEN_STATUS_REQ_V01 0x00A7
#define QMI_IMS_SETTINGS_UPDATE_ACS_TOKEN_STATUS_RSP_V01 0x00A7
#define QMI_IMS_SETTINGS_HIGH_PRIORITY_DATA_DURATION_REQ_V01 0x00A8
#define QMI_IMS_SETTINGS_HIGH_PRIORITY_DATA_DURATION_RSP_V01 0x00A8
#define QMI_IMS_SETTINGS_HIGH_PRIORITY_DATA_DURATION_IND_V01 0x00A9
/**
    @}
  */
