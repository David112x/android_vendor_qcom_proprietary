...
namespace sensors_stability {
    ...
    namespace Parser {
        ...
        const std::string NUM_QUEUED_SENSORS = "num_queued_sensors";
        ...
        // Initialized to 2
        extern int default_queued_sensors;
        // Initialized to 1.0f
...
//-----------------------------------------------------------------------------
     ...
     * @return void
     */
      void set_usb_state(const std::string& test_state);
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
     ...
     /**
     * Override the default number of queued sensors for the test by passing from
     * the input file. Default is 2
     *
     * @param queued_sensors passed as const std::string reference
     * @return void
     */
      void set_num_queued_sensors(const std::string& queued_sensors);
//-----------------------------------------------------------------------------
     ...
     * @return void
     */
      void set_tot_report_count(const std::string&
...
//-----------------------------------------------------------------------------
     ...
     *
     * @param void
     * @return random_seed as unsigned int value
     */
...
//-----------------------------------------------------------------------------
    ...
    /**
     * Return number of queued sensors
     *
     * @param void
     * @return num_wueued_sensors as integer value. Default is 2
     */
