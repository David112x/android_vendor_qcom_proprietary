/*============================================================================
  ...
  ===========================================================================*/
#ifndef _SNS_REGISTRY_SKEL_H
#define _SNS_REGISTRY_SKEL_H
...
#ifndef _SNS_REGISTRY_SLIM_H
#define _SNS_REGISTRY_SLIM_H
#include "remote.h"
#include <stdint.h>
...
#else
#endif
static const Parameter parameters[2] = {{SLIM_IFPTR32(0x8,0x10),{{(const uintptr_t)0x0,0}}, 4,SLIM_IFPTR32(0x4,0x8),0,0},{SLIM_IFPTR32(0x8,0x10),{{(const uintptr_t)0x0,0}}, 4,SLIM_IFPTR32(0x4,0x8),3,0}};
static const Parameter* const parameterArrays[2] = {(&(parameters[0])),(&(parameters[1]))};
static const Method methods[1] = {{REMOTE_SCALARS_MAKEX(0,0,0x2,0x1,0x0,0x0),0x8,0x0,4,2,(&(parameterArrays[0])),0x4,0x1}};
static const Method* const methodArrays[1] = {&(methods[0])};
static const char strings[35] = "get_property\0prop_value\0prop_name\0";
static const uint16_t methodStrings[3] = {0,24,13};
static const uint16_t methodStringsArrays[1] = {0};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(sns_registry_slim) = {1,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
#endif //_SNS_REGISTRY_SLIM_H
extern int adsp_mmap_fd_getinfo(int, uint32_t *);
#ifdef __cplusplus
extern "C" {
#endif
static __inline int _skel_method(int (*_pfn)(char*, char*, uint32_t), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   char* _in0[1];
   uint32_t _in0Len[1];
   char* _rout1[1];
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(sns_registry_skel_invoke)(uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc))
   {
      case 0:
      return _skel_method((void*)__QAIC_IMPL(sns_registry_get_property), _sc, _pra);
   }
