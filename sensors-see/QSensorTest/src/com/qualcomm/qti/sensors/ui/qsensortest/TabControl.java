...
public class TabControl extends Activity {
  ...
  private TabControlReceiver TabControlReceiver = null;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Intent QsensorServiceIntent = new Intent(this, QSensorService.class);
    TabControl.context.startService(QsensorServiceIntent);
