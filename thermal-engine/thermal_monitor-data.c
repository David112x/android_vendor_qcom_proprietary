...
static struct setting_info tm_cfgs_lagoon_qrd[] =
{
	{
		.desc = "Q6-CX-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_kona[] =
{
	{
		.desc = "CWLAN-TJ-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
...
static struct setting_info tm_cfgs_scuba_qrd[] =
{
	{
		.desc = "SOCD-CAMERA-EXIT-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
		.data.tm = {
			.sensor = "socd-usr",
			.sampling_period_ms = 1000,
...
static struct setting_info tm_cfgs_scuba[] =
{
	{
		.desc = "SOCD-CAMERA-EXIT-MONITOR",
		.algo_type = MONITOR_ALGO_TYPE,
	...
	switch (therm_get_msm_id()) {
		...
		case THERM_LAGOON:
			...
			case THERM_PLATFORM_ATP:
				...
				break;
			default:
				cfg = tm_cfgs_lagoon_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_lagoon_qrd);
				break;
			}
			break;
		case THERM_ATOLL:
		...
		case THERM_KONA:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_kona;
				arr_size = ARRAY_SIZE(tm_cfgs_kona);
				break;
		...
		case THERM_SCUBA:
			...
			case THERM_PLATFORM_ATP:
				cfg = tm_cfgs_scuba;
				arr_size = ARRAY_SIZE(tm_cfgs_scuba);
				break;
			default:
				cfg = tm_cfgs_scuba_qrd;
				arr_size = ARRAY_SIZE(tm_cfgs_scuba_qrd);
				break;
			}
			break;
#ifdef ENABLE_BW_SENSOR
