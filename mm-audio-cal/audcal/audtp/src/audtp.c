        ...
        )
{
    ...
    *atp_frame_ptr = (atp_frame_struct* )malloc(sizeof(atp_frame_struct));
    ...
    ACDB_MEM_CPY((uint8_t *)(&(*atp_frame_ptr)->header),headersize,(uint8_t *)atp_diag_pkt->payload_req,headersize);
    (*atp_frame_ptr)->data_ptr = NULL ;
        ...
        )
{
    ...
    if ( context_ptr->is_next_frame_gnf == TRUE )
    {
        ...
        ACDB_MEM_CPY((uint8_t *)atp_resp_frame_ptr,atp_frame_header_length,
                (uint8_t *)&context_ptr->resp_current_node_ptr->frame_ptr->header,
        ...
        )
{
    ...
    ACDB_MEM_CPY(&(*atp_diag_pkt)->payload_resp[0],headersize,(uint8_t *)&atp_frame_ptr->header,headersize);
    /**copy frame data*/
