...
ifeq ($(call is-board-platform-in-list,msm8909 msm8996 msm8937 msm8953 msm8998 apq8098_latv sdm660 sdm845 sdm670 qcs605 sdmshrike msmnile $(MSMSTEPPE) $(TRINKET) qcs405 kona lito atoll bengal),true)
...
LOCAL_SHARED_LIBRARIES  += libvirtdiag
else
