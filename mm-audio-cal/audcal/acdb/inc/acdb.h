...
--------   ---      ----------------------------------------------------------
2020-03-04  kde     Adding support for Persistent Aud Proc Instance
                    Calibration APIs:
                    ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_TABLE_SIZE
                    ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_TABLE
                    ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_DATA
...
/** PID ADIE codec path for SC7180X which has CODEC_WCD938x
@newpage
*/
#define ACDB_PID_ADIE_CODEC_PATH_SC7180_WCD938X                   0x0001337B
...
/*
   ...
   struct {
            uint32_t ulDeviceType: The device type.
								   ...
								   (0x0001337A) - ACDB_DEVICE_TYPE_DMA_PARAM
                                                 :DMA device type ParamId
           }
*/
...
/**
	Parameter ID identifying a CODEC DMA device type.
*/
#define ACDB_DEVICE_TYPE_DMA_PARAM                            0x0001337A
...
@code
   ...
   // DMA Device Type
        ulPayloadMajorVersion = 0x0001
        ulPayloadMinorVersion = 0x0000
          This is the parameter ID identifying the format of the DMA
          device information structure.
   struct
   {
      uint32_t  ulCodecPathId;

      uint32_t  ulAfeBitsPerSampleMask;    // Refer to enum AcdbAfeBytesPerSampleType for
                                           supported values
      uint32_t  ulChannelConfig;     // Refer to enum AcdbChannelConfigType
                                        for supported values
      uint32_t  ulSampleRateMask;    // Refer to enum AcdbSampleRateMaskType
...
/** @addtogroup get_persistent_audproc_instance_com_tbl_size
@{ */

/**
    Queries for the size of a persistent AudProc instance common calibration table.

    @param[in] nCommandId
        Command ID is ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_TABLE_SIZE.
    @param[in] pCommandStruct
        Pointer to AcdbAudProcTableSizeCmdType.
    @param[in] nCommandStructLength
        Length must equal the size of AcdbAudProcTableSizeCmdType.
    ...
    _AcdbSizeResponseType
*/
#define ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_TABLE_SIZE    0x000133BA

/** @} */ /* end_addtogroup get_persistent_audproc_instance_com_tbl_size */
...
/** @addtogroup get_persistent_audproc_instance_com_tbl
@{ */
...
/**
   ...
   @param[in] nCommandId
         Command ID is ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_TABLE.
   @param[in] pCommandStruct
         Pointer to AcdbAudProcTableCmdType.
   @param[in] nCommandStructLength
         Length must equal the size of AcdbAudProcTableCmdType.
   ...
   _AcdbQueryResponseType
*/
#define ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_TABLE    0x000133B9
...
/** @} */ /* end_addtogroup get_persistent_audproc_instance_com_tbl */
...
/** @addtogroup get_persistent_audproc_instance_com_data
@{ */
...
/**
   ...
   @param[in] nCommandId
         Command ID is ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_DATA.
   @param[in] pCommandStruct
         Pointer to AcdbAudProcInstanceCmdType.
   @param[in] nCommandStructLength
         Length must equal the size of AcdbAudProcInstanceCmdType.
   ...
   @newpage
*/
#define ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_DATA     0x000133B8

/** @} */ /* end_addtogroup get_persistent_audproc_instance_com_data */
