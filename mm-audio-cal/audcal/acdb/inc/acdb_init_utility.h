...
========================================================================== */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/dev/fluence.x/acdb/inc/acdb_init_utility.h#2 $ */
...
--------   ---      ----------------------------------------------------------
2020-03-03 kde      Added AcdbReadFile(...) API
...
int32_t AcdbReadFile(const char* pFilename, uint8_t *pBfr, uint32_t bfrLen, uint32_t *pFileSize);
