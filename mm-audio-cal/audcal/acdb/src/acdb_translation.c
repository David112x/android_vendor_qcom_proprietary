...
/*===========================================================================
    ...
    $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acdb/src/acdb_translation.c#9 $
                                    ...
                                    )
{
	...
	case ACDB_SAMPLERATE_192000Hz:
		*pOutput = 192000;
		break;
	case ACDB_SAMPLERATE_88200Hz:
		*pOutput = 88200;
		break;
	case ACDB_SAMPLERATE_176400Hz:
		*pOutput = 176400;
		break;
	case ACDB_SAMPLERATE_352800Hz:
		*pOutput = 352800;
		break;
	case ACDB_SAMPLERATE_384000Hz:
		*pOutput = 384000;
		break;
	}
...
int32_t acdb_devinfo_getSampleMaskOffset (uint32_t nDeviceType)
{
   ...
   case ACDB_DEVICE_TYPE_SIMPLE_PARAM:
      offset = sizeof(uint32_t);
      break;
   case ACDB_DEVICE_TYPE_SIMPLE_PARAM_V2:
      offset = sizeof(uint32_t);
      break;
   case ACDB_DEVICE_TYPE_TDM_PARAM:
      offset = 3*sizeof(uint32_t);
      break;
   case ACDB_DEVICE_TYPE_USB_PARAM:
	   offset = 3*sizeof(uint32_t);
	   break;
   default:
      offset = 0;
