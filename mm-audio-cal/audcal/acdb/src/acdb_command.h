...
========================================================================== */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/dev/fluence.x/acdb/src/acdb_command.h#2 $ */
...
int32_t AcdbCmdGetAVCSCustomTopoInfo_V3(AcdbQueryCmdType *pInput,
                                    AcdbQueryResponseType *pOutput);
...
int32_t AcdbCmdGetPPSequenceInfo(uint32_t queryType,uint8_t *pInput, uint8_t *pOutput);
...
int32_t AcdbCmdGetCodecGainLevelsInfo(uint32_t queryType,uint8_t *pOut);
