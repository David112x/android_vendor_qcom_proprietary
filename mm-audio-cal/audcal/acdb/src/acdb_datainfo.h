...
========================================================================== */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/dev/fluence.x/acdb/src/acdb_datainfo.h#4 $ */
...
#define AUDPROCTBL_CDFT_INDICES_COUNT 2
...
#define AUDPROCTBL_GAIN_DEP_CDFT_INDICES_COUNT 2
...
#define AUDPROCTBL_VOL_CDFT_INDICES_COUNT 2
...
#define AUDSTREAMTBL_CDFT_INDICES_COUNT 2
...
#define VOCSTREAMTBL_CDFT_INDICES_COUNT 2
...
#define VOCSTREAM2TBL_CDFT_INDICES_COUNT 2
...
#define VOCPROCTBL_CDFT_INDICES_COUNT 2
...
#define VOCPROCDYNTBL_CDFT_INDICES_COUNT 2
...
#define VOCPROCSTATTBL_CDFT_INDICES_COUNT 2
...
#define AFECMNTBL_CDFT_INDICES_COUNT 2
...
#define AANC_CFG_CDFT_INDICES_COUNT 2
...
#define VOCPROCTBL_VOL_V2_CDFT_INDICES_COUNT 2
...
#define VOICE_VP3TBL_CDFT_INDICES_COUNT 2
...
#define AUDREC_VP3TBL_CDFT_INDICES_COUNT 2
...
#define VOCPROCDYN_INSTANCE_LUT_INDICES_COUNT 13
#define VOCPROCDYN_INSTANCE_CMD_INDICES_COUNT 3
#define VOCPROCDYN_INSTANCE_CDFT_INDICES_COUNT 3
#define VOCPROCDYNTBL_INSTANCE_INDICES_COUNT (VOCPROCDYN_INSTANCE_LUT_INDICES_COUNT-2)

#define VOCPROCSTAT_INSTANCE_LUT_INDICES_COUNT 13
#define VOCPROCSTAT_INSTANCE_CMD_INDICES_COUNT 4
#define VOCPROCSTAT_INSTANCE_CDFT_INDICES_COUNT 3
#define VOCPROCSTATTBL_INSTANCE_INDICES_COUNT (VOCPROCSTAT_INSTANCE_LUT_INDICES_COUNT-2)

//TO-DO: check the index count
#define AUDPROC_INST_LUT_INDICES_COUNT 5
#define AUDPROC_INST_CMD_INDICES_COUNT 3
#define AUDPROCTBL_INST_INDICES_COUNT (AUDPROC_INST_LUT_INDICES_COUNT-2)
#define AUDPROCTBL_INST_CDFT_INDICES_COUNT 3

#define AUDPROC_INST_GAIN_DEP_LUT_INDICES_COUNT 5
#define AUDPROC_INST_GAIN_DEP_CMD_INDICES_COUNT 3
#define AUDPROCTBL_INST__GAIN_DEP_INDICES_COUNT (AUDPROC_INST_GAIN_DEP_LUT_INDICES_COUNT-2)
#define AUDPROCTBL_INST_GAIN_DEP_CDFT_INDICES_COUNT 3

#define AUDSTREAM_INST_LUT_INDICES_COUNT 3
#define AUDSTREAM_INST_CMD_INDICES_COUNT 1
#define AUDSTREAMTBL_INST_INDICES_COUNT (AUDSTREAM_INST_LUT_INDICES_COUNT-2)
#define AUDSTREAMTBL_INST_CDFT_INDICES_COUNT 3

#define AFECMN_INST_LUT_INDICES_COUNT 4
#define AFECMN_INTS_CMD_INDICES_COUNT 2
#define AFECMNTBL_INST_INDICES_COUNT (AFECMN_INST_LUT_INDICES_COUNT-2)
#define AFECMNTBL_INST_CDFT_INDICES_COUNT 3

#define LSM_INST_LUT_INDICES_COUNT 4
#define LSM_INST_CMD_INDICES_COUNT 2
#define LSM_INST_INDICES_COUNT (LSM_INST_LUT_INDICES_COUNT-2)
#define LSM_INST_CDFT_INDICES_COUNT 3

#define VOCSTREAM2_INST_LUT_INDICES_COUNT 9
#define VOCSTREAM2_INST_CMD_INDICES_COUNT 0
#define VOCSTREAM2TBL_INST_INDICES_COUNT (VOCSTREAM2_INST_LUT_INDICES_COUNT-2)
#define VOCSTREAM2TBL_INST_CDFT_INDICES_COUNT 3

#define CODEC_PP_GAIN_LUT_INDICES_COUNT 5
#define CODEC_PP_GAIN_CMD_INDICES_COUNT 3
#define CODEC_PP_GAIN_TABLE_INDICES_COUNT (CODEC_PP_GAIN_LUT_INDICES_COUNT-2)
#define CODEC_PP_GAIN_CDFT_INDICES_COUNT 2

#define CODEC_PP_COMMON_LUT_INDICES_COUNT 4
#define CODEC_PP_COMMON_CMD_INDICES_COUNT 2
#define CODEC_PP_COMMON_TABLE_INDICES_COUNT (CODEC_PP_COMMON_LUT_INDICES_COUNT-2)
#define CODEC_PP_COMMON_CDFT_INDICES_COUNT 2
...
static const uint32_t CHANNELTYPE_V2 = 0x000132B9;  // 16-Channel Type Config
...
static const uint32_t CODEC_GAINS_STEPS = 0x0001314C; //Codec gain steps
static const uint32_t CODEC_PP_SEQUENCE = 0x0001314D; //PP sequence PID
static const uint32_t CODEC_GROUP_DEVICE_LIST = 0x0001314E; //Group device ID PID
static const uint32_t CODEC_GATEWAYTOPOLOGY = 0x000130FD; //CODEC Gateway topology PID
...
static const uint32_t ADSP_INSTANCE_ID_INFO = 0x0001327F; //ADSP global property with instance ID information.
static const uint32_t AVCS_TOPOLOGY_INFO_GLOBAL_PROPERTY_V2 = 0x0001327E; //AVCS custom topology information with instance ID support.
static const uint32_t GROUP_DEVICE_CONFIG_LIST_GLOBAL_PROPERTY = 0x000130F6;// Global property PID for Group configuration
static const uint32_t TXTOANY_RECORDED_DEVICEPAIR = 0x0001324F;    // Audio Rec EC Dev pairs for txtoany
static const uint32_t TDM_MULTI_LANE_CONFIG = 0x00013364; //TDM multi lane config property ID

static const uint32_t ACDB_GBL_PROPID_AVS_TOPO_INFO_V3 = 0x000132AC;   //User added AVCS Custom Topo Info
static const uint32_t ACDB_GBL_PROPID_OFFLOADED_PARAM_INFO = 0x000133B7;//Property that stores a list of parameters that are offloaded from the ACDB Data files

static uint32_t READ_UInt32(uint8_t* addr) {
  return (*addr) + ((*(addr + 1)) << 8) + ((*(addr + 2)) << 16) + ((*(addr + 3)) << 24);
}
static uint32_t READ_UInt16(uint8_t* addr) {
...
#include "acdb_end_pack.h"
;
typedef struct _VocProcDynInstCmdAllIndicesType VocProcDynInstCmdAllIndicesType;
#include "acdb_begin_pack.h"
struct _VocProcDynInstCmdAllIndicesType {
	uint32_t nTxDeviceId;
	/**< Tx device ID. */
	uint32_t nRxDeviceId;
	/**< Rx device ID. */
...
typedef struct _AdspCalHdrWithInstanceIDFormatType AdspCalHdrWithInstanceIDFormatType;
#include "acdb_begin_pack.h"
struct _AdspCalHdrWithInstanceIDFormatType{
	uint32_t nModuleId;
	uint16_t nInstanceId;
	uint16_t nReserved1; // Must be 0
	uint32_t nParamId;
	uint32_t nParamSize; //multiple of 4
}
#include "acdb_end_pack.h"
;
...
//caraudio
typedef struct _CodecGainDepCmdLookupType CodecGainDepCmdLookupType;
#include "acdb_begin_pack.h"
struct _CodecGainDepCmdLookupType {
	uint32_t nDeviceId;
	uint32_t nGainType;
	int32_t nGainStep;
}
#include "acdb_end_pack.h"
;
typedef struct _CodecGainDataCmdLookupType CodecGainDataCmdLookupType;
#include "acdb_begin_pack.h"
struct _CodecGainDataCmdLookupType {
	uint32_t nDeviceId;
	uint32_t nGainType;
	int32_t nGainStep;
	uint32_t nMid;
...
#include "acdb_end_pack.h"
;
typedef struct _CodecCommonCmdLookupType CodecCommonCmdLookupType;
#include "acdb_begin_pack.h"
struct _CodecCommonCmdLookupType {
	uint32_t nDeviceId;
	uint32_t nDeviceSampleRateId;
}
#include "acdb_end_pack.h"
;
typedef struct _CodecGainTblLookupType CodecGainTblLookupType;
#include "acdb_begin_pack.h"
struct _CodecGainTblLookupType {
	uint32_t nTxDevId;
	uint32_t nCDEFTblOffset;
	uint32_t nCDOTTblOffset;
}
...
//caraudio
typedef struct _CodecCommonTblLookupType CodecCommonTblLookupType;
#include "acdb_begin_pack.h"
struct _CodecCommonTblLookupType {
	uint32_t nDeviceId;
	uint32_t nDeviceSampleRateId;
	uint32_t nCDEFTblOffset;
	uint32_t nCDOTTblOffset;
...
#include "acdb_end_pack.h"
;
typedef struct _CodecCommonDataLookupTblType CodecCommonDataLookupTblType;
#include "acdb_begin_pack.h"
struct _CodecCommonDataLookupTblType {
	uint32_t nLen;
	CodecCommonTblLookupType *pLut;
}
#include "acdb_end_pack.h"
;
typedef struct _CodecCmnDataLookupType CodecCmnDataLookupType;
#include "acdb_begin_pack.h"
struct _CodecCmnDataLookupType {
	uint32_t nDeviceId;
	uint32_t nDeviceSampleRateId;
	uint32_t nCDEFTblOffset;
	uint32_t nCDOTTblOffset;
...
#include "acdb_end_pack.h"
;
typedef struct _CodecGainDataLookupType CodecGainDataLookupType;
#include "acdb_begin_pack.h"
struct _CodecGainDataLookupType {
	uint32_t nDeviceId;
	uint32_t nGainType;
	int32_t nGainStep;
	uint32_t nCDEFTblOffset;
...
#include "acdb_end_pack.h"
;
typedef struct _CodecGainDataLookupTblType CodecGainDataLookupTblType;
#include "acdb_begin_pack.h"
struct _CodecGainDataLookupTblType {
	uint32_t nLen;
	CodecGainDataLookupType *pLut;
}
#include "acdb_end_pack.h"
;
...
{
    uint32_t alignment;     /**< the alignment that determines the amount of padding added before the data */
    uint32_t data_offset;   /**< the starting offset of the data */
    uint32_t data_size;     /**< Size of the data starting at data_offset */
    /*uint8_t data[0];*/
