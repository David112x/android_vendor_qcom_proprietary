...
/*===========================================================================
    ...
    $ $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/dev/fluence.x/acdb/src/acdb.c#2 $

    when        who     what, where, why
    ----------  ---     -----------------------------------------------------
    2020-03-04  kde     Adding support for Persistent Aud Proc Instance Calibration APIs:
  ...
  case ACDB_CMD_GET_AUDIO_RECORD_RX_DEVICE_LIST:
   ...
   case ACDB_CMD_GET_AUDIO_POPP_TOPOLOGIES_SIZE:
    ...
    case ACDB_CMD_GET_AUDPROC_INSTANCE_COMMON_DATA:
      ...
      break;
    case ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_DATA:
        if (pCommandStruct == NULL || nCommandStructLength != sizeof(AcdbAudProcInstanceCmdType) ||
            pResponseStruct == NULL || nResponseStructLength != sizeof(AcdbQueryResponseType))
        {
            result = ACDB_BADPARM;
        ...
        else
        {
            ...
            {
                result = AcdbCmdGetPersistentAudProcIntanceInfo(
                    DATA_CMD, (uint8_t *)pInput, (uint8_t *)pOutput);
            }
        }
        break;
   case ACDB_CMD_GET_AUDPROC_INSTANCE_COMMON_TABLE:
      ...
      break;
   case ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_TABLE:
       if (pCommandStruct == NULL || nCommandStructLength != sizeof(AcdbAudProcTableCmdType) ||
           pResponseStruct == NULL || nResponseStructLength != sizeof(AcdbQueryResponseType))
       {
           result = ACDB_BADPARM;
       ...
       else
       {
           ...
           {
               result = AcdbCmdGetPersistentAudProcIntanceInfo(
                   TABLE_CMD, (uint8_t *)pInput, (uint8_t *)pOutput);
           }
       }
       break;
   case ACDB_CMD_GET_AUDPROC_INSTANCE_COMMON_TABLE_SIZE:
      ...
      break;
   case ACDB_CMD_GET_PERSISTENT_AUDPROC_INSTANCE_COMMON_TABLE_SIZE:
       if (pCommandStruct == NULL || nCommandStructLength != sizeof(AcdbAudProcTableSizeCmdType) ||
           pResponseStruct == NULL || nResponseStructLength != sizeof(AcdbSizeResponseType))
       {
           result = ACDB_BADPARM;
       ...
       else
       {
           ...
           AcdbSizeResponseType *pOutput = (AcdbSizeResponseType *)pResponseStruct;
           result = AcdbCmdGetPersistentAudProcIntanceInfo(
               TABLE_SIZE_CMD, (uint8_t *)pInput, (uint8_t *)pOutput);
       }
       break;
...
case ACDB_CMD_GET_PP_SEQUENCE:
 ...
 case ACDB_CMD_GET_CODEC_PP_GAIN_DEP_STEP_DATA:
   ...
   case ACDB_CMD_GET_GROUP_DEVICE_LIST_SIZE:
      ...
      break;
   case ACDB_CMD_GET_TDM_MULTI_LANE_CONFIG_SIZE:
	   if ( pResponseStruct == NULL || nResponseStructLength != sizeof (AcdbSizeResponseType))
      {
         result = ACDB_BADPARM;
      }
      ...
      {
		  AcdbTdmLaneConfigQueryCmdType *pInput = (AcdbTdmLaneConfigQueryCmdType *)pCommandStruct;
         AcdbSizeResponseType *pOutput = (AcdbSizeResponseType *)pResponseStruct;
         result = AcdbCmdGetTdmMultiLaneConfigData(DATA_SIZE_CMD, pInput, (uint8_t *)pOutput);
      }
	   break;
   case ACDB_CMD_GET_TDM_MULTI_LANE_CONFIG:
	   if ( pResponseStruct == NULL || nResponseStructLength != sizeof (AcdbQueryResponseType))
      {
         result = ACDB_BADPARM;
      }
      else
      {
		 AcdbTdmLaneConfigQueryCmdType *pInput = (AcdbTdmLaneConfigQueryCmdType *)pCommandStruct;
         AcdbQueryResponseType *pOutput = (AcdbQueryResponseType *)pResponseStruct;
         result = AcdbCmdGetTdmMultiLaneConfigData (DATA_CMD, pInput, (uint8_t *)pOutput);
      }
	   break;
   default:
