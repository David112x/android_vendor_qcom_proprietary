...
to locate data between several calls to the data base.
*/
typedef struct _AcdbDeltaDataKeyTypeV2 AcdbDeltaDataKeyTypeV2;
#include "acdb_begin_pack.h"
struct _AcdbDeltaDataKeyTypeV2 {
	uint32_t nTableId;
	uint32_t nIndicesCount;
	uint8_t *pIndices;
}
...
typedef struct AcdbDynamicDeltaInstanceStructV2 AcdbDynamicDeltaInstanceTypeV2;
#include "acdb_begin_pack.h"
struct AcdbDynamicDeltaInstanceStructV2{
	AcdbDeltaDataKeyTypeV2 *pKey;
	AcdbDynamicUniqueDataType *pDataNode;
	struct AcdbDynamicDeltaInstanceStructV2 *pNext;
}
#include "acdb_end_pack.h"
;
...
typedef struct AcdbDynamicDeltaFileDataStructV2 AcdbDynamicDeltaFileDataTypeV2;
#include "acdb_begin_pack.h"
struct AcdbDynamicDeltaFileDataStructV2{
	AcdbDynamicDeltaInstanceTypeV2 *pFileHead;
	AcdbDynamicDeltaInstanceTypeV2 *pFileTail;
}
#include "acdb_end_pack.h"
;
