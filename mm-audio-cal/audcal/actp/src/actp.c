 ...
 *
 * Copyright (c) 2010-2019 by Qualcomm Technologies, Inc.
 * All Rights Reserved.
 ...
 * DESCRIPTION : * De-registers the subsystem with diag dispathcer
 *
 * DEPENDENCIES : None.
 *
 * RETURN VALUE : None
        ...
        )
{
	...
	diag_pkt_req_struct request = { { 0, 0, 0 }, ""};
    ...
    if (NULL != req_ptr)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                ACDB_MEM_CPY((uint8_t *)rsp_diag_pkt_ptr,actp_rsp_pkt_len,(uint8_t *)actp_rsp_ptr,actp_rsp_pkt_len);
