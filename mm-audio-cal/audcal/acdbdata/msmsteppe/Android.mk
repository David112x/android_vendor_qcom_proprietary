...
# ---------------------------------------------------------------------------------
#             Populate ACDB data files to file system for QRD wcd9375qrd Codec
# ---------------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_Bluetooth_cal.acdb
LOCAL_MODULE_FILENAME   := Bluetooth_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/Bluetooth_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_Codec_cal.acdb
LOCAL_MODULE_FILENAME   := Codec_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/Codec_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_General_cal.acdb
LOCAL_MODULE_FILENAME   := General_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/General_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_Global_cal.acdb
LOCAL_MODULE_FILENAME   := Global_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/Global_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_Handset_cal.acdb
LOCAL_MODULE_FILENAME   := Handset_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/Handset_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_Hdmi_cal.acdb
LOCAL_MODULE_FILENAME   := Hdmi_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/Hdmi_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_Headset_cal.acdb
LOCAL_MODULE_FILENAME   := Headset_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/Headset_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_Speaker_cal.acdb
LOCAL_MODULE_FILENAME   := Speaker_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/Speaker_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := QRD_WCD9375_workspaceFile.qwsp
LOCAL_MODULE_FILENAME   := workspaceFile.qwsp
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/sm6150-wcd9375qrd-snd-card/
LOCAL_SRC_FILES         := QRD/sm6150-wcd9375qrd-snd-card/workspaceFile.qwsp
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/Bluetooth_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/Codec_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/General_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/Global_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/Handset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/Hdmi_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/Headset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/Speaker_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/sm6150-tavil-snd-card/
LOCAL_SRC_FILES         := IDP/sm6150-tavil-snd-card/workspaceFile.qwsp
include $(BUILD_PREBUILT)
