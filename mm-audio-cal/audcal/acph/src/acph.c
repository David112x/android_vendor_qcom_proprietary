 ...
 *--------     ---     ----------------------------------------------------------
 *05/09/18  maahdevk   Updated ACPH_BUFFER_LENGTH to 0x200000 (2MB)
...
#define ACPH_BUFFER_LENGTH          0x200000
                                 ...
                                 )
{
   ...
   {
      /** copy data length*/
      ACDB_MEM_CPY((uint8_t *)data_length,ACPH_DATA_LENGTH_LENGTH,
