...
LOC_HIDL_3_0_TARGET_LIST := msm8909
...
MM_AUDIO += fai_3.0.0_0.0_eai_1.00.pmd
MM_AUDIO += fai_1.0.0_0.0_eai_1.00.pmd
MM_AUDIO += fai_1.1.0_0.0_eai_1.00.pmd
MM_AUDIO += fai_2.0.0_0.0_eai_1.00.pmd
MM_AUDIO += fai_2.0.0_0.1_eai_1.00.pmd
MM_AUDIO += fai_2.1.0_0.0_eai_1.00.pmd
MM_AUDIO += fai_2.1.0_0.1_eai_1.00.pmd
MM_AUDIO += fai_2.2.0_0.0_eai_1.00.pmd
MM_AUDIO += fai_2.2.0_0.1_eai_1.00.pmd
MM_AUDIO += fai__2.0.0_0.1__3.0.0_0.0__eai_1.00.pmd
MM_AUDIO += fai__2.2.0_0.1__3.0.0_0.0__eai_1.00.pmd
...
MM_BUFFERQ += libbufferq_system
MM_BUFFERQ += libfenceq_system
endif
...
MM_CAMERA += libchromatix_gc2365_snapshot
MM_CAMERA += libchromatix_gc2365_default_video
MM_CAMERA += libchromatix_gc2365_common
MM_CAMERA += libchromatix_gc2365_liveshot
MM_CAMERA += libchromatix_gc2365_preview
MM_CAMERA += libchromatix_gc030a_snapshot
MM_CAMERA += libchromatix_gc030a_common
MM_CAMERA += libchromatix_gc030a_preview
...
MM_CAMERA += libmmcamera_gc2365
MM_CAMERA += libmmcamera_gc030a
...
EARLY_SERVICES += early_init.conf
EARLY_SERVICES += init_early_test
PRODUCT_PACKAGES += $(EARLY_SERVICES)
endif
...
PERF += vendor.qti.hardware.perf@2.1
PERF += vendor.qti.hardware.perf@2.1-service.rc
PERF += vendor.qti.hardware.perf@2.1-impl
PERF += vendor.qti.hardware.perf@2.1-service
...
VEHICLE_NETWORKS += mpc5746c_firmware.elf
VEHICLE_NETWORKS += vip_fw_version
...
VNDK_LIBS += vendor.qti.hardware.perf@2.1.vendor
