...
/*===========================================================================
  ...
  Copyright (c) 2008-2017, 2019-2020 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
/*===========================================================================
  FUNCTION:  dsi_mni_embms_get_tuneaway_info
===========================================================================*/
/*!
    @brief
    used to retrieve tuneaway info from modem.
...
*/
/*=========================================================================*/
int dsi_mni_embms_get_tuneaway_info(dsi_store_t * st_hndl, unsigned int txn_id)
{
  int ret = DSI_ERROR;
  int i = DSI_ERROR;
  ...
  do
  {
    ...
    {
      DSI_LOG_ERROR("%s: invalid st_hndl received", __func__);
      break;
    }

    DSI_LOG_DEBUG("%s:st_hndl [%p] txn_id[%d]",
                  __func__, (unsigned int*)st_hndl, txn_id);
    ...
    if(DSI_SUCCESS !=
        dsi_qmi_wds_get_tuneaway_info(DSI_GET_WDS_HNDL(i), txn_id))
    {
      DSI_LOG_ERROR("dsi_mni_embms_get_tuneaway_info failed: iface=[%d]", i);
      break;
    }
