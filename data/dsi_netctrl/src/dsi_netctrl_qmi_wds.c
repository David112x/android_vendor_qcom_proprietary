...
/*===========================================================================
    FUNCTION  dsi_qmi_wds_get_tuneaway_info
===========================================================================*/
/*!
@brief
  QMI message to retrieve tuneaway info from modem.
...
)
{
  int rc;
  int ret = DSI_ERROR;
  wds_embms_get_tuneaway_info_req_msg_v01  req;
  wds_embms_get_tuneaway_info_resp_msg_v01 resp;
  ...
  rc = qmi_client_send_msg_sync(clnt_handle,
                                QMI_WDS_EMBMS_GET_TUNEAWAY_INFO_REQ_V01,
                                (void *)&req,
                                sizeof(req),
                                (void*)&resp,
                                sizeof(resp),
