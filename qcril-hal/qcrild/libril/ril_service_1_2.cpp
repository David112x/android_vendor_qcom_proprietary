...
Return<void> RadioImpl_1_2::startLceService(int32_t serial, int32_t reportInterval, bool pullMode) {
    ...
    if (msg) {
        GenericCallback<RIL_LceStatusInfo> cb([this, serial](std::shared_ptr<Message>,
            ...
            RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponseV1_2, startLceServiceResponse, responseInfo, result);
        });
        msg->setCallback(&cb);
        msg->dispatch();
    } else {
        RadioResponseInfo rsp{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
        LceStatusInfo result = {};
        RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponseV1_2, startLceServiceResponse, rsp, result);
    }
#else
...
Return<void> RadioImpl_1_2::stopLceService(int32_t serial) {
    ...
    if (msg) {
        GenericCallback<RIL_LceStatusInfo> cb([this, serial](std::shared_ptr<Message>,
            ...
            RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponseV1_2, stopLceServiceResponse, responseInfo, result);
        });
        msg->setCallback(&cb);
        msg->dispatch();
    } else {
        RadioResponseInfo rsp{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
        LceStatusInfo result = {};
        RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponseV1_2, stopLceServiceResponse, rsp, result);
    }
#else
...
Return<void> RadioImpl_1_2::pullLceData(int32_t serial) {
    ...
    if (msg)
    {
        GenericCallback<RIL_LceDataInfo> cb([this, serial](std::shared_ptr<Message>,
            ...
            RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponseV1_2, pullLceDataResponse, responseInfo, result);
        });
        msg->setCallback(&cb);
        msg->dispatch();
    }
    else
    {
        RadioResponseInfo rsp{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
        LceDataInfo result = {};
        RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponseV1_2, pullLceDataResponse, rsp, result);
    }
#else
...
Return<void> RadioImpl_1_2::setupDataCall_1_2(int32_t serial, V1_2::AccessNetwork accessNetwork, const V1_0::DataProfileInfo& dataProfileInfo,
                                                bool modemCognitive, bool roamingAllowed,bool isRoaming, V1_2::DataRequestReason reason,
