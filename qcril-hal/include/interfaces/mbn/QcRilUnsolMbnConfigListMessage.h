...
class QcRilUnsolMbnConfigListMessage : public UnSolicitedMessage,
 ...
 public:
  static constexpr const char *MESSAGE_NAME = "com.qualcomm.qti.qcril.mbn.mbn_config_list";
  QcRilUnsolMbnConfigListMessage() = delete;
  ~QcRilUnsolMbnConfigListMessage() {};

  explicit inline QcRilUnsolMbnConfigListMessage(const std::vector<uint8_t> &resultArray)
