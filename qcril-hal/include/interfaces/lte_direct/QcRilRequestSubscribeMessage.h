...
/*
 * Request to specify the expression that the App wishes to subscribe
 *
 * Response:
 *   errorCode    : Valid error codes
 *   responseData : nullptr
 */
class QcRilRequestSubscribeMessage : public QcRilRequestMessage,
                                     public add_message_id<QcRilRequestSubscribeMessage> {
private:
...
public:
  static constexpr const char *MESSAGE_NAME = "QcRilRequestSubscribeMessage";

  QcRilRequestSubscribeMessage() = delete;

  ~QcRilRequestSubscribeMessage() {}

  inline QcRilRequestSubscribeMessage(std::shared_ptr<MessageContext> context)
