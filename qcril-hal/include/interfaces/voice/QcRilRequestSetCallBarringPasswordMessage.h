...
class QcRilRequestSetCallBarringPasswordMessage
 ...
 public:
  ...
  const std::string &getOldPassword() { return *mOldPassword; }
  void setOldPassword(const std::string &val) { mOldPassword = val; }
  ...
  const std::string &getNewPassword() { return *mNewPassword; }
  void setNewPassword(const std::string &val) { mNewPassword = val; }
