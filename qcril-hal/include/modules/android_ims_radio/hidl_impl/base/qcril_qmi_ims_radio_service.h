...
class ImsRadioImplBase : virtual public ::android::RefBase {
 ...
 public:
  ...
  virtual void notifyOnCallComposerInfoAvailable(
  ...
  virtual void notifyOnRetrievingGeoLocationDataStatus(
...
class ImsRadioImpl : public ImsRadioImplBase, public V1_3::IImsRadio, public hidl_death_recipient {
 ...
 public:
  ...
  void notifyOnCallComposerInfoAvailable(std::shared_ptr<QcRilUnsolImsCallComposerInfo> msg);
