...
typedef enum
{
  ...
  QCRIL_UIM_REQUEST_SEND_CONF_CODE
...
typedef enum
{
  ...
  QMI_UIM_SRVC_CONF_CODE_RSP_MSG
} qmi_uim_rsp_id_type;
...
typedef enum
{
  ...
  QMI_UIM_PROFILE_CONFIRMATION_CODE_REQUIRED                 = 0x06
...
/* -----------------------------------------------------------------------------
   STRUCTURE:    qmi_uim_conf_code_req_type

   DESCRIPTION:   Confirmation code data structure
-------------------------------------------------------------------------------*/
typedef struct
{
  qmi_uim_slot_type   slot;
  char              * confirmation_code_ptr;
} qmi_uim_conf_code_req_type;
/* -----------------------------------------------------------------------------
