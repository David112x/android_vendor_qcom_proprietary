...
class OemHookImpl : public IQtiOemHook, public hidl_death_recipient {
  ...
  public:
    ...
    public:
        ...
        Return<void> processLteDirectDiscRequest(int32_t serial, uint8_t *data, uint32_t dataLen);
        Return<void> lteDirectDiscoveryInitializeRequest(int32_t serial);
        Return<void> lteDirectDiscoveryGetDeviceCapabilityRequest(int32_t serial);
        Return<void> lteDirectDiscoveryTerminateRequest(int32_t serial,
                                                        LteDirectDiscovery_Terminate *inData);
        Return<void> lteDirectDiscoveryGetServiceStatusRequest(int32_t serial);
        Return<void> lteDirectDiscoveryPublishRequest(int32_t serial,
                                                      LteDirectDiscovery_Publish *inData);
        Return<void>
        lteDirectDiscoveryCancelPublishRequest(int32_t serial,
                                               LteDirectDiscovery_CancelPublish *inData);
        Return<void> lteDirectDiscoverySubscribeRequest(int32_t serial,
                                                        LteDirectDiscovery_Subscribe *inData);
        Return<void>
        lteDirectDiscoveryCancelSubscribeRequest(int32_t serial,
        ...
        void
        sendLteDirectUnsolExpressionStatus(std::shared_ptr<QcRilUnsolExpressionStatusMessage> msg);
        ...
        void sendLteDirectUnsolTransmissionStatus(
            std::shared_ptr<QcRilUnsolTransmissionStatusMessage> msg);
        void
        sendLteDirectUnsolReceptionStatus(std::shared_ptr<QcRilUnsolReceptionStatusMessage> msg);
