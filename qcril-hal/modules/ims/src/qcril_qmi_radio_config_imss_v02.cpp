  ...
  do
  {
    ...
    switch(config_ptr->config_item)
    {
      ...
      case QCRIL_QMI_RADIO_CONFIG_MMTEL_CALL_COMPOSER_PREFERENCE:
        qmi_req.mmtel_call_composer_config_enabled_valid = TRUE;
        qmi_req.mmtel_call_composer_config_enabled = *((bool *) config_ptr->config_item_value);
        QCRIL_LOG_INFO("Set config mmtel_call_composer_config_enabled to: %d",
                        qmi_req.mmtel_call_composer_config_enabled);
