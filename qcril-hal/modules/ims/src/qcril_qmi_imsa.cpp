...
static void qcril_qmi_imsa_store_service_status_cl(
    ...
    uint8_t callcomposer_service_status_valid,
    imsa_service_status_enum_v01 callcomposer_service_status,
    uint8_t callcomposer_service_rat_valid,
...
void qcril_qmi_imsa_init()
{
   ...
   ind_reg_req.gps_config_valid = TRUE;
   ind_reg_req.gps_config = 1;  // enable
...
void qcril_qmi_imsa_register_for_geo_location_request()
{
   ...
   ret = qmi_client_imsa_send_sync(QMI_IMSA_IND_REG_REQ_V01,
       ...
       (void*) &ind_reg_resp,
       sizeof(imsa_ind_reg_rsp_msg_v01));
   QCRIL_LOG_DEBUG("IND_REG_REQ for geo_location_status_config ret = %d", ret);
   QCRIL_LOG_FUNC_RETURN();
} // qcril_qmi_imsa_ind_registrations
...
void qcril_qmi_imsa_cleanup()
{
   ...
   qcril_qmi_imsa_store_service_status_cl(
       ...
       TRUE, IMSA_NO_SERVICE_V01,  // CALL COMPOSER SERVICE_STATUS
       FALSE, IMSA_WWAN_V01);      // CALL COMPOSER SERVICE_RAT
   ...
   qcril_qmi_imsa_info.ims_srv_status.callcomposer_service_status_valid = FALSE;
   ...
   qcril_qmi_imsa_info.ims_srv_status.callcomposer_service_rat_valid = FALSE;
...
//=========================================================================
//  convert_imsa_gps_error_reason
//=========================================================================
qcril::interfaces::GeoLocationDataStatus convert_imsa_gps_error_reason(
    imsa_gps_error_reason_enum_v01 in)
{
  qcril::interfaces::GeoLocationDataStatus result =
      qcril::interfaces::GeoLocationDataStatus::UNKNOWN;
  switch (in) {
    case IMSA_GPS_ERROR_REASON_TIMEOUT_V01:
      result = qcril::interfaces::GeoLocationDataStatus::TIMEOUT;
      break;
    case IMSA_GPS_ERROR_REASON_NO_CIVIC_ADDRESS_V01:
      result = qcril::interfaces::GeoLocationDataStatus::NO_CIVIC_ADDRESS;
      break;
    case IMSA_GPS_ERROR_REASON_ENGINE_LOCK_V01:
      result = qcril::interfaces::GeoLocationDataStatus::ENGINE_LOCK;
      break;
    case IMSA_GPS_ERROR_RESOLVED_V01:
      result = qcril::interfaces::GeoLocationDataStatus::RESOLVED;
      break;
    default:
      result = qcril::interfaces::GeoLocationDataStatus::UNKNOWN;
      break;
  }
  return result;
}
...
//===========================================================================
// qcril_qmi_imsa_gps_info_ind_hdlr
//===========================================================================
void qcril_qmi_imsa_gps_info_ind_hdlr(const imsa_gps_error_ind_msg_v01 &qmi_ind) {
  QCRIL_LOG_FUNC_ENTRY();
  auto msg = std::make_shared<QcRilUnsolImsGeoLocationDataStatus>();
  if (msg)
  {
    msg->setGeoLocationDataStatus(convert_imsa_gps_error_reason(qmi_ind.gps_error_reason));
    Dispatcher::getInstance().dispatchSync(msg);
  }
  QCRIL_LOG_FUNC_RETURN();
} // qcril_qmi_imsa_gps_info_ind_hdlr
...
)
{
    ...
    if (callcomposer_service_status_valid)
    {
      qcril_qmi_imsa_info.ims_srv_status.callcomposer_service_status_valid =
            callcomposer_service_status_valid;
      qcril_qmi_imsa_info.ims_srv_status.callcomposer_service_status = callcomposer_service_status;

    }

    if (callcomposer_service_rat_valid)
    {
      qcril_qmi_imsa_info.ims_srv_status.callcomposer_service_rat_valid =
            callcomposer_service_rat_valid;
      qcril_qmi_imsa_info.ims_srv_status.callcomposer_service_rat = callcomposer_service_rat;
    }
    // IMSA REFACTOR TEST
    qcril_qmi_imsa_broadcast_service_status(qcril_qmi_imsa_info);
...
void qcril_qmi_imsa_service_status_ind_hdlr(void *ind_data_ptr)
{
    ...
    if (NULL != service_ind_msg_ptr)
    {
      ...
      QCRIL_LOG_ESSENTIAL("CallComposer: service_status(%s): %d, rat(%s): %d",
            service_ind_msg_ptr->callcomposer_service_status_valid ? "valid": "not valid",
            service_ind_msg_ptr->callcomposer_service_status,
            service_ind_msg_ptr->callcomposer_service_rat_valid ? "valid": "not valid",
            service_ind_msg_ptr->callcomposer_service_rat);
        ...
        qcril_qmi_imsa_store_service_status_cl(
            ...
            service_ind_msg_ptr->ut_service_rat,
            service_ind_msg_ptr->callcomposer_service_status_valid,
            service_ind_msg_ptr->callcomposer_service_status,
            service_ind_msg_ptr->callcomposer_service_rat_valid,
            service_ind_msg_ptr->callcomposer_service_rat);
...
)
{
  ...
  if (decoded_payload && decoded_payload_len)
  {
    switch(msg_id)
    {
      ...
      case QMI_IMSA_GPS_INFO_IND_V01: {
        imsa_gps_error_ind_msg_v01 *qmi_ind = (imsa_gps_error_ind_msg_v01 *)(decoded_payload);
        qcril_qmi_imsa_gps_info_ind_hdlr(*qmi_ind);
      } break;
  ...
  {
    QCRIL_LOG_DEBUG("Invalid decoded_payload (payload = %p, len = %d)",
...
)
{
  ...
  do {
    ...
    if (resp_msg_ptr->resp.result == QMI_RESULT_SUCCESS_V01)
    {
      ...
      QCRIL_LOG_ESSENTIAL("CallComposer: service_status(%s): %d, rat(%s): %d",
          resp_msg_ptr->callcomposer_service_status_valid ? "valid": "not valid",
          resp_msg_ptr->callcomposer_service_status,
          resp_msg_ptr->callcomposer_service_rat_valid ? "valid": "not valid",
          resp_msg_ptr->callcomposer_service_rat);
      ...
      qcril_qmi_imsa_store_service_status_cl(
          ...
          resp_msg_ptr->ut_service_rat,
          resp_msg_ptr->callcomposer_service_status_valid,
          resp_msg_ptr->callcomposer_service_status,
          resp_msg_ptr->callcomposer_service_rat_valid,
          resp_msg_ptr->callcomposer_service_rat);
...
)
{
    ...
    {
      qcril_qmi_imsa_info.max_ims_instances = 1;
    }
