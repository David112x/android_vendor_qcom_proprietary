...
#include "deprecated/qcril_qmi_radio_config_meta_table.h"
#endif
...
//===========================================================================
const char* qcril_qmi_radio_config_get_item_log_str(qcril_qmi_ims_config_item_type config_item)
{
  size_t i;
  for (i=0; i< meta_table_length; i++)
  {
...
{
  qcril_qmi_ims_config_settings_resp_type ret = QCRIL_QMI_RADIO_CONFIG_SETTINGS_RESP_OTHER_INTERNAL_ERR;
...
{
  qcril_qmi_ims_config_error_type ret = QCRIL_QMI_RADIO_CONFIG_ERROR_GENERIC_FAILURE;
  switch(qmi_error)
  {
