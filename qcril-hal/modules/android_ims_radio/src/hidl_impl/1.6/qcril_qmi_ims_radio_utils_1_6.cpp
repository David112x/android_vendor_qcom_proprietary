...
qcril::interfaces::ConfigItem convertConfigItem(const V1_6::ConfigItem in) {
    ...
    switch(in) {
        case V1_6::ConfigItem::CONFIG_ITEM_SET_AUTO_REJECT_CALL_MODE_CONFIG:
            ...
            break;
        case V1_6::ConfigItem::CONFIG_ITEM_MMTEL_CALL_COMPOSER_CONFIG:
...
V1_6::GeoLocationDataStatus convertGeoLocationDataStatus(
    qcril::interfaces::GeoLocationDataStatus in) {
  switch (in) {
    case qcril::interfaces::GeoLocationDataStatus::TIMEOUT:
      return V1_6::GeoLocationDataStatus::TIMEOUT;
    case qcril::interfaces::GeoLocationDataStatus::NO_CIVIC_ADDRESS:
      return V1_6::GeoLocationDataStatus::NO_CIVIC_ADDRESS;
    case qcril::interfaces::GeoLocationDataStatus::ENGINE_LOCK:
      return V1_6::GeoLocationDataStatus::ENGINE_LOCK;
    case qcril::interfaces::GeoLocationDataStatus::RESOLVED:
      return V1_6::GeoLocationDataStatus::RESOLVED;
    default:
      return V1_6::GeoLocationDataStatus::RESOLVED;
  }
}

qcril::interfaces::Priority convertToRilPriority(const V1_6::CallPriority &in) {
  switch (in) {
     case V1_6::CallPriority::URGENT:
...
qcril::interfaces::Location convertToRilLocation(const V1_6::CallLocation &in) {
...
V1_6::CallPriority convertCallComposerPriority(const qcril::interfaces::Priority& in) {
  switch (in) {
  case qcril::interfaces::Priority::URGENT:
    return V1_6::CallPriority::URGENT;
  case qcril::interfaces::Priority::NORMAL:
  default:
    return V1_6::CallPriority::NORMAL;
  }
}

V1_6::CallLocation convertCallComposerLocation(const qcril::interfaces::Location& in) {
  V1_6::CallLocation out{};
...
void convertCallComposerInfo(V1_6::CallComposerInfo &out,
    const qcril::interfaces::CallComposerInfo& in) {
  if (in.hasId()) out.callId = in.getId();
  if (in.hasPriority()) {
    out.priority = convertCallComposerPriority(in.getPriority());
  }
  ...
  if (in.hasLocation()) {
    out.location = convertCallComposerLocation(in.getLocation());
  }
}
