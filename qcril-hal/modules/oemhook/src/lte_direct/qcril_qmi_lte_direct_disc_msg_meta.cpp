...
{
  qcril_qmi_lte_direct_disc_msg_meta_data.push_back({LteDirectDiscovery_MsgId_REQUEST_INITIALIZE,LteDirectDiscovery_MsgType_REQUEST,NULL,0,QCRIL_EVT_NONE,"INITIALIZE REQ"});
  ...
  qcril_qmi_lte_direct_disc_msg_meta_data.push_back({LteDirectDiscovery_MsgId_REQUEST_GET_DEVICE_CAPABILITY,LteDirectDiscovery_MsgType_REQUEST,NULL,0,QCRIL_EVT_NONE,"GET_DEVICE_CAPABILITY REQ"});
  ...
  qcril_qmi_lte_direct_disc_msg_meta_data.push_back({LteDirectDiscovery_MsgId_REQUEST_TERMINATE,LteDirectDiscovery_MsgType_REQUEST,LteDirectDiscovery_Terminate_fields,sizeof(LteDirectDiscovery_Terminate),QCRIL_EVT_NONE,"TERMINATE REQ"});
  ...
  qcril_qmi_lte_direct_disc_msg_meta_data.push_back({LteDirectDiscovery_MsgId_REQUEST_GET_SERVICE_STATUS,LteDirectDiscovery_MsgType_REQUEST,NULL,0,QCRIL_EVT_NONE,"GET_SERVICE_STATUS REQ"});
  ...
  qcril_qmi_lte_direct_disc_msg_meta_data.push_back({LteDirectDiscovery_MsgId_REQUEST_PUBLISH,LteDirectDiscovery_MsgType_REQUEST,LteDirectDiscovery_Publish_fields,sizeof(LteDirectDiscovery_Publish),QCRIL_EVT_NONE,"PUBLISH REQ"});
  ...
  qcril_qmi_lte_direct_disc_msg_meta_data.push_back({LteDirectDiscovery_MsgId_REQUEST_CANCEL_PUBLISH,LteDirectDiscovery_MsgType_REQUEST,LteDirectDiscovery_CancelPublish_fields,sizeof(LteDirectDiscovery_CancelPublish),QCRIL_EVT_NONE,"CANCEL_PUBLISH REQ"});
  ...
  qcril_qmi_lte_direct_disc_msg_meta_data.push_back({LteDirectDiscovery_MsgId_REQUEST_SUBSCRIBE,LteDirectDiscovery_MsgType_REQUEST,LteDirectDiscovery_Subscribe_fields,sizeof(LteDirectDiscovery_Subscribe),QCRIL_EVT_NONE,"SUBSCRIBE REQ"});
  ...
  qcril_qmi_lte_direct_disc_msg_meta_data.push_back({LteDirectDiscovery_MsgId_REQUEST_CANCEL_SUBSCRIBE,LteDirectDiscovery_MsgType_REQUEST,LteDirectDiscovery_CancelSubscribe_fields,sizeof(LteDirectDiscovery_CancelSubscribe),QCRIL_EVT_NONE,"CANCEL_SUBSCRIBE REQ"});
