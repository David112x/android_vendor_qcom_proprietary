...
typedef union
{
  ...
  qmi_uim_conf_code_req_type                    confirmation_code_req;
} req_params;
...
)
{
  ...
  switch(request_type)
  {
   ...
   case QCRIL_UIM_REQUEST_ADD_PROFILE:
    ...
    case QCRIL_UIM_REQUEST_SEND_CONF_CODE:
      memcpy(&request_ptr->confirmation_code_req,param_data_ptr,sizeof(qmi_uim_conf_code_req_type));
      QCRIL_UIM_DUPLICATE(request_ptr->confirmation_code_req.confirmation_code_ptr,
                          ((qmi_uim_conf_code_req_type*)param_data_ptr)->confirmation_code_ptr,
                          strlen(((qmi_uim_conf_code_req_type*)param_data_ptr)->confirmation_code_ptr) + 1,
                          (char *));
      break;
    default:
 ...
 /* Free the request */
  switch(request_type)
  {
    ...
    case QCRIL_UIM_REQUEST_GET_SET_SERVER_ADDRESS:
      ...
      break;
    case QCRIL_UIM_REQUEST_SEND_CONF_CODE:
      QCRIL_UIM_FREE_IF_NOT_NULL(params_ptr->confirmation_code_req.confirmation_code_ptr);
      break;
    case QCRIL_UIM_REQUEST_POWER_UP:
    case QCRIL_UIM_REQUEST_POWER_DOWN:
    case QCRIL_UIM_REQUEST_RESELECT:
