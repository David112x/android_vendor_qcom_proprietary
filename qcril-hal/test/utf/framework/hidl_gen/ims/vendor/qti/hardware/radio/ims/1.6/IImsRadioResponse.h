...
struct IImsRadioResponse : public ::vendor::qti::hardware::radio::ims::V1_5::IImsRadioResponse {
     ...
     *
     */
    virtual ::android::hardware::Return<void> setConfigResponse_1_6(int32_t token, int32_t errorCode, const ::vendor::qti::hardware::radio::ims::V1_6::ConfigInfo& config) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> sendUssdResponse(int32_t token, uint32_t errorCode, const ::vendor::qti::hardware::radio::ims::V1_0::SipErrorInfo& errorDetails) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> cancelPendingUssdResponse(int32_t token, uint32_t errorCode, const ::vendor::qti::hardware::radio::ims::V1_0::SipErrorInfo& errorDetails) = 0;
