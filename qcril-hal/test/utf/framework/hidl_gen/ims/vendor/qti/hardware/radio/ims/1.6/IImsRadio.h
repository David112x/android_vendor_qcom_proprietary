...
struct IImsRadio : public ::vendor::qti::hardware::radio::ims::V1_5::IImsRadio {
     ...
     *
     */
    virtual ::android::hardware::Return<void> dial_1_6(int32_t token, const ::vendor::qti::hardware::radio::ims::V1_6::DialRequest& dialRequest) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> emergencyDial_1_6(int32_t token, const ::vendor::qti::hardware::radio::ims::V1_6::DialRequest& dialRequest, ::android::hardware::hidl_bitfield<::vendor::qti::hardware::radio::ims::V1_5::EmergencyServiceCategory> categories, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& urns, ::vendor::qti::hardware::radio::ims::V1_5::EmergencyCallRoute route, bool hasKnownUserIntentEmergency, bool isTesting) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> sendUssd(int32_t token, const ::android::hardware::hidl_string& ussd) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> cancelPendingUssd(int32_t token) = 0;
     ...
     * @param dialRequest - the struct containing the dial request params like address, clir
     *     call details, etc.
     * @param callComposerInfo - struct containing pre-call (aka call composer) information,
     *     including subject, image, location, and priority
     *
     * Response function is IImsRadioResponse.dialResponse()
     *
     */
    virtual ::android::hardware::Return<void> callComposerDial(int32_t token, const ::vendor::qti::hardware::radio::ims::V1_6::DialRequest& dialRequest, const ::vendor::qti::hardware::radio::ims::V1_6::CallComposerInfo& callComposerInfo) = 0;
