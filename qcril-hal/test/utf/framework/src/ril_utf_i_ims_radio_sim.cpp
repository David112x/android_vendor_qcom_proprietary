...
class IImsRadioIndicationClient : public V1_6::IImsRadioIndication {
 public:
  ...
  ::android::hardware::Return<void> onIncomingCallComposerCallAutoRejected(
    ...
    auto data = (ims_CallComposerAutoRejected*)qcril_malloc(sizeof(ims_CallComposerAutoRejected));
    assert(data != nullptr);
    V1_6::utils::convertFromHidl(data->composer, callComposerInfo);
    V1_6::utils::convertHidlToProtoAutoCallRejectionInfo(autoCallRejectionInfo, data->rej);

    send_i_ims_radio_enqueue_ims_expect(sizeof(ims_CallComposerAutoRejected), data,
                                        ims_MsgId_UNSOL_CALL_COMPOSER_AUTO_REJECTED, -1,
                                        ril_utf_ims_indication, ims_Error_E_SUCCESS);
    return Void();
  }
  ...
  ::android::hardware::Return<void> onCallComposerInfoAvailable(
    ...
    assert(data != nullptr);
    V1_6::utils::convertFromHidl(*data, callComposerInfo);
  ...
  ::android::hardware::Return<void> onIncomingCallAutoRejected_1_6(
    ...
    ims_AutoCallRejectionInfo *msg_data =
              (ims_AutoCallRejectionInfo *)qcril_malloc(sizeof(ims_AutoCallRejectionInfo));
    V1_6::utils::convertHidlToProtoAutoCallRejectionInfo(autoCallRejectionInfo, *msg_data);
    // Decode message and enqueue
    send_i_ims_radio_enqueue_ims_expect(sizeof(ims_AutoCallRejectionInfo), msg_data,
                                        ims_MsgId_UNSOL_AUTO_CALL_REJECTION_IND, -1,
                                        ril_utf_ims_indication, ims_Error_E_SUCCESS);
  ...
  ::android::hardware::Return<void> onRetrievingGeoLocationDataStatus(
      ::vendor::qti::hardware::radio::ims::V1_6::GeoLocationDataStatus geoLocationDataStatus) {
