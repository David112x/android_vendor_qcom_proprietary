...
test_result ril_utf_ims_mt_call_010(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_call_011(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_call_012(user_specified_attrib_t attr);
...
test_result ril_utf_ims_auto_rejected_incoming_call_end_ind_002(user_specified_attrib_t attr);
test_result ril_utf_ims_auto_rejected_incoming_call_end_ind_003(user_specified_attrib_t attr);
test_result ril_utf_ims_auto_rejected_incoming_call_with_call_composer_001(
