...
voice_call_composer_capabilities_info_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_call_composer_capabilities_info(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->call_composer_capabilities_info_valid = TRUE;
  ptr->call_composer_capabilities_info_len = len;
  return (ptr->call_composer_capabilities_info);
}

voice_call_composer_importance_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_call_composer_importance(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->call_composer_importance_valid = TRUE;
  ptr->call_composer_importance_len = len;
  return (ptr->call_composer_importance);
}

voice_call_composer_subject_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_call_composer_subject(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->call_composer_subject_valid = TRUE;
  ptr->call_composer_subject_len = len;
  return (ptr->call_composer_subject);
}

voice_call_composer_pic_url_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_call_composer_picture_url(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->call_composer_picture_url_valid = TRUE;
  ptr->call_composer_picture_url_len = len;
  return (ptr->call_composer_picture_url);
}

voice_call_composer_location_circle_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_call_composer_circle_location(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->call_composer_circle_location_valid = TRUE;
  ptr->call_composer_circle_location_len = len;
  return (ptr->call_composer_circle_location);
}

voice_call_composer_location_point_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_call_composer_point_location(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->call_composer_point_location_valid = TRUE;
  ptr->call_composer_point_location_len = len;
  return (ptr->call_composer_point_location);
}
...
========================================================*/
auto_rejected_incoming_call_end_ind_msg_v02*
ril_utf_qmiril_if::update_default_qmi_voice_auto_rejected_incoming_call_end_ind_msg(
    ...
    mt_ims_verstat_enum_v02 mt_call_verstat_info)
{
  ...
  ptr->sip_error_code = sip_error_code;
  ptr->mt_call_verstat_info = mt_call_verstat_info;

  return ptr;
}
void ril_utf_qmiril_if::set_qmi_voice_auto_rejected_incoming_call_end_ind_num(const char *number)
{
  auto_rejected_incoming_call_end_ind_msg_v02 *ptr = (auto_rejected_incoming_call_end_ind_msg_v02 *) payload;
  if (number)
  {
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_imsa_ind_reg_req_v01(imsa_ind_reg_req_msg_v01 *msg)
{
...
/*========================================================
  QMI_IMSA_GPS_INFO_IND_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_imsa_gps_info_ind(imsa_gps_error_reason_enum_v01 gps_error_reason)
{
  payload = (void *) malloc(sizeof(imsa_gps_error_ind_msg_v01));
  payload_len = sizeof(imsa_gps_error_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_IMSA;
  msg_id = QMI_IMSA_GPS_INFO_IND_V01;
  imsa_gps_error_ind_msg_v01 *ptr = (imsa_gps_error_ind_msg_v01 *) payload;
  ptr->gps_error_reason = gps_error_reason;
}
