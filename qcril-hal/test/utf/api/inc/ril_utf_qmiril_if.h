...
*/
  ...
  // composer info related
  voice_call_composer_capabilities_info_type_v02*
  set_qmi_voice_all_call_status_ind_call_composer_capabilities_info(uint32_t len);
  voice_call_composer_importance_type_v02*
  set_qmi_voice_all_call_status_ind_call_composer_importance(uint32_t len);
  voice_call_composer_subject_type_v02*
  set_qmi_voice_all_call_status_ind_call_composer_subject(uint32_t len);
  voice_call_composer_pic_url_type_v02*
  set_qmi_voice_all_call_status_ind_call_composer_picture_url(uint32_t len);
  voice_call_composer_location_circle_type_v02*
  set_qmi_voice_all_call_status_ind_call_composer_circle_location(uint32_t len);
  voice_call_composer_location_point_type_v02*
  set_qmi_voice_all_call_status_ind_call_composer_point_location(uint32_t len);
...
update_default_qmi_voice_auto_rejected_incoming_call_end_ind_msg(
...
void set_qmi_voice_auto_rejected_incoming_call_end_ind_num(const char *number);
...
*/
void update_default_qmi_imsa_ind_reg_req_v01(imsa_ind_reg_req_msg_v01 *msg = nullptr);
...
*/
void update_default_qmi_imsa_gps_info_ind(imsa_gps_error_reason_enum_v01 gps_error_reason);
#endif
