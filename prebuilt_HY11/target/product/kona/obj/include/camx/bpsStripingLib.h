...
/** function pointer definition for creating BPS striping library context */
typedef int32_t(*BpsStripingLibraryContextCreate_t)(const BpsConfigIoData* configIO,
    StripingLibMemOp* mem,
...
/** function pointer definition for BPS striping library context execute */
typedef int32_t(*BpsStripingLibraryExecute_t)(SL_HANDLE handle,
    const BPSStripingLibExecuteParams* exe,
    void* outputBuffer,
    BPSStripingLibExecuteMetaData* metaDataBuffer,
    userBPSArgs* pUserBPSArgs);

/** function pointer definition for destroying BPS striping library context */
typedef int32_t(*BpsStripingLibraryContextDestroy_t)(SL_HANDLE* handle);
#ifdef __cplusplus
}
#endif
