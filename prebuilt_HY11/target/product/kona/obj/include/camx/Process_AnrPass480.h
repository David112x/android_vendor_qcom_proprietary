...
#ifndef __PROCESS_ANR_PASS480_H__
#define __PROCESS_ANR_PASS480_H__

#include <string.h>
#include "ANR_Chromatix.h"
#include "ANR_Registers480.h"
...
*/
int32_t ANR_FlowProcessNcLib480(
    ANR_Chromatix* chromatixHeaderPasses,
    NCLIB_CONTEXT_ANR* context,
    IPEANRRegCmd480* registerStructPasses,
...
*/
int32_t ANR_ValidateNcLibRegs480(IPEANRRegCmd480* registerStruct, uint32_t numOfPasses, uint32_t mE);
...
*  @return void
*/
void SetDefaultVal_ANR480(IPEANRRegCmd480* registerStruct, uint32_t numOfPasses, uint32_t mE);
...
#endif //__PROCESS_ANR_PASS480_H__
