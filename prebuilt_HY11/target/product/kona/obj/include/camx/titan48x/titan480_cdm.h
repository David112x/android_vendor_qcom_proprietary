...
==============================================================================*/
#ifndef TITAN480_CDM_H
#define TITAN480_CDM_H
...
#define CDM_REGS_LAST 0x1fc

#define CDM_REGS_COUNT 0x3b
...
#define regCDM_CPAS_CDM_COMP_WAIT_STATUS0 0x88  /*register offset*/
#define CDM_CPAS_CDM_COMP_WAIT_STATUS0_WAITING_MASK 0xffffffff
#define CDM_CPAS_CDM_COMP_WAIT_STATUS0_WAITING_SHIFT 0x0

#define regCDM_CPAS_CDM_COMP_WAIT_STATUS1 0x8c  /*register offset*/
#define CDM_CPAS_CDM_COMP_WAIT_STATUS1_WAITING_MASK 0xffffffff
#define CDM_CPAS_CDM_COMP_WAIT_STATUS1_WAITING_SHIFT 0x0
...
#define regCDM_CPAS_CDM_PERF_COUNT_CFG_0 0x180  /*register offset*/
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_CNTR_START_CMD_MASK 0x1
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_CNTR_START_CMD_SHIFT 0x0
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_CNTR_STOP_CMD_MASK 0x2
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_CNTR_STOP_CMD_SHIFT 0x1
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_CONTINUOUS_MODE_MASK 0x4
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_CONTINUOUS_MODE_SHIFT 0x2
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_UNUSED0_MASK 0x8
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_UNUSED0_SHIFT 0x3
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_EVENT_SEL_MASK 0x70
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_EVENT_SEL_SHIFT 0x4
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_UNUSED1_MASK 0x80
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_UNUSED1_SHIFT 0x7
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_CLIENT_SEL_MASK 0x1f00
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_CLIENT_SEL_SHIFT 0x8
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_UNUSED2_MASK 0xe000
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_UNUSED2_SHIFT 0xd
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_WINDOW_START_SEL_MASK 0xf0000
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_WINDOW_START_SEL_SHIFT 0x10
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_WINDOW_END_SEL_MASK 0xf00000
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_WINDOW_END_SEL_SHIFT 0x14
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_NUM_WINDOW_MASK 0xff000000
#define CDM_CPAS_CDM_PERF_COUNT_CFG_0_NUM_WINDOW_SHIFT 0x18

#define regCDM_CPAS_CDM_PERF_ALWAYS_COUNT_VAL 0x184  /*register offset*/
#define CDM_CPAS_CDM_PERF_ALWAYS_COUNT_VAL_VAL_MASK 0xffffffff
#define CDM_CPAS_CDM_PERF_ALWAYS_COUNT_VAL_VAL_SHIFT 0x0

#define regCDM_CPAS_CDM_PERF_BUSY_COUNT_VAL 0x188  /*register offset*/
#define CDM_CPAS_CDM_PERF_BUSY_COUNT_VAL_VAL_MASK 0xffffffff
#define CDM_CPAS_CDM_PERF_BUSY_COUNT_VAL_VAL_SHIFT 0x0

#define regCDM_CPAS_CDM_PERF_STALL_AXI_COUNT_VAL 0x18c  /*register offset*/
#define CDM_CPAS_CDM_PERF_STALL_AXI_COUNT_VAL_VAL_MASK 0xffffffff
#define CDM_CPAS_CDM_PERF_STALL_AXI_COUNT_VAL_VAL_SHIFT 0x0

#define regCDM_CPAS_CDM_PERF_COUNT_STATUS 0x190  /*register offset*/
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_PERF_ALWAYS_COUNT_DONE_MASK 0x1
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_PERF_ALWAYS_COUNT_DONE_SHIFT 0x0
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_UNUSED0_MASK 0xe
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_UNUSED0_SHIFT 0x1
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_PERF_BUSY_COUNT_DONE_MASK 0x10
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_PERF_BUSY_COUNT_DONE_SHIFT 0x4
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_UNUSED1_MASK 0xe0
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_UNUSED1_SHIFT 0x5
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_PERF_STALL_AXI_COUNT_DONE_MASK 0x100
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_PERF_STALL_AXI_COUNT_DONE_SHIFT 0x8
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_UNUSED2_MASK 0xfffffe00
#define CDM_CPAS_CDM_PERF_COUNT_STATUS_UNUSED2_SHIFT 0x9

#define regCDM_CPAS_CDM_ICL_LAST_DATA0 0x1c0  /*register offset*/
#define CDM_CPAS_CDM_ICL_LAST_DATA0_DATA_MASK 0xffffffff
#define CDM_CPAS_CDM_ICL_LAST_DATA0_DATA_SHIFT 0x0

#define regCDM_CPAS_CDM_ICL_LAST_DATA1 0x1c4  /*register offset*/
#define CDM_CPAS_CDM_ICL_LAST_DATA1_DATA_MASK 0xffffffff
#define CDM_CPAS_CDM_ICL_LAST_DATA1_DATA_SHIFT 0x0

#define regCDM_CPAS_CDM_ICL_LAST_DATA2 0x1c8  /*register offset*/
#define CDM_CPAS_CDM_ICL_LAST_DATA2_DATA_MASK 0xffffffff
#define CDM_CPAS_CDM_ICL_LAST_DATA2_DATA_SHIFT 0x0

#define regCDM_CPAS_CDM_ICL_INV_DATA 0x1cc  /*register offset*/
#define CDM_CPAS_CDM_ICL_INV_DATA_DATA_MASK 0xffffffff
#define CDM_CPAS_CDM_ICL_INV_DATA_DATA_SHIFT 0x0

#define regCDM_CPAS_CDM_SPARE 0x1fc  /*register offset*/
...
} _cdm_cpas_cdm_comp_wait_status0;

typedef union{
    _cdm_cpas_cdm_comp_wait_status0 bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_COMP_WAIT_STATUS0;

typedef struct{
    unsigned  WAITING : 32; /* 31:0 */
} _cdm_cpas_cdm_comp_wait_status1;

typedef union{
    _cdm_cpas_cdm_comp_wait_status1 bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_COMP_WAIT_STATUS1;
...
} _cdm_cpas_cdm_perf_count_cfg_0;

typedef union{
    _cdm_cpas_cdm_perf_count_cfg_0 bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_PERF_COUNT_CFG_0;

typedef struct{
    unsigned  VAL : 32; /* 31:0 */
} _cdm_cpas_cdm_perf_always_count_val;

typedef union{
    _cdm_cpas_cdm_perf_always_count_val bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_PERF_ALWAYS_COUNT_VAL;

typedef struct{
    unsigned  VAL : 32; /* 31:0 */
} _cdm_cpas_cdm_perf_busy_count_val;

typedef union{
    _cdm_cpas_cdm_perf_busy_count_val bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_PERF_BUSY_COUNT_VAL;

typedef struct{
    unsigned  VAL : 32; /* 31:0 */
} _cdm_cpas_cdm_perf_stall_axi_count_val;

typedef union{
    _cdm_cpas_cdm_perf_stall_axi_count_val bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_PERF_STALL_AXI_COUNT_VAL;
...
} _cdm_cpas_cdm_perf_count_status;

typedef union{
    _cdm_cpas_cdm_perf_count_status bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_PERF_COUNT_STATUS;

typedef struct{
    unsigned  DATA : 32; /* 31:0 */
} _cdm_cpas_cdm_icl_last_data0;

typedef union{
    _cdm_cpas_cdm_icl_last_data0 bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_ICL_LAST_DATA0;

typedef struct{
    unsigned  DATA : 32; /* 31:0 */
} _cdm_cpas_cdm_icl_last_data1;

typedef union{
    _cdm_cpas_cdm_icl_last_data1 bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_ICL_LAST_DATA1;

typedef struct{
    unsigned  DATA : 32; /* 31:0 */
} _cdm_cpas_cdm_icl_last_data2;

typedef union{
    _cdm_cpas_cdm_icl_last_data2 bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_ICL_LAST_DATA2;

typedef struct{
    unsigned  DATA : 32; /* 31:0 */
} _cdm_cpas_cdm_icl_inv_data;

typedef union{
    _cdm_cpas_cdm_icl_inv_data bitfields,bits;
    unsigned int u32All;

} CDM_CPAS_CDM_ICL_INV_DATA;
