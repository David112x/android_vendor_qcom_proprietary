...
#define HLSTATUS_MEMMAP_INVALID         (HLSTATUS_ERROR_BASE + 0x0000a)
#define HLSTATUS_RESET_FAILURE          (HLSTATUS_ERROR_BASE + 0x0000b)
//------------------------------------------------------------------------
...
#define LLSTATUS_HW_RESET_FAILURE       (LLSTATUS_ERROR_BASE + 0x0000c)
...
typedef enum _ProgramType
{
    ...
    */
    ...
    BPS_HNR_LUT_PROGRAM,
    BPS_UVG_LUT_PROGRAM,
    BPS_LCAC_LUT_PROGRAM,
    BPS_BAYER_LTM_LUT_PROGRAM,
    ...
    IPE_GRA_LUT_PROGRAM,
    IPE_HNR_LUT_PROGRAM,
    IPE_DSX_Y_LUT_PROGRAM,
    IPE_DSX_C_LUT_PROGRAM,
    IPE_MFHDR_MAC_LUT_PROGRAM,
    IPE_MFHDR_GLUT_0_LUT_PROGRAM,
    IPE_MFHDR_GLUT_1_LUT_PROGRAM,
    IPE_MFHDR_GLUT_2_LUT_PROGRAM,
    IPE_MFHDR_GTM_LUT_PROGRAM,
    IPE_MFHDR_LTM_LUT_PROGRAM,
    IPE_MFHDR_GLUT_3_LUT_PROGRAM,
    PROGRAM_TYPE_LUT_MAX,

    /* Non-LUT type programs used by High Level Driver in FW */
    PROGRAM_TYPE_NON_LUT_START = 64,
    IPE_ICA1_PROGRAM = PROGRAM_TYPE_NON_LUT_START,
    IPE_ICA2_PROGRAM,
    IPE_ANR_CYLPF_PROGRAM,
    IPE_TF_PROGRAM,
    IPE_DSX_PROGRAM,
    IPE_MFHDR_LTM_PROGRAM,
    PROGRAM_TYPE_FW_END,
