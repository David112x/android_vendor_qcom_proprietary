...
typedef struct TF_Chromatix_TAG
{
    ...
    // Enable of local motion compensation
    // format: 1u
    PARAM_UINT lmc_enable;

    // Multiplicative factor for validation of previous-pass local motion vectors
    // format: 8u4
    PARAM_UINT lmc_default_sad_c1;

    // Additive offset for validation of previous-pass local motion vectors
    // format: 8u
    PARAM_UINT lmc_default_sad_c2;

    // Multiplicative factor for validation of current-pass local motion vectors
    // format: 8u4
    PARAM_UINT lmc_sad_c1;

    // Additive offset for validation of current-pass local motion vectors
    // format: 8u
    PARAM_UINT lmc_sad_c2;

    // Multiplicative factor for local motion smoothness
    // format: 8u
    PARAM_UINT lmc_smoothness_m;

    // Additive offset for local motion smoothness
    // format: 5u
    PARAM_UINT lmc_smoothness_a;

    // Maximal absolute value of local motion vector X component
    // format: 6u6
    PARAM_UINT lmc_max_x;

    // Maximal absolute value of local motion vector Y component
    // format: 6u6
    PARAM_UINT lmc_max_y;
    ...
    // Confidence threshold for validation of local motion
    // format: float
    PARAM_FLOAT lmc_conf;

    // Irregularity threshold for validating local motion
    // format: float
    PARAM_FLOAT lmc_irreg;

    // Threshold on LMC-refinement difference
    // format: 5uQ4
    PARAM_UINT lmc_mv_diff_thr;
