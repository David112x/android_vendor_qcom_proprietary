...
/**
 * @brief Synchronous API to  to limit number of concurrent
 *        running instances to 4 with in a session.
 *
 * @param[in] swvdec: SwVdec handle.
 *
 * @retval SWVDEC_STATUS_SUCCESS
 * @retval SWVDEC_STATUS_NULL_POINTER
 * @retval SWVDEC_STATUS_INSUFFICIENT_RESOURCES
 */
SWVDEC_STATUS swvdec_check_inst_load(SWVDEC_HANDLE swvdec);
