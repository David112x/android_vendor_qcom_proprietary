...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL TF20Setting::CalculateHWSetting(
    ...
    VOID*                                               pOutput)
{
    ...
    if ((NULL != pInput) && (NULL != pData))
    {
        ...
        tf_2_0_0::tf20_rgn_dataType*  pPassUnpackedData;
        ...
        for (UINT32 passType = 0; passType < pInput->maxUsedPasses; passType++)
        {
            ...
            {
                pPassUnpackedData = &pData->mod_tf20_pass_data[passType].tf20_rgn_data;
            ...
            {
                pReserveData->mod_tf20_pass_reserve_data[passType].pass_data.is_anr_strength_blender_mode = 0;
            }
        }
        result = MapChromatix2TFChromatix(pReserveData->mod_tf20_pass_reserve_data,
                                          pData,
                                          pInput,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// TF20Setting::GetTFPerPassRegionData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
tf_2_0_0::tf20_rgn_dataType* TF20Setting::GetTFPerPassRegionData(
    tf_2_0_0::mod_tf20_cct_dataType::cct_dataStruct* pUnpackedData,
    const TF20InputData*                             pInput,
    UINT32                                           passType)
{
    tf_2_0_0::tf20_rgn_dataType*  pPassUnpackedData = NULL;

    if (pInput->maxUsedPasses < pInput->maxSupportedPassesForUsecase)
    {
        pPassUnpackedData = (0 == passType) ? &pUnpackedData->mod_tf20_pass_data[passType].tf20_rgn_data :
            &pUnpackedData->mod_tf20_pass_data[
                (pInput->maxSupportedPassesForUsecase - pInput->maxUsedPasses + passType)].tf20_rgn_data;
    ...
    {
        pPassUnpackedData = &pUnpackedData->mod_tf20_pass_data[passType].tf20_rgn_data;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// TF20Setting::GetTFPerPassReservedData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
tf_2_0_0::mod_tf20_pass_reserve_dataType::pass_dataStruct* TF20Setting::GetTFPerPassReservedData(
    tf_2_0_0::mod_tf20_pass_reserve_dataType*        pReserveData,
    const TF20InputData*                             pInput,
    UINT32                                           passType)
{
    tf_2_0_0::mod_tf20_pass_reserve_dataType::pass_dataStruct* pPassReserveData = NULL;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// TF20Setting::MapChromatix2TFChromatix
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL TF20Setting::MapChromatix2TFChromatix(
    tf_2_0_0::mod_tf20_pass_reserve_dataType*        pReserveData,
    tf_2_0_0::mod_tf20_cct_dataType::cct_dataStruct* pUnpackedData,
    const TF20InputData*                             pInput,
    UINT32                                           passNumMax,
...
{
    TF_Chromatix*                                              pPassTFChromatix  = NULL;
    tf_2_0_0::tf20_rgn_dataType*                               pPassUnpackedData = NULL;
    tf_2_0_0::mod_tf20_pass_reserve_dataType::pass_dataStruct* pPassReserveData  = NULL;
    BOOL                                                       result            = TRUE;
    UINT32    idx;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// TF20Setting::CopyUINT32toINT32ArrayWithSize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID TF20Setting::CopyUINT32toINT32ArrayWithSize(
    INT32*        pDstArrayName,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// TF20Setting::CopyINT32toINT32ArrayWithSize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID TF20Setting::CopyINT32toINT32ArrayWithSize(
    INT32*       pDstArrayName,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// TF20Setting::CopyUINT32toUINT8ArrayWithSize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID TF20Setting::CopyUINT32toUINT8ArrayWithSize(
    UINT8*        pDstArrayName,
    const UINT32* pSrcArrayName,
    INT           arraySize)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL TF20Setting::GetInitializationData(
