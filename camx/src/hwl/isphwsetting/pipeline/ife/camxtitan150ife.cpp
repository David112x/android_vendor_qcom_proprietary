...
static const UINT32 IFE150CGCNumRegs = sizeof(IFE150CGCOnCmds) / (2 * sizeof(UINT32));

CAMX_NAMESPACE_BEGIN

IFEIQModuleInfo IFEIQModuleItems1[] =
{
    {ISPIQModuleType::SWTMC,                    IFEPipelinePath::CommonPath,    TRUE,  SWTMC11::CreateIFE},
    ...
    {ISPIQModuleType::IFEHDR,                   IFEPipelinePath::CommonPath,    TRUE,  IFEHDR23::Create},
    ...
    {ISPIQModuleType::IFEDemosaic,              IFEPipelinePath::CommonPath,    TRUE,  IFEDemosaic37::Create},
...
static IFEStatsModuleInfo IFEStatsModuleItems1[] =
{
    ...
    {ISPStatsModuleType::IFEBF,         TRUE, IFEBFStats24::Create},
    {ISPStatsModuleType::IFEAWBBG,      TRUE, AWBBGStats14::Create}
};


////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Titan150IFE::FetchPipelineCapability
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID Titan150IFE::FetchPipelineCapability(
    VOID* pPipelineCapability)
{
    IFECapabilityInfo*   pIFECapability = static_cast<IFECapabilityInfo*>(pPipelineCapability);

    pIFECapability->numIFEIQModule      = sizeof(IFEIQModuleItems1) / sizeof(IFEIQModuleInfo);
    pIFECapability->pIFEIQModuleList    = &IFEIQModuleItems1[0];
    pIFECapability->numIFEStatsModule   = sizeof(IFEStatsModuleItems1) / sizeof(IFEStatsModuleInfo);
    pIFECapability->pIFEStatsModuleList = &IFEStatsModuleItems1[0];
    ...
    pIFECapability->LDCSupport               = FALSE;
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Titan150IFE::ProgramIQModuleEnableConfig()
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult Titan150IFE::ProgramIQModuleEnableConfig(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Titan150IFE::GetISPIQModulesOfType()
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID Titan150IFE::GetISPIQModulesOfType(
    ISPIQModuleType moduleType,
    VOID*           pModuleInfo)
{
    UINT            numOfIQModule = sizeof(IFEIQModuleItems1) / sizeof(IFEIQModuleInfo);
    IFEIQModuleInfo* pIFEmoduleInfo = static_cast<IFEIQModuleInfo*>(pModuleInfo);

    for (UINT i = 0; i < numOfIQModule; i++)
    {
        if (IFEIQModuleItems1[i].moduleType == moduleType)
        {
            Utils::Memcpy(pIFEmoduleInfo, &IFEIQModuleItems1[i], sizeof(IFEIQModuleInfo));
            break;
        }
    }
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Titan150IFE::FillConfigTuningMetadata()
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID Titan150IFE::FillConfigTuningMetadata(
    ISPInputData* pInputData)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Titan150IFE::DumpTuningMetadata()
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID Titan150IFE::DumpTuningMetadata(
    ISPInputData*       pInputData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Titan150IFE::FillCGCConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID Titan150IFE::FillCGCConfig(
    CmdBuffer*  pCmdBuffer)
{
    if (NULL != pCmdBuffer)
    {
        PacketBuilder::WriteInterleavedRegs(pCmdBuffer, IFE150CGCNumRegs, IFE150CGCOnCmds);
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Titan150IFE::FillFlushConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID Titan150IFE::FillFlushConfig(
    CmdBuffer*  pCmdBuffer)
{
    if (NULL != pCmdBuffer)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Titan150IFE::GetIFEDefaultConfig()
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID Titan150IFE::GetIFEDefaultConfig(
    IFEDefaultModuleConfig* pDefaultData)
{
    pDefaultData->RSStatsHorizRegions   = RSStats14MaxHorizRegions;
    pDefaultData->RSStatsVertRegions    = RSStats14MaxHorizRegions;
