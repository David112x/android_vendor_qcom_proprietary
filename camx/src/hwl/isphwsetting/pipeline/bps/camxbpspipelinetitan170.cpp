...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxbpspipelinetitan170.cpp
...
static BPSIQModuleInfo BPSPipeline170ModuleList[] =
{
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSPipelineTitan170::GetModuleListForMode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSPipelineTitan170::GetModuleListForMode(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSPipelineTitan170::GetModuleList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSPipelineTitan170::GetModuleList(
    BPSIQModuleList* pIQmoduleInfo)
{
    ...
    if (NULL != pIQmoduleInfo)
    {
        ...
        UINT32 numBPSModules = sizeof(BPSPipeline170ModuleList) / sizeof(BPSIQModuleInfo);

        for (UINT32 i = 0; i < numBPSModules; i++)
        {
            if (TRUE == BPSPipeline170ModuleList[i].isEnabled)
            {
                pIQmoduleInfo->pBPSIQModule[pIQmoduleInfo->numBPSIQModules] = &BPSPipeline170ModuleList[i];
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSPipelineTitan170::GetCapability
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSPipelineTitan170::GetCapability(
