...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxbpspipelinetitan160.cpp
...
static BPSIQModuleInfo BPSPipeline160ModuleList[] =
{
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSPipelineTitan160::GetModuleListForMode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSPipelineTitan160::GetModuleListForMode(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSPipelineTitan160::GetCapability
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSPipelineTitan160::GetCapability(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSPipelineTitan160::GetModuleList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSPipelineTitan160::GetModuleList(
    BPSIQModuleList* pIQmoduleInfo)
{
    CamxResult result = CamxResultSuccess;
    ...
    if (NULL != pIQmoduleInfo)
    {
        ...
        UINT32 numBPSModules = sizeof(BPSPipeline160ModuleList) / sizeof(BPSIQModuleInfo);

        for (UINT32 i = 0; i < numBPSModules; i++)
        {
            if (TRUE == BPSPipeline160ModuleList[i].isEnabled)
            {
                pIQmoduleInfo->pBPSIQModule[pIQmoduleInfo->numBPSIQModules] = &BPSPipeline160ModuleList[i];
