...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxipe2dlut10titan480.cpp
/// @brief IPE2DLUT10Titan480 class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPE2DLUT10Titan480::IPE2DLUT10Titan480
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
IPE2DLUT10Titan480::IPE2DLUT10Titan480()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPE2DLUT10Titan480::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPE2DLUT10Titan480::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPE2DLUT10Titan480::WriteLUTtoDMI
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPE2DLUT10Titan480::WriteLUTtoDMI(
    ISPInputData* pInputData)
{
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexHue0!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexHue1!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexHue2!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexHue3!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexSaturation0!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexSaturation1!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexSaturation2!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexSaturation3!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexInverseHue!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndexInverseSaturation!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndex1DHue!");
    }
    ...
    if (CamxResultSuccess != result)
    {
        CAMX_LOG_ERROR(CamxLogGroupPProc, "PacketBuilder::WriteDMI failed for LUT2DIndex1DSaturation!");
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPE2DLUT10Titan480::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPE2DLUT10Titan480::PackIQRegisterSetting(
    VOID*  pInput,
    VOID*  pOutputVal)
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPE2DLUT10Titan480::SetupRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPE2DLUT10Titan480::SetupRegisterSetting(
    VOID*  pInput)
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPE2DLUT10Titan480::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPE2DLUT10Titan480::UpdateTuningMetadata(
    VOID*  pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    if ((NULL != pInputData->pIPETuningMetadata) && (NULL != pRegCmd))
    {
        CAMX_STATIC_ASSERT(sizeof(IPER2DLUTRegCmd) ==
            sizeof(pIPETuningMetadata->IPETuningMetadata480.IPE2DLUTData.LUT2DConfig));

        Utils::Memcpy(&pIPETuningMetadata->IPETuningMetadata480.IPE2DLUTData.LUT2DConfig,
                        pRegCmd,
        ...
        if (TRUE == pIPEIQSettings->lut2dParameters.moduleCfg.EN)
        {
            ...
            result = pInputData->pipelineIPEData.pDebugDataWriter->AddDataTag(
                ...
                CAMX_ARRAY_SIZE(pIPETuningMetadata->IPETuningMetadata480.IPE2DLUTData.LUT2DConfig),
                &pIPETuningMetadata->IPETuningMetadata480.IPE2DLUTData.LUT2DConfig,
                sizeof(pIPETuningMetadata->IPETuningMetadata480.IPE2DLUTData.LUT2DConfig));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPE2DLUT10Titan480::GetRegSize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT IPE2DLUT10Titan480::GetRegSize()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPE2DLUT10Titan480::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPE2DLUT10Titan480::DumpRegConfig()
{
    if (NULL != m_pRegCmd)
    {
