...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxbpscc13titan480.cpp
/// @brief CAMXBPSCC13TITAN480 class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
static const UINT32 BPSCC13RegConfigLengthDWord = sizeof(BPSCC13RegConfig) / sizeof(UINT32);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCC13Titan480::BPSCC13Titan480
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BPSCC13Titan480::BPSCC13Titan480()
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCC13Titan480::Create
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCC13Titan480::Create(
    ISPHWSetting** ppHWSetting)
{
    CamxResult result = CamxResultSuccess;

    BPSCC13Titan480* pHWSetting = CAMX_NEW BPSCC13Titan480;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// BPSCC13Titan480::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCC13Titan480::Initialize()
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCC13Titan480::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCC13Titan480::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCC13Titan480::UpdateFirmwareData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCC13Titan480::UpdateFirmwareData(
    VOID*   pSettingData,
    BOOL    moduleEnable)
{
    ISPInputData*        pInputData     = static_cast<ISPInputData*>(pSettingData);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCC13Titan480::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCC13Titan480::UpdateTuningMetadata(
    VOID* pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    if (NULL != pBPSTuningMetadata)
    {
        CAMX_STATIC_ASSERT(sizeof(BPSCC13RegConfig) <=
            sizeof(pBPSTuningMetadata->BPSTuningMetadata480.BPSCCData.colorCorrectionConfig));

        Utils::Memcpy(&pBPSTuningMetadata->BPSTuningMetadata480.BPSCCData.colorCorrectionConfig,
                        pRegCmd,
            ...
            (NULL != pInputData->pipelineBPSData.pDebugDataWriter))
        {
            result = pInputData->pipelineBPSData.pDebugDataWriter->AddDataTag(
                ...
                CAMX_ARRAY_SIZE(pBPSTuningMetadata->BPSTuningMetadata480.BPSCCData.colorCorrectionConfig),
                &pBPSTuningMetadata->BPSTuningMetadata480.BPSCCData.colorCorrectionConfig,
                sizeof(pBPSTuningMetadata->BPSTuningMetadata480.BPSCCData.colorCorrectionConfig));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCC13Titan480::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCC13Titan480::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult         result  = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCC13Titan480::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID BPSCC13Titan480::DumpRegConfig()
{
    BPSCC13RegConfig*  pRegCmd = static_cast<BPSCC13RegConfig*>(m_pRegCmd);
