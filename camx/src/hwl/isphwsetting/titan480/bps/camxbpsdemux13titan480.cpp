...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxbpsdemux13titan480.cpp
/// @brief CAMXBPSDEMUX13TITAN480 class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
static const UINT32 BPSDemux13RegLengthDWord = sizeof(BPSDemux13RegCmd) / sizeof(UINT32);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSDemux13Titan480::BPSDemux13Titan480
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BPSDemux13Titan480::BPSDemux13Titan480()
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSDemux13Titan480::Create
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSDemux13Titan480::Create(
    ISPHWSetting** ppHWSetting)
{
    CamxResult result = CamxResultSuccess;

    BPSDemux13Titan480* pHWSetting = CAMX_NEW BPSDemux13Titan480;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// BPSDemux13Titan480::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSDemux13Titan480::Initialize()
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSDemux13Titan480::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSDemux13Titan480::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSDemux13Titan480::UpdateFirmwareData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSDemux13Titan480::UpdateFirmwareData(
    VOID*   pSettingData,
    BOOL    moduleEnable)
{
    ISPInputData*  pInputData     = static_cast<ISPInputData*>(pSettingData);
    ...
    if (NULL != pBPSIQSettings)
    {
        ...
        pBPSIQSettings->pdpcParameters_480.moduleCfg.CHANNEL_BALANCE_EN  = moduleEnable;
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSDemux13Titan480::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSDemux13Titan480::UpdateTuningMetadata(
    VOID* pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    if (NULL != pBPSTuningMetadata)
    {
        CAMX_STATIC_ASSERT(sizeof(BPSDemux13RegCmd) <=
            sizeof(pBPSTuningMetadata->BPSTuningMetadata480.BPSDemuxData.demuxConfig));

        Utils::Memcpy(&pBPSTuningMetadata->BPSTuningMetadata480.BPSDemuxData.demuxConfig,
                        pRegCmd,
        ...
        if (NULL != pInputData->pipelineBPSData.pDebugDataWriter)
        {
            result = pInputData->pipelineBPSData.pDebugDataWriter->AddDataTag(
                ...
                CAMX_ARRAY_SIZE(pBPSTuningMetadata->BPSTuningMetadata480.BPSDemuxData.demuxConfig),
                &pBPSTuningMetadata->BPSTuningMetadata480.BPSDemuxData.demuxConfig,
                sizeof(pBPSTuningMetadata->BPSTuningMetadata480.BPSDemuxData.demuxConfig));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSDemux13Titan480::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSDemux13Titan480::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult            result  = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSDemux13Titan480::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID BPSDemux13Titan480::DumpRegConfig()
{
    BPSDemux13RegCmd* pRegCmd = static_cast<BPSDemux13RegCmd*>(m_pRegCmd);
