...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxbpsabf40titan480.cpp
/// @brief CAMXBPSABF40TITAN480 class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
static const UINT32 NoiseLUT   = BPS_BPS_0_CLC_ABF_DMI_LUT_CFG_LUT_SEL_NOISE_LUT;
static const UINT32 ActivityLUT = BPS_BPS_0_CLC_ABF_DMI_LUT_CFG_LUT_SEL_ACT_LUT;
static const UINT32 DarkLUT     = BPS_BPS_0_CLC_ABF_DMI_LUT_CFG_LUT_SEL_DARK_LUT;

static const UINT32 BPSABF40RegConfigLengthDWord = sizeof(BPSABF40RegConfig) / sizeof(UINT32);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Titan480::BPSABF40Titan480
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BPSABF40Titan480::BPSABF40Titan480()
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Titan480::Create
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSABF40Titan480::Create(
    ISPHWSetting** ppHWSetting)
{
    CamxResult result = CamxResultSuccess;

    BPSABF40Titan480* pHWSetting = CAMX_NEW BPSABF40Titan480;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// BPSABF40Titan480::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSABF40Titan480::Initialize()
{
    CamxResult result = CamxResultSuccess;
    ...
    else
    {
        ...
        if (NULL != m_pRegCmd)
        {
            ...
            Set32bitDMILength((BPSABF40NoiseLUTSizeDword + BPSABF40ActivityLUTSizeDword + BPSABF40DarkLUTSizeDword));
        }
        else
        {
            result = CamxResultENoMemory;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Titan480::WriteLUTtoDMI
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSABF40Titan480::WriteLUTtoDMI(
    VOID*   pInput)
{
    CamxResult      result      = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Titan480::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSABF40Titan480::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Titan480::UpdateFirmwareData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSABF40Titan480::UpdateFirmwareData(
    VOID*   pSettingData,
    BOOL    moduleEnable)
{
    ISPInputData*   pInputData     = static_cast<ISPInputData*>(pSettingData);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Titan480::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSABF40Titan480::UpdateTuningMetadata(
    VOID* pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    {
        CAMX_STATIC_ASSERT(sizeof(BPSABF40RegConfig) <= sizeof(pBPSTuningMetadata->BPSTuningMetadata480.BPSABFData.config));

        Utils::Memcpy(&pBPSTuningMetadata->BPSTuningMetadata480.BPSABFData.config, pRegCmd, sizeof(BPSABF40RegConfig));

        if ((TRUE == pBPSIQSettings->abfParameters.moduleCfg.EN) && (NULL != pInputData->pipelineBPSData.pDebugDataWriter))
        {
            result = pInputData->pipelineBPSData.pDebugDataWriter->AddDataTag(
                DebugDataTagID::TuningBPSABFRegister,
                DebugDataTagType::UInt32,
                CAMX_ARRAY_SIZE(pBPSTuningMetadata->BPSTuningMetadata480.BPSABFData.config),
                &pBPSTuningMetadata->BPSTuningMetadata480.BPSABFData.config,
                sizeof(pBPSTuningMetadata->BPSTuningMetadata480.BPSABFData.config));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Titan480::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSABF40Titan480::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult               result  = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Titan480::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID BPSABF40Titan480::DumpRegConfig()
{
    BPSABF40RegConfig* pRegCmd = static_cast<BPSABF40RegConfig*>(m_pRegCmd);
