...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxbpscst12titan480.cpp
/// @brief CAMXBPSCST12TITAN480 class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCST12Titan480::BPSCST12Titan480
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BPSCST12Titan480::BPSCST12Titan480()
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCST12Titan480::Create
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCST12Titan480::Create(
    ISPHWSetting** ppHWSetting)
{
    CamxResult result = CamxResultSuccess;

    BPSCST12Titan480* pHWSetting = CAMX_NEW BPSCST12Titan480;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// BPSCST12Titan480::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCST12Titan480::Initialize()
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCST12Titan480::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCST12Titan480::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCST12Titan480::UpdateFirmwareData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCST12Titan480::UpdateFirmwareData(
    VOID*   pSettingData,
    BOOL    moduleEnable)
{
    ISPInputData*  pInputData     = static_cast<ISPInputData*>(pSettingData);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCST12Titan480::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCST12Titan480::UpdateTuningMetadata(
    VOID* pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    if (NULL != pBPSTuningMetadata)
    {
        CAMX_STATIC_ASSERT(sizeof(BPSCST12RegCmd) <=
            sizeof(pBPSTuningMetadata->BPSTuningMetadata480.BPSCSTData.CSTConfig));

        Utils::Memcpy(&pBPSTuningMetadata->BPSTuningMetadata480.BPSCSTData.CSTConfig, pRegCmd, sizeof(BPSCST12RegCmd));
            ...
            (NULL != pInputData->pipelineBPSData.pDebugDataWriter))
        {
            result = pInputData->pipelineBPSData.pDebugDataWriter->AddDataTag(
                ...
                CAMX_ARRAY_SIZE(pBPSTuningMetadata->BPSTuningMetadata480.BPSCSTData.CSTConfig),
                &pBPSTuningMetadata->BPSTuningMetadata480.BPSCSTData.CSTConfig,
                sizeof(pBPSTuningMetadata->BPSTuningMetadata480.BPSCSTData.CSTConfig));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCST12Titan480::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSCST12Titan480::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult          result  = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSCST12Titan480::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID BPSCST12Titan480::DumpRegConfig()
{
    BPSCST12RegCmd* pRegCmd = static_cast<BPSCST12RegCmd*>(m_pRegCmd);
