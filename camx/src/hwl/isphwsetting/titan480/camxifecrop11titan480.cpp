...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxifecrop11titan480.cpp
/// @brief CAMXIFECROP11TITAN480 class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::IFECrop11Titan480
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
IFECrop11Titan480::IFECrop11Titan480()
{
    SetCommandLength(
                 PacketBuilder::RequiredWriteRegRangeSizeInDwords(sizeof(IFECrop11FDLumaReg)     / RegisterWidthInBytes) +
                 PacketBuilder::RequiredWriteRegRangeSizeInDwords(sizeof(IFECrop11FDChromaReg)   / RegisterWidthInBytes) +
                 PacketBuilder::RequiredWriteRegRangeSizeInDwords(sizeof(IFECrop11FullLumaReg)   / RegisterWidthInBytes) +
                 PacketBuilder::RequiredWriteRegRangeSizeInDwords(sizeof(IFECrop11FullChromaReg) / RegisterWidthInBytes) +
                 PacketBuilder::RequiredWriteRegRangeSizeInDwords(sizeof(IFECropPixelRawReg)     / RegisterWidthInBytes));
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFECrop11Titan480::CreateCmdList(
    VOID*   pSettingData,
    UINT32* pDMIBufferOffset)
{
    ...
    if (NULL != pInputData && NULL != pInputData->pCmdBuffer)
    {
        ...
        {
            case FDOutput:
                register1       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_MN_Y_FD_OUT_CROP_LINE_CFG;
                numberOfValues1 = sizeof(IFECrop11FDLumaReg) / RegisterWidthInBytes;
                pValues1        = reinterpret_cast<UINT32*>(&m_regCmd.FDLuma);

                register2       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_MN_C_FD_OUT_CROP_LINE_CFG;
                numberOfValues2 = sizeof(IFECrop11FDChromaReg) / RegisterWidthInBytes;
                pValues2        = reinterpret_cast<UINT32*>(&m_regCmd.FDChroma);
                break;

            case FullOutput:
                register1       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_MN_Y_VID_OUT_CROP_LINE_CFG;
                numberOfValues1 = (sizeof(IFECrop11FullLumaReg) / RegisterWidthInBytes);
                pValues1        = reinterpret_cast<UINT32*>(&m_regCmd.fullLuma);

                register2       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_MN_C_VID_OUT_CROP_LINE_CFG;
                numberOfValues2 = sizeof(IFECrop11FullChromaReg) / RegisterWidthInBytes;
                pValues2        = reinterpret_cast<UINT32*>(&m_regCmd.fullChroma);
                break;

            case DS4Output:
                register1       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DSX_Y_VID_OUT_CROP_LINE_CFG;
                numberOfValues1 = sizeof(IFECrop11DS4LumaReg) / RegisterWidthInBytes;
                pValues1        = reinterpret_cast<UINT32*>(&m_regCmd.DS4Luma);

                register2       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DSX_C_VID_OUT_CROP_LINE_CFG;
                numberOfValues2 = sizeof(IFECrop11DS4ChromaReg) / RegisterWidthInBytes;
                pValues2        = reinterpret_cast<UINT32*>(&m_regCmd.DS4Chroma);;
                break;

            case DS16Output:
                register1       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_4TO1_Y_VID_DS16_OUT_CROP_LINE_CFG;
                numberOfValues1 = sizeof(IFECrop11DS16LumaReg) / RegisterWidthInBytes;
                pValues1        = reinterpret_cast<UINT32*>(&m_regCmd.DS16Luma);

                register2       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_4TO1_C_VID_DS16_OUT_CROP_LINE_CFG;
                numberOfValues2 = sizeof(IFECrop11DS16ChromaReg) / RegisterWidthInBytes;
                pValues2        = reinterpret_cast<UINT32*>(&m_regCmd.DS16Chroma);
                break;

            case PixelRawOutput:
                register1       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_PIXEL_RAW_OUT_CROP_LINE_CFG;
            ...
            case DisplayFullOutput:
                register1       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_MN_Y_DISP_OUT_CROP_LINE_CFG;
                numberOfValues1 = (sizeof(IFECrop11DisplayFullLumaReg) / RegisterWidthInBytes);
                pValues1        = reinterpret_cast<UINT32*>(&m_regCmd.displayFullLuma);

                register2       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_MN_C_DISP_OUT_CROP_LINE_CFG;
                numberOfValues2 = sizeof(IFECrop11DisplayFullChromaReg) / RegisterWidthInBytes;
                pValues2        = reinterpret_cast<UINT32*>(&m_regCmd.displayFullChroma);
                break;

            case DisplayDS4Output:
                register1       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_4TO1_Y_DISP_DS4_OUT_CROP_LINE_CFG;
                numberOfValues1 = sizeof(IFECrop11DisplayDS4LumaReg) / RegisterWidthInBytes;
                pValues1        = reinterpret_cast<UINT32*>(&m_regCmd.displayDS4Luma);

                register2       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_4TO1_C_DISP_DS4_OUT_CROP_LINE_CFG;
                numberOfValues2 = sizeof(IFECrop11DisplayDS4ChromaReg) / RegisterWidthInBytes;
                pValues2        = reinterpret_cast<UINT32*>(&m_regCmd.displayDS4Chroma);;
                break;

            case DisplayDS16Output:
                register1       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_4TO1_Y_DISP_DS16_OUT_CROP_LINE_CFG;
                numberOfValues1 = sizeof(IFECrop11DisplayDS16LumaReg) / RegisterWidthInBytes;
                pValues1        = reinterpret_cast<UINT32*>(&m_regCmd.displayDS16Luma);

                register2       = regIFE_IFE_0_PP_CLC_CROP_RND_CLAMP_POST_DOWNSCALE_4TO1_C_DISP_DS16_OUT_CROP_LINE_CFG;
                numberOfValues2 = sizeof(IFECrop11DisplayDS16ChromaReg) / RegisterWidthInBytes;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::GetChromaSubsampleFactor
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFECrop11Titan480::GetChromaSubsampleFactor(
    ...
    Format pixelFormat)
{
        ...
        (NULL != pVerticalSubsampleFactor))
    {
        switch (pixelFormat)
        {
            ...
            case Format::PD10:
            case Format::P010:
                // Due to two pixel per cycle changes, we need to program the crop per channel
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ModifyCropWindow
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFECrop11Titan480::ModifyCropWindow(
    CropType cropType)
{
    CamxResult result            = CamxResultSuccess;
    ...
    if (Utils::AbsoluteFLOAT(outputAspectRatio - cropAspectRatio) > AspectRatioTolerance)
    {
        ...
        else
        {
            ...
            m_pState->modifiedCropWindow.width    =
                Utils::FloorUINT32(2, (static_cast<UINT32>(m_pState->modifiedCropWindow.height * outputAspectRatio)));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureFDLumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureFDLumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureFDChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureFDChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureFullLumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureFullLumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureFullChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureFullChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDisplayFullLumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDisplayFullLumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDisplayFullChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDisplayFullChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDS4LumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDS4LumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDS4ChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDS4ChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDS16LumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDS16LumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDS16ChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDS16ChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigurePixelRawRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigurePixelRawRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDisplayDS4LumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDisplayDS4LumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDisplayDS4ChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDisplayDS4ChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDisplayDS16LumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDisplayDS16LumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::ConfigureDisplayDS16ChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::ConfigureDisplayDS16ChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::CalculateCropCoordinates
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::CalculateCropCoordinates(
    CropInfo*   pCrop,
    CropType    cropType)
{
    UINT32 cropLeft;
    ...
    else
    {
        ...
        UINT32 scalerOutputMinusStreamHeight = (m_pState->scalerOutput.dimension.height > m_pState->streamDimension.height) ?
            (m_pState->scalerOutput.dimension.height - m_pState->streamDimension.height) : 0;

        centerCoordinateY  =
            Utils::FloorUINT32(2, ((scalerOutputMinusStreamHeight) / 2));
        ...
        // Beyond IFE scaling range IPE cropping needed for zoom
        UINT32 cropTopMinusFirstLine = (cropTop > pCrop->firstLine) ? (cropTop - pCrop->firstLine) : 0;
        m_pState->cropInfo.top    = cropTopMinusFirstLine;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::UpdateAppliedCrop
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFECrop11Titan480::UpdateAppliedCrop(
    CropInfo*   pCrop)
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::CalculateCropInfo
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFECrop11Titan480::CalculateCropInfo(
    CropInfo*   pLumaCrop,
    ...
    Format      pixelFormat)
{
    ...
    if ((TRUE             == m_pState->scalerOutput.preCropEnable) &&
        (CropTypeCentered == cropType))
    {
        pLumaCrop->firstPixel = 0;
        pLumaCrop->lastPixel  = m_pState->streamDimension.width - 1;
        pLumaCrop->firstLine  = 0;
        pLumaCrop->lastLine   = m_pState->streamDimension.height - 1;

        if ((m_pState->scalerOutput.dimension.width  != m_pState->streamDimension.width) &&
            (m_pState->scalerOutput.dimension.height != m_pState->streamDimension.height))
        {
            CAMX_LOG_WARN(CamxLogGroupISP, "Path %d, Invalid Scaler output [%d * %d] vs O/P dim[%d * %d]",
                          m_output,
                          m_pState->scalerOutput.dimension.width,
                          m_pState->scalerOutput.dimension.height,
                          m_pState->streamDimension.width,
    ...
    else if (TRUE == m_pInputData->pStripeConfig->overwriteStripes)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFECrop11Titan480::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult          result      = CamxResultSuccess;
    ...
    if (TRUE == pInputData->pStripeConfig->overwriteStripes)
    {
            ...
            (CropTypeFromRight == pInputData->pStripeConfig->cropType)))
        {
            ...
            else if (DS4Output == m_output)
            {
                ...
                currentModuleMNDSOutputHeight = pInputData->pStripeConfig->stateDS[modulePathIndex].DS4PathOutput.height;

                lumaCrop.firstLine    = 0;
                lumaCrop.lastLine     = currentModuleMNDSOutputHeight - 1;
            ...
            else if (DS16Output == m_output)
            {
                ...
                currentModuleMNDSOutputHeight = pInputData->pStripeConfig->stateDS[modulePathIndex].DS16PathOutput.height;
    ...
    if ((PixelRawOutput != m_output) &&
        (FALSE          == m_pState->scalerOutput.preCropEnable))
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::SetupRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFECrop11Titan480::SetupRegisterSetting(
    VOID*  pInput)
{
    CamxResult    result      = CamxResultSuccess;
    ISPInputData* pInputData  = static_cast<ISPInputData*>(pInput);
    ...
    switch (m_output)
    {
        ...
        case FullOutput:
            ...
            if (CropTypeCentered == pInputData->pStripeConfig->cropType)
            {
                ...
                pInputData->pCalculatedData->preCropInfo.CrCrop.firstPixel  =
                    m_regCmd.fullChroma.pixelConfig.bitfields.FIRST_PIXEL * 2;
                pInputData->pCalculatedData->preCropInfo.CrCrop.lastPixel   =
                    m_regCmd.fullChroma.pixelConfig.bitfields.LAST_PIXEL * 2 +1;
            }
            else
            {
                ...
                if (TRUE == pInputData->pStripeConfig->overwriteStripes)
                {
                    ...
                    pInputData->pCalculatedData->preCropInfo.preDSXphaseInitLuma   =
                        pInputData->pStripeConfig->pStripeOutput->preDSXphaseInitLuma;
                    pInputData->pCalculatedData->preCropInfo.preDSXphaseInitChroma =
                        pInputData->pStripeConfig->pStripeOutput->preDSXphaseInitChroma;
                }
            }
            break;
        ...
        case DS4Output:
            ...
            pInputData->pCalculatedData->preCropInfoDS16.CrCrop.firstPixel  =
                m_regCmd.DS4Chroma.pixelConfig.bitfields.FIRST_PIXEL * 2;
            pInputData->pCalculatedData->preCropInfoDS16.CrCrop.lastPixel   =
                m_regCmd.DS4Chroma.pixelConfig.bitfields.LAST_PIXEL * 2 + 1;
        ...
        case DisplayFullOutput:
            ...
            if (CropTypeCentered == pInputData->pStripeConfig->cropType)
            {
                ...
                pInputData->pCalculatedData->dispPreCropInfo.CrCrop.firstPixel  =
                    m_regCmd.displayFullChroma.pixelConfig.bitfields.FIRST_PIXEL * 2;
                pInputData->pCalculatedData->dispPreCropInfo.CrCrop.lastPixel   =
                    m_regCmd.displayFullChroma.pixelConfig.bitfields.LAST_PIXEL * 2 + 1;
            }
            else
            {
                // When not overwriting, we need to calculate pre-crop properly to respect DS4,
        ...
        case DisplayDS4Output:
            ...
            pInputData->pCalculatedData->dispPreCropInfoDS16.CrCrop.firstPixel  =
                m_regCmd.displayDS4Chroma.pixelConfig.bitfields.FIRST_PIXEL * 2;
            pInputData->pCalculatedData->dispPreCropInfoDS16.CrCrop.lastPixel   =
                m_regCmd.displayDS4Chroma.pixelConfig.bitfields.LAST_PIXEL * 2 + 1;
        ...
        default:
            CAMX_LOG_VERBOSE(CamxLogGroupIQMod, "Non Image path %d", m_output);
            break;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::CopyRegCmd
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT32 IFECrop11Titan480::CopyRegCmd(
    VOID* pData)
{
    UINT32 dataCopied = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop11Titan480::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop11Titan480::DumpRegConfig()
{
