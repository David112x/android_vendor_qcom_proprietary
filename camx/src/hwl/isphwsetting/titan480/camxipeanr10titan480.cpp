...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxipeanr10titan480.cpp
/// @brief CAMXIPEANR10TITAN480 class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#include "Process_AnrPass480.h"
#include "anr10regcmd480.h"
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::IPEANR10Titan480
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
IPEANR10Titan480::IPEANR10Titan480()
{
    m_pRegCmd = CAMX_CALLOC(PASS_NAME_MAX * sizeof(IPEANRRegCmd480));
    if (NULL == m_pRegCmd)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEANR10Titan480::GetModuleData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEANR10Titan480::GetModuleData(
    VOID* pModuleData)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10Titan480::CreateCmdList(
    VOID*   pSettingData,
    UINT32* pDMIBufferOffset)
{
    ...
    IPEANRRegCmd480* pRegCmd    = static_cast<IPEANRRegCmd480*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::ValidateAndCorrectPreviewsAndvideoParameters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEANR10Titan480::ValidateAndCorrectPreviewsAndvideoParameters(
    AnrParameters* pAnrParameters,
    UINT32         numOfPasses)
{
    AnrParameters*    pFWStruct = pAnrParameters;
    IPEANRRegCmd480*  pRegPass  = static_cast<IPEANRRegCmd480*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::ValidateAndCorrectStillModeParameters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEANR10Titan480::ValidateAndCorrectStillModeParameters(
    AnrParameters* pAnrParameters,
    UINT32         numOfPasses)
{
    AnrParameters*    pFWStruct = pAnrParameters;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::ValidateAndCorrectAnrSettings
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEANR10Titan480::ValidateAndCorrectAnrSettings(
    AnrParameters*  pAnrParameters,
    BOOL            isRealTime,
    UINT32          numOfPasses)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10Titan480::PackIQRegisterSetting(
    VOID*  pInput,
    VOID*  pOutput)
{
    CamxResult result = CamxResultSuccess;
    ...
    if (NULL != pInput)
    {
        ...
        IQSettingUtils::Memset(pRegPass, 0x0, sizeof(IPEANRRegCmd480) * numOfPasses);
        ...
        intRet = ANR_FlowProcessNcLib480(pAnrChromatix, &nclibContext, pRegPass, pFWStruct, numOfPasses,
        ...
        else
        {
            ...
            {
                // intRet = ANR_ValidateNcLibRegs480(pRegPass, numOfPasses, mE);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::SetupRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10Titan480::SetupRegisterSetting(
    VOID*  pInput)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10Titan480::UpdateTuningMetadata(
    VOID*  pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    {
        CAMX_STATIC_ASSERT((sizeof(IPEANRRegCmd480) * PASS_NAME_MAX) ==
            sizeof(pIPETuningMetadata->IPETuningMetadata480.IPEANRData.ANRData));

        for (UINT passNumber = PASS_NAME_FULL; passNumber < PASS_NAME_MAX; ++passNumber)
        {
            Utils::Memcpy(&pIPETuningMetadata->IPETuningMetadata480.IPEANRData.ANRData[passNumber],
                          &pRegCmd[passNumber],
                          sizeof(IPEANRRegCmd480));
        }
        ...
        if (TRUE == pIPEIQSettings->anrParameters.parameters[PASS_NAME_FULL].moduleCfg.EN)
        {
            ...
            result = pInputData->pipelineIPEData.pDebugDataWriter->AddDataTag(
                ...
                CAMX_ARRAY_SIZE(pIPETuningMetadata->IPETuningMetadata480.IPEANRData.ANRData),
                &pIPETuningMetadata->IPETuningMetadata480.IPEANRData.ANRData,
                sizeof(pIPETuningMetadata->IPETuningMetadata480.IPEANRData.ANRData));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEANR10Titan480::DumpRegConfig()
{
    IPEANRRegCmd480* pRegCmd            = static_cast<IPEANRRegCmd480*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::RunCalculationFullPass
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10Titan480::RunCalculationFullPass(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::RunCalculationDS4Pass
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10Titan480::RunCalculationDS4Pass(
    ISPInputData* pInputData)
{
    CAMX_UNREFERENCED_PARAM(pInputData);
    IPEANRRegCmd480* pRegCmd = static_cast<IPEANRRegCmd480*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10Titan480::RunCalculationDS16Pass
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10Titan480::RunCalculationDS16Pass(
    ISPInputData* pInputData)
{
    CAMX_UNREFERENCED_PARAM(pInputData);
    IPEANRRegCmd480* pRegCmd = static_cast<IPEANRRegCmd480*>(m_pRegCmd);
