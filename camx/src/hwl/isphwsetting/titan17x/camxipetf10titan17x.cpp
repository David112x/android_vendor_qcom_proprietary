...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxipetf10titan17x.cpp
/// @brief CAMXIPETF10TITAN17x class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "camxipetf10titan17x.h"
#include "tf10setting.h"
#include "camxutils.h"
#include "camxispiqmodule.h"
#include "tf10regcmd17x.h"
#include "Process_TF17x.h"
#include "NcLibWarp.h"


CAMX_NAMESPACE_BEGIN

static const UINT32 IPETFReg17xLength = sizeof(IPETFRegCmd17x) / sizeof(UINT32); // RegisterWidthInBytes;
CAMX_STATIC_ASSERT((94) == IPETFReg17xLength);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::IPETF10Titan17x
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
IPETF10Titan17x::IPETF10Titan17x()
{
    m_pRegCmd = CAMX_CALLOC(PASS_NAME_MAX * sizeof(IPETFRegCmd17x));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::InitializeDefaultRegisterValues
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void IPETF10Titan17x::InitializeDefaultRegisterValues()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::RunCalculationFullPass
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::RunCalculationFullPass()
{
    CamxResult result = CamxResultSuccess;
    IPETFRegCmd17x* pRegCmd = static_cast<IPETFRegCmd17x*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::RunCalculationDS4Pass
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::RunCalculationDS4Pass()
{
    CamxResult result = CamxResultSuccess;
    IPETFRegCmd17x* pRegCmd = static_cast<IPETFRegCmd17x*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::RunCalculationDS16Pass
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::RunCalculationDS16Pass()
{
    CamxResult result = CamxResultSuccess;
    IPETFRegCmd17x* pRegCmd = static_cast<IPETFRegCmd17x*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::CreateCmdList(
    VOID*   pSettingData,
    UINT32* pDMIBufferOffset)
{
        ...
        (NULL != m_pRegCmd))
    {
        ...
        {
            pRegCmd = static_cast<IPETFRegCmd17x*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::PackIQRegisterSetting(
    VOID*  pInput,
    VOID*  pOutput)
{
    CamxResult result = CamxResultSuccess;
    INT32 intRet = NC_LIB_SUCCESS;
    TF10InputData*  pTFInput = static_cast<TF10InputData*>(pInput);
    tf_1_0_0::chromatix_tf10Type::enable_sectionStruct* pModuleEnable  = &(pTFInput->pChromatix->enable_section);

    CAMX_UNREFERENCED_PARAM(pOutput);

    if ((NULL != pInput))
    {
        IPETFRegCmd17x* pRegs = static_cast<IPETFRegCmd17x*>(m_pRegCmd);
        ...
        // tf_2_0_0::tf10_rgn_dataType*  pPassUnpackedData;
        ...
        IQSettingUtils::Memset(pRegs, 0x0, sizeof(IPETFRegCmd17x) * PASS_NAME_MAX);
        ...
        else
        {
            ...
            CAMX_LOG_ERROR(CamxLogGroupPProc, "Input use case %d not supported", pTFInput->useCase);
        ...
        if (CamxResultSuccess == result)
        {
            ...
            intRet = TF_ProcessNcLibFull17x(pTFChromatix,
                                            &nclibContext,
            ...
            if (NC_LIB_SUCCESS != intRet)
            {
                result = CamxResultEFailed;
                /// @todo (CAMX-1812) Need to add logging for Common library
                CAMX_LOG_WARN(CamxLogGroupPProc, "TF_ProcessNcLibFull failed");
            }
    ...
    {
        /// @todo (CAMX-1812) Need to add logging for Common library
        CAMX_LOG_ERROR(CamxLogGroupPProc, "pInput=%p", pTFInput);
        result = CamxResultEFailed;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::SetupRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::SetupRegisterSetting(
    VOID*  pInput)
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::GetRegSize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT IPETF10Titan17x::GetRegSize()
{
    return sizeof(IPETFRegCmd17x);
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPETF10Titan17x::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::UpdateTuningMetadata(
    VOID* pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    {
        CAMX_STATIC_ASSERT(PASS_NAME_MAX * sizeof(IPETFRegCmd17x) ==
            sizeof(pIPETuningMetadata->IPETuningMetadata17x.IPETFData.TFData));

        for (UINT passNumber = PASS_NAME_FULL; passNumber < PASS_NAME_MAX; passNumber++)
        {
            Utils::Memcpy(&pIPETuningMetadata->IPETuningMetadata17x.IPETFData.TFData[passNumber],
                          &pRegCmd[passNumber],
                          sizeof(IPETFRegCmd17x));
        }
        ...
        if (TRUE == pIPEIQSettings->tfParameters.parameters[0].moduleCfg.EN)
        {
            ...
            {
                dataTagID = DebugDataTagID::TuningIPETF10Register;
            }
            else
            {
                dataTagID = DebugDataTagID::TuningIPETF10RegisterOffline;
            }

            result = pInputData->pipelineIPEData.pDebugDataWriter->AddDataTag(
                dataTagID,
                DebugDataTagType::TuningTF10Config,
                CAMX_ARRAY_SIZE(pIPETuningMetadata->IPETuningMetadata17x.IPETFData.TFData),
                &pIPETuningMetadata->IPETuningMetadata17x.IPETFData.TFData,
                sizeof(pIPETuningMetadata->IPETuningMetadata17x.IPETFData.TFData));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPETF10Titan17x::SetupInternalData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::SetupInternalData(
    VOID* pData)
{
    CamxResult result = CamxResultSuccess;
    ...
    TF10internalData* pInternalData = reinterpret_cast<TF10internalData*>(pData);
    ...
    TF10InputData* pDependenceData      = pInternalData->pDependenceData;
    ...
    {
        result = CamxResultEInvalidArg;
        CAMX_LOG_ERROR(CamxLogGroupISP, "NULL Input Buffer");
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::FillFirmwareConfig0
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPETF10Titan17x::FillFirmwareConfig0(
    IpeIQSettings*  pIPEIQSettings,
    UINT32          passType)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::FillFirmwareConfig1
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPETF10Titan17x::FillFirmwareConfig1(
    IpeIQSettings*  pIPEIQSettings,
    UINT32          passType,
    BOOL            bypassMode)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::FillFirmwareFStoA1A4Map
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPETF10Titan17x::FillFirmwareFStoA1A4Map(
    IpeIQSettings*  pIPEIQSettings,
    UINT32          passType)
{
    IPETFRegCmd17x* pRegCmd = static_cast<IPETFRegCmd17x*>(m_pRegCmd);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::ValidateAndCorrectTFParams
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::ValidateAndCorrectTFParams(
    const ISPInputData* pInputData,
    TF10InputData* pDependenceData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::ValidateAndCorrectStillModeParameters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::ValidateAndCorrectStillModeParameters(
    const ISPInputData* pInputData,
    TF10InputData* pDependenceData)
{
    CamxResult      result         = CamxResultSuccess;
    ...
    if (MF_CONFIG_TEMPORAL != pDependenceData->configMF)
    {
        // Regular blending is post process and default mode and constant blending in prefiltering
        UINT32 blendingMode = ((MF_CONFIG_NONE == pDependenceData->configMF) ||
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::ValidateAndCorrectMCTFParameters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPETF10Titan17x::ValidateAndCorrectMCTFParameters(
    const ISPInputData* pInputData,
    TF10InputData* pDependenceData)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPETF10Titan17x::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPETF10Titan17x::DumpRegConfig()
{
