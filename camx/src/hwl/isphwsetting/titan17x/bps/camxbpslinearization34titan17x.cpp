...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxbpslinearization34titan17x.cpp
/// @brief CAMXBPSLINEARIZATION34TITAN17X class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
static const UINT32 BPSLinearization34RegLengthDWord = sizeof(BPSLinearization34RegConfig) / RegisterWidthInBytes;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSLinearization34Titan17x::BPSLinearization34Titan17x
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BPSLinearization34Titan17x::BPSLinearization34Titan17x()
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSLinearization34Titan17x::Create
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSLinearization34Titan17x::Create(
    ISPHWSetting** ppHWSetting)
{
    CamxResult result = CamxResultSuccess;

    BPSLinearization34Titan17x* pHWSetting = CAMX_NEW BPSLinearization34Titan17x;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// BPSLinearization34Titan17x::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSLinearization34Titan17x::Initialize()
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSLinearization34Titan17x::WriteLUTtoDMI
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSLinearization34Titan17x::WriteLUTtoDMI(
    VOID*   pInput)
{
    CamxResult    result     = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSLinearization34Titan17x::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSLinearization34Titan17x::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSLinearization34Titan17x::UpdateFirmwareData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSLinearization34Titan17x::UpdateFirmwareData(
    VOID*   pSettingData,
    BOOL    moduleEnable)
{
    ISPInputData*                pInputData     = static_cast<ISPInputData*>(pSettingData);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSLinearization34Titan17x::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSLinearization34Titan17x::UpdateTuningMetadata(
    VOID* pSettingData)
{
    CamxResult                   result             = CamxResultSuccess;
    ISPInputData*                pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    if (NULL != pBPSTuningMetadata)
    {
        CAMX_STATIC_ASSERT(sizeof(BPSLinearization34RegConfig) <=
            sizeof(pBPSTuningMetadata->BPSTuningMetadata17x.BPSLinearizationData.linearizationConfig));

        Utils::Memcpy(&pBPSTuningMetadata->BPSTuningMetadata17x.BPSLinearizationData.linearizationConfig,
                        pRegCmd,
        ...
        if (TRUE == pBPSIQSettings->linearizationParameters.moduleCfg.EN)
        {
            result = pInputData->pipelineBPSData.pDebugDataWriter->AddDataTag(
                ...
                CAMX_ARRAY_SIZE(pBPSTuningMetadata->BPSTuningMetadata17x.BPSLinearizationData.linearizationConfig),
                &pBPSTuningMetadata->BPSTuningMetadata17x.BPSLinearizationData.linearizationConfig,
                sizeof(pBPSTuningMetadata->BPSTuningMetadata17x.BPSLinearizationData.linearizationConfig));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSLinearization34Titan17x::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSLinearization34Titan17x::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult                    result   = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSLinearization34Titan17x::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID BPSLinearization34Titan17x::DumpRegConfig()
{
    BPSLinearization34RegConfig* pRegCmd    = static_cast<BPSLinearization34RegConfig*>(m_pRegCmd);
