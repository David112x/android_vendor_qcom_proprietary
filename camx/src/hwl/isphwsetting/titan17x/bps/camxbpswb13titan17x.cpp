...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxbpswb13titan17x.cpp
/// @brief CAMXBPSWB13TITAN17X class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
static const UINT32 BPSWB13RegLengthDWord = sizeof(BPSWB13RegCmd) / RegisterWidthInBytes;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSWB13Titan17x::BPSWB13Titan17x
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BPSWB13Titan17x::BPSWB13Titan17x()
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSWB13Titan17x::Create
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSWB13Titan17x::Create(
    ISPHWSetting** ppHWSetting)
{
    CamxResult result = CamxResultSuccess;

    BPSWB13Titan17x* pHWSetting = CAMX_NEW BPSWB13Titan17x;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// BPSWB13Titan17x::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSWB13Titan17x::Initialize()
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSWB13Titan17x::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSWB13Titan17x::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSWB13Titan17x::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSWB13Titan17x::UpdateTuningMetadata(
    VOID* pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    {
        CAMX_STATIC_ASSERT(sizeof(BPSWB13RegCmd) <= sizeof(pBPSTuningMetadata->BPSTuningMetadata17x.BPSWBData.WBConfig));

        Utils::Memcpy(&pBPSTuningMetadata->BPSTuningMetadata17x.BPSWBData.WBConfig, pRegCmd, sizeof(BPSWB13RegCmd));

        result = pInputData->pipelineBPSData.pDebugDataWriter->AddDataTag(
            DebugDataTagID::TuningBPSWBRegister,
            DebugDataTagType::UInt32,
            CAMX_ARRAY_SIZE(pBPSTuningMetadata->BPSTuningMetadata17x.BPSWBData.WBConfig),
            &pBPSTuningMetadata->BPSTuningMetadata17x.BPSWBData.WBConfig,
            sizeof(pBPSTuningMetadata->BPSTuningMetadata17x.BPSWBData.WBConfig));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSWB13Titan17x::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult BPSWB13Titan17x::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult         result      = CamxResultSuccess;
    ...
    else
    {
        ...
        CAMX_LOG_ERROR(CamxLogGroupBPS, "Invalid data pData: %p pOutputData: %p", pData, pOutput);
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSWB13Titan17x::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID BPSWB13Titan17x::DumpRegConfig()
{
    BPSWB13RegCmd* pRegCmd = static_cast<BPSWB13RegCmd*>(m_pRegCmd);
