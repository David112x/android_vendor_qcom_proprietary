...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxifehdr22titan17x.cpp
/// @brief CAMXIFEHDR22TITAN17X class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR22Titan17x::IFEHDR22Titan17x
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
IFEHDR22Titan17x::IFEHDR22Titan17x()
{
    SetCommandLength(PacketBuilder::RequiredWriteRegRangeSizeInDwords(IFEHDR22RegLengthDWord1) +
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR22Titan17x::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFEHDR22Titan17x::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR22Titan17x::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFEHDR22Titan17x::UpdateTuningMetadata(
    VOID* pTuningMetaData)
{
    ...
    {
        CAMX_STATIC_ASSERT(sizeof(IFEHDR22RegCmd1) == sizeof(pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig1));
        Utils::Memcpy(&pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig1, &m_regCmd.m_regCmd1, sizeof(IFEHDR22RegCmd1));

        CAMX_STATIC_ASSERT(sizeof(IFEHDR22RegCmd2) == sizeof(pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig2));
        Utils::Memcpy(&pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig2, &m_regCmd.m_regCmd2, sizeof(IFEHDR22RegCmd2));

        CAMX_STATIC_ASSERT(sizeof(IFEHDR22RegCmd3) == sizeof(pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig3));
        Utils::Memcpy(&pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig3, &m_regCmd.m_regCmd3, sizeof(IFEHDR22RegCmd3));
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR22Titan17x::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFEHDR22Titan17x::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult          result    = CamxResultSuccess;
    HDR22UnpackedField* pData     = static_cast<HDR22UnpackedField*>(pInput);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR22Titan17x::SetupRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFEHDR22Titan17x::SetupRegisterSetting(
    VOID*  pInput)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR22Titan17x::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFEHDR22Titan17x::DumpRegConfig()
{
}
