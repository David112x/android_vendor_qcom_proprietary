...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxifehdr23titan17x.cpp
/// @brief CAMXIFEHDR23TITAN17X class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR23Titan17x::IFEHDR23Titan17x
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
IFEHDR23Titan17x::IFEHDR23Titan17x()
{
    SetCommandLength(PacketBuilder::RequiredWriteRegRangeSizeInDwords(IFEHDR23RegLengthDWord1) +
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR23Titan17x::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFEHDR23Titan17x::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR23Titan17x::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFEHDR23Titan17x::UpdateTuningMetadata(
    VOID* pTuningMetaData)
{
    ...
    {
        CAMX_STATIC_ASSERT(sizeof(IFEHDR23RegCmd1) == sizeof(pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig1));
        Utils::Memcpy(&pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig1, &m_regCmd.m_regCmd1, sizeof(IFEHDR23RegCmd1));

        CAMX_STATIC_ASSERT(sizeof(IFEHDR23RegCmd2) == sizeof(pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig2));
        Utils::Memcpy(&pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig2, &m_regCmd.m_regCmd2, sizeof(IFEHDR23RegCmd2));

        CAMX_STATIC_ASSERT(sizeof(IFEHDR23RegCmd3) == sizeof(pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig3));
        Utils::Memcpy(&pIFETuningMetadata->metadata17x.IFEHDRData.HDRConfig3, &m_regCmd.m_regCmd3, sizeof(IFEHDR23RegCmd3));
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR23Titan17x::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFEHDR23Titan17x::PackIQRegisterSetting(
    VOID*   pInput,
    VOID*   pOutput)
{
    CamxResult          result    = CamxResultSuccess;
    HDR23UnpackedField* pData     = static_cast<HDR23UnpackedField*>(pInput);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR23Titan17x::SetupRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFEHDR23Titan17x::SetupRegisterSetting(
    VOID*  pInput)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFEHDR23Titan17x::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFEHDR23Titan17x::DumpRegConfig()
{
}
