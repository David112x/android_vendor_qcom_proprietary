...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxipesce11titan17x.cpp
/// @brief CAMXIPESCE11TITAN17x class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPESCE11Titan17x::IPESCE11Titan17x
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
IPESCE11Titan17x::IPESCE11Titan17x()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPESCE11Titan17x::CreateCmdList
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPESCE11Titan17x::CreateCmdList(
    VOID*   pSettingData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPESCE11Titan17x::PackIQRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPESCE11Titan17x::PackIQRegisterSetting(
    VOID*  pInput,
    VOID*  pOutput)
{
    CamxResult           result   = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPESCE11Titan17x::SetupRegisterSetting
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPESCE11Titan17x::SetupRegisterSetting(
    VOID*  pInput)
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPESCE11Titan17x::GetRegSize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT IPESCE11Titan17x::GetRegSize()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPESCE11Titan17x::DumpRegConfig
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPESCE11Titan17x::DumpRegConfig()
{
    IPESCERegCmd*        pRegCmd = NULL;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPESCE11Titan17x::UpdateTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPESCE11Titan17x::UpdateTuningMetadata(
    VOID* pSettingData)
{
    CamxResult         result             = CamxResultSuccess;
    ISPInputData*      pInputData         = static_cast<ISPInputData*>(pSettingData);
    ...
    if ((NULL != pInputData->pIPETuningMetadata) && (NULL != pRegCmd))
    {
        CAMX_STATIC_ASSERT(sizeof(IPESCERegCmd) ==
            sizeof(pIPETuningMetadata->IPETuningMetadata17x.IPESCEData.SCEConfig));

        Utils::Memcpy(&pIPETuningMetadata->IPETuningMetadata17x.IPESCEData.SCEConfig,
                      pRegCmd,
                      sizeof(IPESCERegCmd));
        ...
        if (TRUE == pIPEIQSettings->skinEnhancementParameters.moduleCfg.EN)
        {
            ...
            result = pInputData->pipelineIPEData.pDebugDataWriter->AddDataTag(
                ...
                CAMX_ARRAY_SIZE(pIPETuningMetadata->IPETuningMetadata17x.IPESCEData.SCEConfig),
                &pIPETuningMetadata->IPETuningMetadata17x.IPESCEData.SCEConfig,
                sizeof(pIPETuningMetadata->IPETuningMetadata17x.IPESCEData.SCEConfig));
