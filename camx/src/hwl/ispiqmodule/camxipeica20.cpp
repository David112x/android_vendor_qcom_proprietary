...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxipeica20.cpp
/// @brief CAMXIPEICA20 class implementation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    IPEModuleCreateData* pCreateData)
{
    ...
    {
        IPEICA20* pModule = CAMX_NEW IPEICA20(pCreateData->pNodeIdentifier, pCreateData);

        if (NULL != pModule)
        {
            result = pModule->Initialize(pCreateData->path);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::InitializeModuleDataParameters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEICA20::InitializeModuleDataParameters()
{
    ...
    m_moduleData.numLUTs                                   = ICA20Indexmax;
    m_moduleData.IPEPath                                   = m_moduleData.IPEPath;
    m_numLUT                                               = ICA20Indexmax;
    m_moduleData.pLUT[ICA20IndexPerspective]               = PERSPECTIVE_LUT;
    m_moduleData.pLUT[ICA20IndexGrid]                      = GRID_LUT0;
    m_moduleData.offsetLUTCmdBuffer[ICA20IndexPerspective] = 0;
    m_moduleData.offsetLUTCmdBuffer[ICA20IndexGrid]        = IPEICA20LUTSize[ICA20IndexPerspective];
    m_moduleData.ICALUTBufferSize                          = IPEICA20LUTBufferSize;
...
// IPEICA20::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::Initialize(
    UINT32 IPEPath)
{
    CamxResult          result       = CamxResultSuccess;
    ...
    switch (m_moduleData.titanVersion)
    {
        case CSLCameraTitanVersion::CSLTitan175:
            m_pHWSetting = CAMX_NEW IPEICA20Titan17x;
            break;
        case CSLCameraTitanVersion::CSLTitan480:
            if (CVPICA == IPEPath)
            {
                m_pHWSetting = CAMX_NEW CVPICA20Titan17x;
            }
            else
            {
                CAMX_LOG_ERROR(CamxLogGroupISP, "ERROR: ICA20 for Titan480 unsupported for IPE");
            }
            break;
        default:
            break;
    ...
    if (CamxResultSuccess == result)
    {
        for (UINT i = 0; i < ICAReferenceNumber; i++)
        {
            ...
            if ((CamxResultSuccess == result) &&
                ((INPUT == m_moduleData.IPEPath) || (CVPICA == m_moduleData.IPEPath)))
            {
        ...
        if (CVPICA == m_moduleData.IPEPath)
        {
            if (CamxResultSuccess == result)
            {
                result = AllocateCVPICAData(&m_pCVPICAFrameCfgData);
            }
            if (result != CamxResultSuccess)
            {
                CAMX_LOG_ERROR(CamxLogGroupPProc, "Unable to allocate cvp ica frame config data memory");
            }

            if (CamxResultSuccess == result)
            {
                m_dependenceData.pCVPICAIntermediateBuffer = CAMX_CALLOC(NCLIB_PROCESS_CVP_ICA_PROC_BUFFER_SIZE);
                if (NULL == m_dependenceData.pCVPICAIntermediateBuffer)
                {
                    result = CamxResultENoMemory;
                    CAMX_LOG_ERROR(CamxLogGroupPProc, "Unable to allocate memory for CVP ICA calculation buffer");
                }
            }
        }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::FillCmdBufferManagerParams
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::FillCmdBufferManagerParams(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::AllocateCommonLibraryData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::AllocateCommonLibraryData()
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::UpdateIPEInternalData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::UpdateIPEInternalData(
    ISPInputData* pInputData)
{
    ...
    if (TRUE == m_enableCommonIQ)
    {
        ...
        if (((INPUT == m_moduleData.IPEPath) || (CVPICA == m_moduleData.IPEPath)) &&
    ...
    {
        IPETuningICAPath TuningICAPath = (IPEPath::INPUT == m_moduleData.IPEPath) ? TuningICAInput : TuningICAReference;
        DebugDataTagID   dataTagID;

        if (IPEICA10LUTBufferSize <=
            sizeof(pInputData->pIPETuningMetadata->IPETuningMetadata17x.IPEDMIData.ICALUT[TuningICAPath]))
        {
            ...
            {
                Utils::Memcpy(&pInputData->pIPETuningMetadata->IPETuningMetadata17x.IPEDMIData.
                    ICALUT[TuningICAPath].PerspectiveLUT,
        ...
        {
            dataTagID = (IPEPath::INPUT == m_moduleData.IPEPath) ?
                DebugDataTagID::TuningIPEICA10InputPackedLUT : DebugDataTagID::TuningIPEICA10ReferencePackedLUT;
        }
        else
        {
            dataTagID = (IPEPath::INPUT == m_moduleData.IPEPath) ?
                DebugDataTagID::TuningIPEICA10InputPackedLUTOffline : DebugDataTagID::TuningIPEICA10ReferencePackedLUTOffline;
        }

        result = pInputData->pipelineIPEData.pDebugDataWriter->AddDataTag(
            dataTagID,
            DebugDataTagType::TuningICA10LUT,
            1,
            &pInputData->pIPETuningMetadata->IPETuningMetadata17x.IPEDMIData.ICALUT[TuningICAPath],
            sizeof(pInputData->pIPETuningMetadata->IPETuningMetadata17x.IPEDMIData.ICALUT[TuningICAPath]));
...
// IPEICA20::GetRegCmd
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID* IPEICA20::GetRegCmd()
{
    return m_dependenceData.pNCRegData;
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::ValidateDependenceParams
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::ValidateDependenceParams(
    ISPInputData* pInputData)
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::CheckGridDependencyChange
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL IPEICA20::CheckGridDependencyChange(
    ISPInputData* pInputData)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::CheckPerspectiveDependencyChange
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL IPEICA20::CheckPerspectiveDependencyChange(
    ISPInputData* pInputData)
{
    BOOL isChanged                  = FALSE;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::SetModuleEnable
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::SetModuleEnable(
    ISPInputData* pInputData)
{
    CamxResult result = CamxResultSuccess;
    m_moduleEnable    = TRUE;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::CheckAndUpdateChromatixData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL IPEICA20::CheckAndUpdateChromatixData(
    ISPInputData* pInputData)
{
    ...
    {
        CAMX_LOG_WARN(CamxLogGroupIQMod, "Invalid Input: pTuningManager %x IsValidChromatix %d",
            pTuningManager, (NULL != pTuningManager) ? pTuningManager->IsValidChromatix() : FALSE);
    }
    return isChromatixChanged;
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::CheckDependenceChange
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL IPEICA20::CheckDependenceChange(
    ISPInputData* pInputData)
{
    BOOL           isChanged  = FALSE;
        ...
        (NULL != pInputData->pAECUpdateData))
    {
        ...
        if ((NULL != pNewAECUpdate) && (NULL != pInputData->pHwContext))
        {
            ...
            if (TRUE == m_moduleEnable)
            {
                    ...
                    (pInputData->frameNum != m_dependenceData.frameNum))
                {
                    ...
                    m_dependenceData.pIcaGeolibInputData     =  (CVPICA == m_moduleData.IPEPath) ?
                        &pInputData->pipelineCVPData.icaInputData : NULL;
        ...
        {
            CAMX_LOG_ERROR(CamxLogGroupIQMod, "Invalid Input: pNewAECUpdate %x HwContext %x",
    ...
    {
        CAMX_LOG_WARN(CamxLogGroupIQMod, "Null input pointer");
        isChanged = FALSE;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::UpdateLUTFromChromatix
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEICA20::UpdateLUTFromChromatix(
    VOID* pLUT)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::DumpTuningMetadata
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::DumpTuningMetadata(
    ISPInputData*   pInputData,
    UINT32*         pLUT)
{
    CamxResult       result = CamxResultSuccess;
    if (NULL != pInputData->pIPETuningMetadata)
    {
        IPETuningICAPath TuningICAPath = (m_moduleData.IPEPath != REFERENCE) ? TuningICAInput : TuningICAReference;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::RunCalculation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::RunCalculation(
    ISPInputData* pInputData)
{
    CamxResult       result          = CamxResultSuccess;
    ...
    if (CamxResultSuccess == result)
    {
        ...
        if (NULL != pLUT)
        {
            ...
            outputData.pCVPICAFrameCfgData = m_pCVPICAFrameCfgData;
            ...
            if (TRUE == m_enableCommonIQ)
            {
                ...
                m_pICAPerspectiveLUT = reinterpret_cast<UINT32*>(reinterpret_cast<UCHAR*>(pLUT) +
                    m_moduleData.offsetLUTCmdBuffer[ICA30IndexPerspective]);
            }
            else
            {
    ...
    ISPInputData* pInputData)
{
    ...
    if ((NULL != pInputData) && (NULL != m_pHWSetting))
    {
        ...
        if (CamxResultSuccess == result)
        {
            ...
            {
                ICA20HWSettingParams hwSetting;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::GetModuleData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEICA20::GetModuleData(
    VOID* pModuleData)
{
    ...
    IPEModuleCreateData* pCreateData)
{
    ...
    if (TRUE == pCreateData->initializationData.registerBETEn)
    {
        ...
        m_moduleData.titanVersion     = CSLCameraTitanVersion::CSLTitan175;
        m_dependenceData.titanVersion = CSLCameraTitanVersion::CSLTitan175;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::AllocateWarpData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::AllocateWarpData(
    VOID** ppWarpData)
{
    CamxResult result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::DeAllocateWarpData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEICA20::DeAllocateWarpData(
    VOID** ppWarpData)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEICA20::DeallocateCommonLibraryData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEICA20::DeallocateCommonLibraryData()
{
    if (NULL != m_dependenceData.pInterpolationData)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::AllocateWarpAssistData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::AllocateWarpAssistData(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::DeAllocateWarpAssistData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEICA20::DeAllocateWarpAssistData(
    VOID** ppWarpAssistData)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::AllocateWarpGeomOut
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::AllocateWarpGeomOut(
    VOID** ppWarpGeomOut)
{
    CamxResult        result = CamxResultSuccess;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::DeAllocateWarpGeomOut
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEICA20::DeAllocateWarpGeomOut(
    VOID** ppWarpGeomOut)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::AllocateCVPICAData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::AllocateCVPICAData(
    VOID** ppCVPICADataOut)
{
    CamxResult result = CamxResultSuccess;

    NcLibcvpDmeFrameConfigIca* pCVPICADataOut = CAMX_NEW NcLibcvpDmeFrameConfigIca;
    if (NULL == pCVPICADataOut)
    {
        result = CamxResultENoMemory;
    }

    *ppCVPICADataOut = pCVPICADataOut;

    return result;
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::DeAllocateCVPICAData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IPEICA20::DeAllocateCVPICAData(
    VOID** ppCVPICADataOut)
{
    NcLibcvpDmeFrameConfigIca*   pCVPICADataOut = static_cast<NcLibcvpDmeFrameConfigIca*>(*ppCVPICADataOut);

    if (NULL != pCVPICADataOut)
    {
        CAMX_DELETE(pCVPICADataOut);
        pCVPICADataOut = NULL;
    }
}
...
IPEICA20::~IPEICA20()
{
    ...
    if (CVPICA == m_moduleData.IPEPath)
    {
        DeAllocateCVPICAData(&m_pCVPICAFrameCfgData);
        if (NULL != m_dependenceData.pCVPICAIntermediateBuffer)
        {
            CAMX_FREE(m_dependenceData.pCVPICAIntermediateBuffer);
            m_dependenceData.pCVPICAIntermediateBuffer = NULL;
        }
    }
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::UpdatePerspectiveParamsToContext
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::UpdatePerspectiveParamsToContext(
    VOID* pWarp,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::SetGridTransformGeometry
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::SetGridTransformGeometry(
    VOID* pWarp,
    VOID* pICAGridParams)
{
    CamxResult           result = CamxResultSuccess;
    NcLibWarp*           pCurWarp = static_cast<NcLibWarp*>(pWarp);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::UpdateGridParamsToContext
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::UpdateGridParamsToContext(
    VOID* pWarp,
    VOID* pICAGridParams)
{
    CamxResult           result         = CamxResultSuccess;
    ...
    if (NULL != pCurWarp)
    {
        if (TRUE == IsGridEnabled(pGridTransform))
        {
            ...
            result = SetGridTransformGeometry(pWarp, pICAGridParams);
            if (CamxResultSuccess == result)
            {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::SetTransformData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::SetTransformData(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// IPEICA20::DumpInputConfiguration
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEICA20::DumpInputConfiguration(
    ISPInputData*  pInputData,
