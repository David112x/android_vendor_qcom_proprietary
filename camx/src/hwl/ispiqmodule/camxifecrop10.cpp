    ...
    IFEModuleCreateData* pCreateData)
{
    ...
    if (NULL != pCreateData)
    {
        ...
        {
            IFECrop10* pModule = CAMX_NEW IFECrop10(pCreateData);
            if (NULL != pModule)
            {
            ...
            else
            {
                ...
                CAMX_ASSERT_ALWAYS_MESSAGE("Failed to create IFECrop10 object.");
            }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop10::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IFECrop10::Initialize(
    IFEModuleCreateData* pCreateData)
{
    CamxResult result = CamxResultSuccess;
    ...
    switch(pCreateData->titanVersion)
    {
        ...
        case CSLCameraTitanVersion::CSLTitan175:
            m_pHWSetting = CAMX_NEW IFECrop10Titan17x;
            break;
