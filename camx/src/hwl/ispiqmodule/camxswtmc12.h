...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxswtmc12.h
/// @brief camxswtmc12 class declarations
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef CAMXSWTMC12_H
#define CAMXSWTMC12_H
...
//  A duplicated table, the same as TMC11
static FLOAT gamma15tableTMC12[Gamma15TableSize] =
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Class for IFE TMC12 Module
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class SWTMC12 final : public ISPIQModule
{
public:
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// CreateBPS
    ///
    /// @brief  Create SWTMC12 Object
    ///
    ...
    /// Execute
    ///
    /// @brief  Generate Settings for TMC12 Object
    ///
...
protected:
    ...
    ///
    /// @param  bRegisterBETEnable Flag to check if it's running in register BET
    ///
    /// @return CamxResultSuccess if successful
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
private:
    ...
    SWTMC12(const SWTMC12&)             = delete;                   ///< Disallow the copy constructor
    SWTMC12& operator=(const SWTMC12&)  = delete;                   ///< Disallow assignment operator

    BOOL                                m_preGamma15Enabled;        ///< Flag to indicate pre-gamma calculation enabled
    ADRCData*                           m_pADRCData;                ///< ADRC Data
    tmc_1_2_0::chromatix_tmc12Type*     m_pChromatix;               ///< Pointer to tuning mode data
    TMC12InputData                      m_dependenceData;           ///< Dependence Data for this module
