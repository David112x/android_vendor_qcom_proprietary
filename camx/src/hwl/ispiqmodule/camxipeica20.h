...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxipeica20.h
/// @brief IPEICA20 class declarations
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef CAMXIPEICA20_H
#define CAMXIPEICA20_H
...
struct ICA20ModuleData
{
    ...
    UINT                             offsetLUTCmdBuffer[ICA20Indexmax];      ///< Offset of all tables within LUT CmdBuffer
    VOID*                            pLUT[ICA20Indexmax];                    ///< Pointer to array of LUTs supported by ICA
    INT32                            IPEPath;                                ///< IPE path indicating input or reference.
    INT32                            numLUTs;                                ///< Number of LUTs
};

struct ICA20HWSettingParams
{
    CmdBuffer*          pLUTCmdBuffer;       ///< Command buffer pointer for holding all 3 LUTs
    ICA20ModuleData*    pModuleData;         ///< Module data pointer
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Class for IPE ICA Module for ICA20
///
/// This IQ block adds ICA operations
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class IPEICA20 final : public ISPIQModule
{
public:
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Create
...
private:
    ...
    ///
    /// @param  pWarp                    Pointer to ICA input context
    ...
    /// AllocateCVPICAData
    ///
    /// @brief  Allocate memory for CVP ICA frame config data
    ///
    /// @param  ppCVPICADataOut    Pointer to CVP ICA Frame config
    ///
    /// @return CamxResult success if the operation is success
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CamxResult AllocateCVPICAData(
        VOID** ppCVPICADataOut);

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// DeAllocateCVPICAData
    ///
    /// @brief  Free memory for CVP ICA frame config data
    ///
    /// @param  ppCVPICADataOut    Pointer to ICA Warp Geometry Output
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID DeAllocateCVPICAData(
        VOID** ppCVPICADataOut);
    ...
    IPEICA20(const IPEICA20&)            = delete;              ///< Disallow the copy constructor
    IPEICA20& operator=(const IPEICA20&) = delete;              ///< Disallow assignment operator
    ...
    ICA20ModuleData     m_moduleData;                           ///< Module data for ICA
};
