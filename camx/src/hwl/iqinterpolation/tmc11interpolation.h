...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  tmc11interpolation.h
/// @brief TMC11 Tuning Data Interpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef TMC11INTERPOLATION_H
#define TMC11INTERPOLATION_H
...
static const FLOAT  TMC11_UNIT_GAIN_STEP   = 1.03f;
static const INT32  TMC11_DRC_INDEX_MIN    = 94;
static const FLOAT  TMC11_GAIN_RATIO_MIN   = 1.0f;
static const FLOAT  TMC11_GAIN_RATIO_MAX   = 16.0f;
static const FLOAT  TMC11_DRC_GAIN_POW_X   = 1.03f;
static const INT    TMC11_KNEE_POINTS_NUM  = 5;
static const UINT32 TMC11_COEF_NUM         = 9;
static const FLOAT  TMC11_MAX_LTM_GAIN     = 8.0f;
static const UINT32 TMC11_HIST_BIN_NUM     = 1024;
static const UINT32 TMC11_KNEE_MIN         = 1;

// NOWHINE NC004c: Share code with system team
struct TMC11TriggerList
{
    tmc_1_1_0::chromatix_tmc11Type::control_methodStruct controlType;    ///< chromatix data
    FLOAT                                                triggerDRCgain; ///< DRC Gain
    FLOAT                                                triggerHDRAEC;  ///< HDRAEC trigger
    FLOAT                                                triggerAEC;     ///< AEC trigger
};

static const FLOAT log_bin_tmc11[TMC11_HIST_BIN_NUM] =
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Class that implements TMC11 tuning data interpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// NOWHINE NC004c: Share code with system team
class TMC11Interpolation
{
public:
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// CheckUpdateTrigger
    ...
    ///
    /// @param  pInput Pointer to the Input data to the TMC11 Module
    ...
    /// DoInterpolation
    ///
    /// @brief  TMC11 Interpolation function
    ///
...
private:
    ...
    /// InterpolationData
    ///
    /// @brief  Interpolation Function for TMC11 Module
    ///
    ...
    /// @return BOOL    return TRUE on success
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static BOOL InterpolationData(tmc_1_1_0::tmc11_rgn_dataType* pInput1,
    ...
    /// @param  pOriHist  Pointer to original Histogram stats
    /// @param  pTmcHist  Pointer to calculated Histogram stats
    ///
    /// @return BOOL   Return TRUE on success
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /// @param  kneeX     kneeX
    /// @param  kneeY     kneeY
    /// @param  pTmcHist  Pointer to Histogram stats
    ///
    /// @return BOOL   Return TRUE on success
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /// @param  pTmcHist                Pointer to Histogram stats
    /// @param  pContrastEnhanceCurve   Pointer to the output contrast enhance curve
    ///
    /// @return BOOL   Return TRUE on success
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
