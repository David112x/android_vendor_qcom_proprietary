...
static NodeOperation TF10OperationTable[] =
{
    { TF10Interpolation::LensPositionSearchNode,   2},
    { TF10Interpolation::LensZoomSearchNode,       2},
    { TF10Interpolation::PostScaleRatioSearchNode, 2},
    { TF10Interpolation::PreScaleRatioSearchNode,  2},
    { TF10Interpolation::DRCGainSearchNode,        2},
    { TF10Interpolation::HDRAECSearchNode,         2},
    { TF10Interpolation::AECSearchNode,            2},
    { TF10Interpolation::CCTSearchNode,            2}
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// TF10Interpolation::CheckUpdateTrigger
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL TF10Interpolation::CheckUpdateTrigger(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL TF10Interpolation::RunInterpolation(
    const TF10InputData*                             pInput,
    tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct* pData)
{
    BOOL            result = TRUE;
    UINT            count  = 0;
    TuningNode      nodeSet[TF10MaxNode];           // The intepolation tree total Node
    TF10TriggerList TF10Trigger;                    // Color Correction Trigger List

    if ((NULL != pInput) && (NULL != pData) && (NULL != pInput->pChromatix))
    {
        // Initialize all the nodes
        for (count = 0; count < TF10MaxNode; count++)
        {
            if (count < TF10MaxNonLeafNode)
            {
        ...
        IQSettingUtils::AddNodeToInterpolationTree(NULL, &nodeSet[0],
            static_cast<VOID*>(&pInput->pChromatix->chromatix_tf10_core), NULL);

        // Setup Trigger Data
        IQSettingUtils::Memcpy(&TF10Trigger.controlType,
                               &(pInput->pChromatix->control_method),
                               sizeof(tf_1_0_0::chromatix_tf10Type::control_methodStruct));

        TF10Trigger.triggerLensPosition   = pInput->lensPosition;
        TF10Trigger.triggerLensZoom       = pInput->lensZoom;
        TF10Trigger.triggerPostScaleRatio = pInput->postScaleRatio;
        TF10Trigger.triggerPreScaleRatio  = pInput->preScaleRatio;

        TF10Trigger.triggerDRCgain        = pInput->DRCGain;

        TF10Trigger.triggerHDRAEC         =
    ...
    if (FALSE != result)
    {
        ...
        result = IQSettingUtils::InterpolateTuningData(&nodeSet[0],
                                                       TF10MaxNonLeafNode,
                                                       TF10InterpolationLevel,
                                                       TF10Interpolation::DoInterpolation);
    }

    if (FALSE != result)
    {
        IQSettingUtils::Memcpy(pData, nodeSet[0].pData, sizeof(tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct));
    }
    return result;
}
...
/// TF10Interpolation::DoInterpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL TF10Interpolation::DoInterpolation(
    VOID* pData1,
    VOID* pData2,
    FLOAT ratio,
    VOID* pResult)
{
    ...
    if ((NULL != pData1) && (NULL != pData2) && (NULL != pResult))
    {
        tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct* pInput1 =
            static_cast<tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct*>(pData1);
        tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct* pInput2 =
            static_cast<tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct*>(pData2);
        tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct* pOutput =
            static_cast<tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct*>(pResult);

        if (pInput1 == pInput2)
        {
            IQSettingUtils::Memcpy(pOutput, pInput1, sizeof(tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct));
        }
        else if ((ratio > 0.0f) && (ratio < 1.0f))
        {
            result = TF10Interpolation::InterpolationData(pInput1, pInput2, ratio, pOutput);
        }
        else
        {
            ...
            {
                IQSettingUtils::Memcpy(pOutput, pInput2, sizeof(tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct));
            }
            else
            {
                result = FALSE;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// TF10Interpolation::InterpolationData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

BOOL TF10Interpolation::InterpolationData(
    tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct* pInput1,
    tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct* pInput2,
    FLOAT                                            ratio,
    tf_1_0_0::mod_tf10_cct_dataType::cct_dataStruct* pOutput)
{
    ...
    if ((NULL != pInput1) && (NULL != pInput2) && (NULL != pOutput))
    {
        ...
        {
            passType             = static_cast<UINT>(pInput1->mod_tf10_pass_data[count].pass_trigger);
            input1Pass[passType] = count;
            passType             = static_cast<UINT>(pInput2->mod_tf10_pass_data[count].pass_trigger);
            ...
            passType++)
        {
            ...
            tf_1_0_0::tf10_rgn_dataType*  pInput1Rgn = &pInput1->mod_tf10_pass_data[input1Count].tf10_rgn_data;
            tf_1_0_0::tf10_rgn_dataType*  pInput2Rgn = &pInput2->mod_tf10_pass_data[input2Count].tf10_rgn_data;
            tf_1_0_0::tf10_rgn_dataType*  pOutputRgn = &pOutput->mod_tf10_pass_data[passType].tf10_rgn_data;

            pOutput->mod_tf10_pass_data[passType].pass_trigger = pInput1->mod_tf10_pass_data[input1Count].pass_trigger;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TF10Interpolation::LensPositionSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT TF10Interpolation::LensPositionSearchNode(
    ...
    TuningNode* pChildNode)
{
    ...
    tf_1_0_0::chromatix_tf10_coreType*   pParentDataType = NULL;
    TF10TriggerList*  pTriggerList    = NULL;

    if ((NULL != pParentNode)    &&
        (NULL != pTriggerData)   &&
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<tf_1_0_0::chromatix_tf10_coreType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->mod_tf10_lens_posn_dataCount;
        pTriggerList    = static_cast<TF10TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->mod_tf10_lens_posn_data[count].lens_posn_trigger),
                &(triggerRegion[count]));
        }
        ...
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->mod_tf10_lens_posn_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->mod_tf10_lens_posn_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TF10Interpolation::LensZoomSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT TF10Interpolation::LensZoomSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    tf_1_0_0::mod_tf10_lens_posn_dataType*   pParentDataType = NULL;
    TF10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<tf_1_0_0::mod_tf10_lens_posn_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->lens_posn_data.mod_tf10_lens_zoom_dataCount;
        pTriggerList    = static_cast<TF10TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->lens_posn_data.mod_tf10_lens_zoom_data[count].lens_zoom_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->lens_posn_data.mod_tf10_lens_zoom_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->lens_posn_data.mod_tf10_lens_zoom_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TF10Interpolation::PostScaleRatioSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT TF10Interpolation::PostScaleRatioSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    tf_1_0_0::mod_tf10_lens_zoom_dataType*   pParentDataType = NULL;
    TF10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<tf_1_0_0::mod_tf10_lens_zoom_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->lens_zoom_data.mod_tf10_post_scale_ratio_dataCount;
        pTriggerList    = static_cast<TF10TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->lens_zoom_data.mod_tf10_post_scale_ratio_data[count].post_scale_ratio_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->lens_zoom_data.mod_tf10_post_scale_ratio_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->lens_zoom_data.mod_tf10_post_scale_ratio_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TF10Interpolation::PreScaleRatioSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT TF10Interpolation::PreScaleRatioSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    tf_1_0_0::mod_tf10_post_scale_ratio_dataType*   pParentDataType = NULL;
    TF10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<tf_1_0_0::mod_tf10_post_scale_ratio_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->post_scale_ratio_data.mod_tf10_pre_scale_ratio_dataCount;
        pTriggerList    = static_cast<TF10TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->post_scale_ratio_data.mod_tf10_pre_scale_ratio_data[count].pre_scale_ratio_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->post_scale_ratio_data.mod_tf10_pre_scale_ratio_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            ...
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>
                    (&pParentDataType->post_scale_ratio_data.mod_tf10_pre_scale_ratio_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TF10Interpolation::DRCGainSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT TF10Interpolation::DRCGainSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    tf_1_0_0::mod_tf10_pre_scale_ratio_dataType*   pParentDataType = NULL;
    TF10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<tf_1_0_0::mod_tf10_pre_scale_ratio_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->pre_scale_ratio_data.mod_tf10_drc_gain_dataCount;
        pTriggerList    = static_cast<TF10TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->pre_scale_ratio_data.mod_tf10_drc_gain_data[count].drc_gain_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->pre_scale_ratio_data.mod_tf10_drc_gain_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->pre_scale_ratio_data.mod_tf10_drc_gain_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TF10Interpolation::HDRAECSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT TF10Interpolation::HDRAECSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    tf_1_0_0::mod_tf10_drc_gain_dataType*   pParentDataType = NULL;
    TF10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<tf_1_0_0::mod_tf10_drc_gain_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->drc_gain_data.mod_tf10_hdr_aec_dataCount;
        pTriggerList    = static_cast<TF10TriggerList*>(pTriggerData);
        ...
        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegionHDRAEC(
                ...
                &(pParentDataType->drc_gain_data.mod_tf10_hdr_aec_data[count].hdr_aec_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->drc_gain_data.mod_tf10_hdr_aec_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->drc_gain_data.mod_tf10_hdr_aec_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TF10Interpolation::AECSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT TF10Interpolation::AECSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    tf_1_0_0::mod_tf10_hdr_aec_dataType*   pParentDataType = NULL;
    TF10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<tf_1_0_0::mod_tf10_hdr_aec_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->hdr_aec_data.mod_tf10_aec_dataCount;
        pTriggerList    = static_cast<TF10TriggerList*>(pTriggerData);
        ...
        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegionAEC(
                ...
                &(pParentDataType->hdr_aec_data.mod_tf10_aec_data[count].aec_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->hdr_aec_data.mod_tf10_aec_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->hdr_aec_data.mod_tf10_aec_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TF10Interpolation::CCTSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT TF10Interpolation::CCTSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    tf_1_0_0::mod_tf10_aec_dataType*   pParentDataType = NULL;
    TF10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<tf_1_0_0::mod_tf10_aec_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->aec_data.mod_tf10_cct_dataCount;
        pTriggerList    = static_cast<TF10TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->aec_data.mod_tf10_cct_data[count].cct_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->aec_data.mod_tf10_cct_data[regionOutput.startIndex]),
           static_cast<VOID*>(&pParentDataType->aec_data.mod_tf10_cct_data[regionOutput.startIndex].cct_data));
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->aec_data.mod_tf10_cct_data[regionOutput.endIndex]),
                static_cast<VOID*>(&pParentDataType->aec_data.mod_tf10_cct_data[regionOutput.endIndex].cct_data));
            childCount++;
        }
