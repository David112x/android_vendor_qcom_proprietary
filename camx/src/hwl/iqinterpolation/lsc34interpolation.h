...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  lsc34interpolation.h
/// @brief LSC34 module tuning data interpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef LSC34INTERPOLATION_H
#define LSC34INTERPOLATION_H

#include "iqcommondefs.h"
#include "iqsettingutil.h"
#include "lsc_3_4_0.h"

/// @brief LSC34 Trigger List
// NOWHINE NC004c: Share code with system team
struct LSC34TriggerList
{
    lsc_3_4_0::chromatix_lsc34Type::control_methodStruct  controlType;         ///< chromatix data
    ...
    lsc_3_4_0::chromatix_lsc34Type::private_informationStruct privateInfo;         ///< Private Information
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Class that implements LSC34 module tuning data interpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// NOWHINE NC004c: Share code with system team
class LSC34Interpolation
{
public:
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// CheckUpdateTrigger
    ...
    ///
    /// @param  pInput Input data to the LSC34 Module
    ...
    /// DoInterpolation
    ///
    /// @brief  LSC34 Interpolation function
    ///
...
private:
    ...
    static BOOL InterpolateAndCalibrate(
        lsc_3_4_0::lsc34_rgn_dataType* LSCRegionTable,
        const LSC34InputData*          pInput,
