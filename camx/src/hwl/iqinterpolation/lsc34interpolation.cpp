...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  lsc34interpolation.cpp
/// @brief LSC34 tuning data interpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
static NodeOperation LSC34OperationTable[] =
{
    {LSC34Interpolation::LensPositionSearchNode, 2},
    {LSC34Interpolation::DRCGainSearchNode, 2},
    {LSC34Interpolation::HDRAECSearchNode, 2},
    {LSC34Interpolation::LEDSearchNode,  3},
    {LSC34Interpolation::AECSearchNode, 2},
    {LSC34Interpolation::CCTSearchNode, 2}
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// LSC34Interpolation::InterpolateAndCalibrate
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL LSC34Interpolation::InterpolateAndCalibrate(
    ...
    FLOAT                          cctTrigger)
{
    ...
    UINT32 index1                = 0;
    UINT32 index2                = 0;
    FLOAT  tmpGrGbAverage        = 0.0f;
    UINT32 calibrationTableCount = 0;

    // Identify regions
    lsc_3_4_0::chromatix_lsc34_goldenType*    pGoldenTable = NULL;
    lsc_3_4_0::mod_lsc34_golden_cct_dataType* pGoldenTableCCTData = NULL;

    pGoldenTable = &(pInput->pChromatix->chromatix_lsc34_golden);
    pGoldenTableCCTData = &(pGoldenTable->mod_lsc34_golden_cct_data[0]);
    ...
    calibrationTableCount = IQSettingUtils::MinUINT32(pGoldenTable->mod_lsc34_golden_cct_dataCount,
                                                      pInput->numberOfEEPROMTable);

    for (UINT32 count = 1; count < calibrationTableCount - 1; count++)
    {
        pGoldenTableCCTData = &(pGoldenTable->mod_lsc34_golden_cct_data[count]);
        ...
        if (pGoldenTableCCTData->cct_trigger.start > cctTrigger)
        {
            ...
            ratio = (cctTrigger - pGoldenTable->mod_lsc34_golden_cct_data[index1].cct_trigger.start) /
                    (pGoldenTable->mod_lsc34_golden_cct_data[index2].cct_trigger.start -
                     pGoldenTable->mod_lsc34_golden_cct_data[index1].cct_trigger.end);
        }
    ...
    pGoldenTableCCTData = &(pGoldenTable->mod_lsc34_golden_cct_data[calibrationTableCount - 1]);
    ...
    for (UINT32 rolloffSize = 0; rolloffSize < MESH_ROLLOFF_SIZE; rolloffSize++)
    {
        ...
        tmpGrGbAverage = (pOutput->gb_gain_tab.gb_gain[rolloffSize] + pOutput->gr_gain_tab.gr_gain[rolloffSize]) / (2.0f);
        pOutput->gb_gain_tab.gb_gain[rolloffSize] = tmpGrGbAverage;
        pOutput->gr_gain_tab.gr_gain[rolloffSize] = tmpGrGbAverage;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL LSC34Interpolation::CheckUpdateTrigger(
    ISPIQTriggerData* pInput,
    LSC34InputData*   pTriggerData)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL LSC34Interpolation::RunInterpolation(
    const LSC34InputData*          pInput,
    lsc_3_4_0::lsc34_rgn_dataType* pData)
{
    BOOL                           result        = TRUE;
    // The interpolotion tree total Node
    TuningNode                     nodeSet[LSC34MaxmiumNode];
    // Except leaf node, each valid node needs a scratch buffer to contain intepolation result
    lsc_3_4_0::lsc34_rgn_dataType* resultData   = NULL;
    // LSC Trigger List
    LSC34TriggerList               lscTrigger;

    if ((NULL != pInput) && (NULL != pData) && (NULL != pInput->pChromatix))
    {
        // Initialize all the nodes
        for (UINT count = 0; count < LSC34MaxmiumNode; count++)
        {
            if (count < LSC34MaxmiumNonLeafNode)
            {
        ...
        // Setup the Top Node
        nodeSet[0].pNodeData = static_cast<VOID*>(&pInput->pChromatix->chromatix_lsc34_core);
        IQSettingUtils::AddNodeToInterpolationTree(NULL, &nodeSet[0],
            static_cast<VOID*>(&pInput->pChromatix->chromatix_lsc34_core), NULL);

        // Setup Trigger Data
        IQSettingUtils::Memcpy(&lscTrigger.controlType,
            &(pInput->pChromatix->control_method),
            sizeof(lsc_3_4_0::chromatix_lsc34Type::control_methodStruct));
        ...
        result = IQSettingUtils::SetupInterpolationTree(&nodeSet[0],
                                                        LSC34InterpolationLevel,
                                                        &LSC34OperationTable[0],
    ...
    if (FALSE != result)
    {
        ...
        result = IQSettingUtils::InterpolateTuningData(&nodeSet[0],
                                                       LSC34MaxmiumNonLeafNode,
                                                       LSC34InterpolationLevel,
                                                       LSC34Interpolation::DoInterpolation);
    }
    ...
    if ((FALSE != result) && (TRUE == pInput->toCalibrate) && (TRUE == pInput->enableCalibration))
    {
        lsc_3_4_0::chromatix_lsc34_goldenType*    pGoldenTable          = NULL;
        lsc_3_4_0::mod_lsc34_golden_cct_dataType* pGoldenTableCCTData   = NULL;
        lsc_3_4_0::lsc34_golden_rgn_dataType*     pGoldenTableData      = NULL;
        UINT32                                    calibrationTableCount = 0;
        ...
        {
            pGoldenTableCCTData = &(pGoldenTable->mod_lsc34_golden_cct_data[count]);
            pGoldenTableData    = &(pGoldenTableCCTData->lsc34_golden_rgn_data);
    ...
    if ((FALSE != result) && (TRUE == pInput->enableCalibration))
    {
        resultData = static_cast<lsc_3_4_0::lsc34_rgn_dataType*>(nodeSet[0].pData);
    ...
    else if (FALSE != result)
    {
        ...
        IQSettingUtils::Memcpy(pData->r_gain_tab.r_gain,
            ...
            (sizeof(FLOAT) * MESH_ROLLOFF_SIZE));
...
/// LSC34Interpolation::DoInterpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL LSC34Interpolation::DoInterpolation(
    VOID* pData1,
    VOID* pData2,
    FLOAT ratio,
    VOID* pResult)
{
    lsc_3_4_0::lsc34_rgn_dataType* pInput1 = NULL;
    lsc_3_4_0::lsc34_rgn_dataType* pInput2 = NULL;
    lsc_3_4_0::lsc34_rgn_dataType* pOutput = NULL;
    BOOL                           result  = TRUE;
    ...
    if (NULL != pData1 && NULL != pData2 && NULL != pResult)
    {
        ...
        pInput1 =
            static_cast<lsc_3_4_0::lsc34_rgn_dataType*>(pData1);
        pInput2 =
            static_cast<lsc_3_4_0::lsc34_rgn_dataType*>(pData2);
        pOutput =
            static_cast<lsc_3_4_0::lsc34_rgn_dataType*>(pResult);

        if (pInput1 == pInput2)
        {
            IQSettingUtils::Memcpy(pOutput, pInput1, sizeof(lsc_3_4_0::lsc34_rgn_dataType));
        }
        else if ((ratio > 0.0f) && (ratio < 1.0f))
        {
            result = LSC34Interpolation::InterpolationData(pInput1, pInput2, ratio, pOutput);
        }
        else
        {
            ...
            {
                IQSettingUtils::Memcpy(pOutput, pInput2, sizeof(lsc_3_4_0::lsc34_rgn_dataType));
            }
            else
            {
                result = FALSE;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// LSC34Interpolation::InterpolationData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL LSC34Interpolation::InterpolationData(
    lsc_3_4_0::lsc34_rgn_dataType* pInput1,
    lsc_3_4_0::lsc34_rgn_dataType* pInput2,
    FLOAT                          ratio,
    lsc_3_4_0::lsc34_rgn_dataType* pOutput)
{
    UINT count  = 0;
    BOOL result = TRUE;
    for (count = 0; count < MESH_ROLLOFF_SIZE; count++)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LSC34Interpolation::LensPositionSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT LSC34Interpolation::LensPositionSearchNode(
    ...
    TuningNode* pChildNode)
{
    ...
    lsc_3_4_0::chromatix_lsc34_coreType*   pParentDataType = NULL;
    LSC34TriggerList*  pTriggerList    = NULL;

    if ((NULL != pParentNode)    &&
        (NULL != pTriggerData)   &&
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<lsc_3_4_0::chromatix_lsc34_coreType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->mod_lsc34_lens_position_dataCount;
        pTriggerList    = static_cast<LSC34TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->mod_lsc34_lens_position_data[count].lens_position_trigger),
                &(triggerRegion[count]));
        }
        ...
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->mod_lsc34_lens_position_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->mod_lsc34_lens_position_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LSC34Interpolation::DRCGainSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT LSC34Interpolation::DRCGainSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    lsc_3_4_0::mod_lsc34_lens_position_dataType*   pParentDataType = NULL;
    LSC34TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<lsc_3_4_0::mod_lsc34_lens_position_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->lens_position_data.mod_lsc34_drc_gain_dataCount;
        pTriggerList    = static_cast<LSC34TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->lens_position_data.mod_lsc34_drc_gain_data[count].drc_gain_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->lens_position_data.mod_lsc34_drc_gain_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->lens_position_data.mod_lsc34_drc_gain_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LSC34Interpolation::HDRAECSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT LSC34Interpolation::HDRAECSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    lsc_3_4_0::mod_lsc34_drc_gain_dataType*   pParentDataType = NULL;
    LSC34TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<lsc_3_4_0::mod_lsc34_drc_gain_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->drc_gain_data.mod_lsc34_hdr_aec_dataCount;
        pTriggerList    = static_cast<LSC34TriggerList*>(pTriggerData);
        ...
        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegionHDRAEC(
                ...
                &(pParentDataType->drc_gain_data.mod_lsc34_hdr_aec_data[count].hdr_aec_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->drc_gain_data.mod_lsc34_hdr_aec_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->drc_gain_data.mod_lsc34_hdr_aec_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LSC34Interpolation::LEDSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT LSC34Interpolation::LEDSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    lsc_3_4_0::mod_lsc34_hdr_aec_dataType*   pParentDataType = NULL;
    LSC34TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<lsc_3_4_0::mod_lsc34_hdr_aec_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->hdr_aec_data.mod_lsc34_led_idx_dataCount;
        pTriggerList    = static_cast<LSC34TriggerList*>(pTriggerData);
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->hdr_aec_data.mod_lsc34_led_idx_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->hdr_aec_data.mod_lsc34_led_idx_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
        ...
        if ((rationLED2 != 0.0f) && ( 3 <= regionNumber))
        {
            ...
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->hdr_aec_data.mod_lsc34_led_idx_data[2]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LSC34Interpolation::AECSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT LSC34Interpolation::AECSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    lsc_3_4_0::mod_lsc34_led_idx_dataType*   pParentDataType = NULL;
    LSC34TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<lsc_3_4_0::mod_lsc34_led_idx_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->led_idx_data.mod_lsc34_aec_dataCount;
        pTriggerList    = static_cast<LSC34TriggerList*>(pTriggerData);
        ...
        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegionAEC(
                ...
                &(pParentDataType->led_idx_data.mod_lsc34_aec_data[count].aec_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->led_idx_data.mod_lsc34_aec_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->led_idx_data.mod_lsc34_aec_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LSC34Interpolation::CCTSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT LSC34Interpolation::CCTSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    lsc_3_4_0::mod_lsc34_aec_dataType*   pParentDataType = NULL;
    LSC34TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<lsc_3_4_0::mod_lsc34_aec_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->aec_data.mod_lsc34_cct_dataCount;
        pTriggerList    = static_cast<LSC34TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->aec_data.mod_lsc34_cct_data[count].cct_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->aec_data.mod_lsc34_cct_data[regionOutput.startIndex]),
           static_cast<VOID*>(&pParentDataType->aec_data.mod_lsc34_cct_data[regionOutput.startIndex].lsc34_rgn_data));
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->aec_data.mod_lsc34_cct_data[regionOutput.endIndex]),
                static_cast<VOID*>(&pParentDataType->aec_data.mod_lsc34_cct_data[regionOutput.endIndex].lsc34_rgn_data));
            childCount++;
        }
