...
static NodeOperation ICA10OperationTable[] =
{
    { ICA10Interpolation::LensPositionSearchNode, 2 },
    { ICA10Interpolation::LensZoomSearchNode, 2 },
    { ICA10Interpolation::AECSearchNode, 2 },
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// ICA10Interpolation::RunInterpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL ICA10Interpolation::RunInterpolation(
    ...
    ica_1_0_0::ica10_rgn_dataType* pData)
{
    ...
    // ICA Trigger List
    ICA10TriggerList icaTrigger;

    if ((NULL != pInput) && (NULL != pData) && (NULL != pInput->pChromatix))
    {
        ica_1_0_0::chromatix_ica10Type* pChromatix = static_cast <ica_1_0_0::chromatix_ica10Type*>(pInput->pChromatix);
        ...
        IQSettingUtils::AddNodeToInterpolationTree(NULL, &nodeSet[0],
                                                   static_cast<VOID*>(&pChromatix->chromatix_ica10_core), NULL);

        // Setup Trigger Data
        IQSettingUtils::Memcpy(&icaTrigger.controlType,
                               &(pChromatix->control_method),
                               sizeof(ica_1_0_0::chromatix_ica10Type::control_methodStruct));
        ...
        result = IQSettingUtils::SetupInterpolationTree(
            &nodeSet[0], ICAInterpolationLevel, &ICA10OperationTable[0], static_cast<VOID*>(&icaTrigger));
    }
    else
    {
    ...
    if (FALSE != result)
    {
        ...
        result = IQSettingUtils::InterpolateTuningData(&nodeSet[0],
                                                       ...
                                                       ICA10Interpolation::DoInterpolation);
    }

    if (FALSE != result)
    {
        IQSettingUtils::Memcpy(pData, nodeSet[0].pData, sizeof(ica_1_0_0::ica10_rgn_dataType));
    }
...
/// ICA10Interpolation::DoInterpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL ICA10Interpolation::DoInterpolation(
    VOID* pData1,
    VOID* pData2,
    FLOAT ratio,
    VOID* pResult)
{
    ...
    if ((NULL != pData1) && (NULL != pData2) && (NULL != pResult))
    {
        ica_1_0_0::ica10_rgn_dataType* pInput1 =
            static_cast<ica_1_0_0::ica10_rgn_dataType*>(pData1);
        ica_1_0_0::ica10_rgn_dataType* pInput2 =
            static_cast<ica_1_0_0::ica10_rgn_dataType*>(pData2);
        ica_1_0_0::ica10_rgn_dataType* pOutput =
            static_cast<ica_1_0_0::ica10_rgn_dataType*>(pResult);

        if (pInput1 == pInput2)
        {
            IQSettingUtils::Memcpy(pOutput, pInput1, sizeof(ica_1_0_0::ica10_rgn_dataType));
        }
        else if ((ratio > 0.0f) && (ratio < 1.0f))
        {
            result = ICA10Interpolation::InterpolationData(pInput1, pInput2, ratio, pOutput);
        }
        else
        {
            ...
            {
                IQSettingUtils::Memcpy(pOutput, pInput2, sizeof(ica_1_0_0::ica10_rgn_dataType));
            }
            else
            {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// ICA10Interpolation::InterpolationData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL ICA10Interpolation::InterpolationData(
    ica_1_0_0::ica10_rgn_dataType* pInput1,
    ica_1_0_0::ica10_rgn_dataType* pInput2,
    FLOAT                          ratio,
    ica_1_0_0::ica10_rgn_dataType* pOutput)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ICA10Interpolation::LensPositionSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT ICA10Interpolation::LensPositionSearchNode(
    ...
    TuningNode* pChildNode)
{
    ...
    ica_1_0_0::chromatix_ica10_coreType*   pParentDataType = NULL;
    ICA10TriggerList*  pTriggerList    = NULL;

    if ((NULL != pParentNode)    &&
        (NULL != pTriggerData)   &&
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<ica_1_0_0::chromatix_ica10_coreType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->mod_ica10_lens_posn_dataCount;
        pTriggerList    = static_cast<ICA10TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->mod_ica10_lens_posn_data[count].lens_posn_trigger),
                &(triggerRegion[count]));
        }
        ...
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->mod_ica10_lens_posn_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->mod_ica10_lens_posn_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ICA10Interpolation::LensZoomSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT ICA10Interpolation::LensZoomSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    ica_1_0_0::mod_ica10_lens_posn_dataType*   pParentDataType = NULL;
    ICA10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<ica_1_0_0::mod_ica10_lens_posn_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->lens_posn_data.mod_ica10_lens_zoom_dataCount;
        pTriggerList    = static_cast<ICA10TriggerList*>(pTriggerData);

        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegion(
                &(pParentDataType->lens_posn_data.mod_ica10_lens_zoom_data[count].lens_zoom_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->lens_posn_data.mod_ica10_lens_zoom_data[regionOutput.startIndex]),
           NULL);
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->lens_posn_data.mod_ica10_lens_zoom_data[regionOutput.endIndex]),
                NULL);
            childCount++;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ICA10Interpolation::AECSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT ICA10Interpolation::AECSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
    ...
    ica_1_0_0::mod_ica10_lens_zoom_dataType*   pParentDataType = NULL;
    ICA10TriggerList*  pTriggerList    = NULL;
    ...
    if ((NULL != pParentNode)    &&
        ...
        (NULL != pChildNode))
    {
        pParentDataType = static_cast<ica_1_0_0::mod_ica10_lens_zoom_dataType*>(pParentNode->pNodeData);
        regionNumber    = pParentDataType->lens_zoom_data.mod_ica10_aec_dataCount;
        pTriggerList    = static_cast<ICA10TriggerList*>(pTriggerData);
        ...
        for (UINT count = 0; count < regionNumber; count++)
        {
            IQSettingUtils::CopyTriggerRegionAEC(
                ...
                &(pParentDataType->lens_zoom_data.mod_ica10_aec_data[count].aec_trigger),
                &(triggerRegion[count]));
        }
        ...
        // Set up child 1
        IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
           static_cast<VOID*>(&pParentDataType->lens_zoom_data.mod_ica10_aec_data[regionOutput.startIndex]),
           static_cast<VOID*>(&pParentDataType->lens_zoom_data.mod_ica10_aec_data[regionOutput.startIndex].ica10_rgn_data));
        childCount++;
        ...
        if (regionOutput.startIndex != regionOutput.endIndex)
        {
            // Set up child 2
            IQSettingUtils::AddNodeToInterpolationTree(pParentNode, &pChildNode[childCount],
                static_cast<VOID*>(&pParentDataType->lens_zoom_data.mod_ica10_aec_data[regionOutput.endIndex]),
                static_cast<VOID*>(&pParentDataType->lens_zoom_data.mod_ica10_aec_data[regionOutput.endIndex].ica10_rgn_data));
            childCount++;
        }
