...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  camxjpegexifdefs.h
/// @brief JPEG EXIF definitions
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef CAMXJPEGEXIFDEFS_H
#define CAMXJPEGEXIFDEFS_H

#include "camxmem.h"
#include "camxutils.h"

// NOWHINE ENTIRE FILE - legacy
...
/// @brief URAT32 unsigned rational type
struct URAT32
{
...
/// @brief RAT32 signed rational type
struct RAT32
{
...
/// @brief EXIF tag data type per EXIF spec
enum EXIFTagType
{
    EXIF_BYTE      = 1,    ///< type byte
    EXIF_ASCII     = 2,    ///< type ASCII
    EXIF_SHORT     = 3,    ///< type short
    EXIF_LONG      = 4,    ///< type long
    EXIF_RATIONAL  = 5,    ///< type rational
    EXIF_UNDEFINED = 7,    ///< type undefined
    EXIF_SLONG     = 9,    ///< type signed long
    EXIF_SRATIONAL = 10,    ///< type signed rational
    EXIF_MAX_TYPE,
};

/// @brief Used to store EXIF tag entry data
struct EXIFTagEntry
{
    ...
    */
    union
    {
        ...
        BYTE   *_bytes;      ///< EXIF_BYTE count greater than 1
        BYTE    _byte;       ///< EXIF_BYTE count is 1
        UINT16  *_shorts;    ///< EXIF_SHORT count greater than 1
        UINT16   _short;     ///< EXIF_SHORT count is 1
        UINT32 *_longs;      ///< EXIF_LONG count greater than 1
        UINT32  _long;       ///< EXIF_LONG count is 1
        URAT32 *_rats;       ///< EXIF_RATIONAL count greater than 1
        URAT32  _rat;        ///< EXIF_RATIONAL count is 1
        UINT8  *_undefined;  ///< EXIF_UNDEFINED count indicates length
        INT32  *_slongs;     ///< EXIF_SLONG count greater than 1
        INT32   _slong;      ///< EXIF_SLONG count is 1
        RAT32  *_srats;      ///< EXIF_SRATIONAL count greater than 1
        RAT32   _srat;       ///< EXIF_SRATIONAL count is 1
...
/// @brief EXIF tag offsets, ordering matters!
static const UINT32 EXIFTagTypeSizes[EXIF_MAX_TYPE] = {
    0, ///< not applicable
    1, ///< EXIF_BYTE
    1, ///< EXIF_ASCII
    2, ///< EXIF_SHORT
