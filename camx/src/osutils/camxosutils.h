...
static const CHAR DefaultAlgorithmPath[]   = ".";
static const CHAR SensorModulesPath[]      = ".";
static const CHAR MmSensorModulesPath[]    = ".";
...
public:
        ...
        const CHAR* pFileName)
    {
        if (NULL != pFilePath)
        {
            OsUtils::SNPrintF(pFullName, maxSize, "%s%s%s", pFilePath, PathSeparator, pFileName);
        }
        else
        {
    ...
    /// FDelete
    ///
    /// @brief  Delets a file on the filesystem when file's link count becomes 0
    ///
    /// @param  pFilename File to delete
    ///
    /// @return File handle or NULL on failure
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CamxResult FDelete(
        const CHAR* pFilename);

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// FindEstimatedSizeOfUnCompressed
    ///
    /// @brief  method to find the size of the estimated uncompressed data using the input compressed data.
    ///
    /// @param  pInputStream        input data to be uncompressed
    /// @param  inputLength         size of input data
    /// @param  pUncompressedSize   output containing size of the uncompressed size.
    ///
    /// @return size of the uncompressed data
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CamxResult FindEstimatedSizeOfUnCompressed(
        BYTE*  pInputStream,
        UINT   inputLength,
    ...
    /// UnCompress
    ///
    /// @brief  method to uncompress the byte stream
    ///
    /// @param  pInputStream   input data to be uncompressed
    /// @param  inputLength    size of input data
    /// @param  ppOutputStream output data
    /// @param  pOutputLength  output data size
    ///
    /// @return success or failure
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CamxResult UnCompress(
        BYTE*  pInputStream,
        UINT   inputLength,
        BYTE** ppOutputStream,
        UINT*  pOutputLength);
    ...
    /// Compress
    ///
    /// @brief  method to compress the byte stream
    ///
    /// @param  pInputStream   input data to be uncompressed
    /// @param  inputLength    size of input data
    /// @param  ppOutputStream output data
    ...
    /// ComputeCRC32
    ///
    /// @brief  method to Compute CRC-32 Checksum
    ///
    /// @param  previousCRC     previous value for the checksum (it can be 0 if there is no previous checksum)
    /// @param  pBuffer         array of the data to calculate CRC
    /// @param  bufferLength    length of the data
    ///
    /// @return calculatd new checksum value
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // NOWHINE GR017: The native API uses unsigned long
    static unsigned long ComputeCRC32(
    // NOWHINE GR017: The native API uses unsigned long
    ...
    /// @param  pTargetName       Name of the Target
    ...
    /// SetGrallocMetaData
    ///
    /// @brief  Set Metadata in Gralloc buffer
    ///
    /// @param  phNativehandle natvie buffer handle
    /// @param  metadatatype   metadata type
    /// @param  pMetadata      pointer to metadata
    ///
    /// @return CamxResultSuccess if successful
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CamxResult SetGrallocMetaData(
    ...
    /// RaiseSignalAbort
    ///
    /// @brief  Raises a SIGABRT signal indicating abnormal termination
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static VOID RaiseSignalAbort();
...
public:
    ...
    /// Await
    ///
    /// @brief  Indefinitely wait on count down untils it reaches zero. Should be used for debugging only.
    ///         Use TimedAwait() instead.
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
enum SurfaceTileMode
{
    SURFACE_TILE_MODE_DISABLE = 0x0,     ///< used for linear surface
    SURFACE_TILE_MODE_ENABLE  = 0x1      ///< used for tiled surface
};

enum SurfaceRasterMode
{
    SURFACE_RASTER_MODE_UNKNOWN = 0x0,   ///< used when what raster mode that will be used
    SURFACE_RASTER_MODE_TW      = 0x1,   ///< raster_mode = TypeWriter (TW)
    SURFACE_RASTER_MODE_CB      = 0x2,   ///< raster_mode = CheckerBoard (CB)
};

// Adreno Pixel Formats
enum ADRENOPIXELFORMAT
{
    ADRENO_PIXELFORMAT_UNKNOWN = 0,   ///< Unknown Adreno pixel format
    ADRENO_PIXELFORMAT_NV12    = 103, ///< NV12 Adreno pixel format
    ADRENO_PIXELFORMAT_P010    = 104, ///< P010 Adreno pixel format
    ADRENO_PIXELFORMAT_NV21    = 619, ///< NV21 Adreno pixel format
    ADRENO_PIXELFORMAT_Y8      = 625, ///< Y8 Adreno pixel format
    ADRENO_PIXELFORMAT_TP10    = 654, ///< TP10 Adreno pixel format
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Class containing adreno info.
///
/// Wrapping of adreno utils
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class AdrenoInfo final
{
public:
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Create
    ///
    /// @brief  Static method to create an instance of AdrenoInfo
    ///
    /// @return Pointer to newly created object on success, NULL on failure.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static AdrenoInfo* Create();

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Destroy
    ///
    /// @brief  Method to delete an instance of AdrenoInfo
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID Destroy();
    ...
    /// GetAlignment
    ///
    /// @brief  Get stride and scanline alignments from GPU
    ///
    /// @param  width                The width of the image buffer
    /// @param  height               The height of the image buffer
    /// @param  planeId              The plane id
    /// @param  format               The format of the image buffer
    /// @param  pStrideAlignment     Pointer to the output of stride alignment
    /// @param  pScanlineAlignment   Pointer to the output of scanline alignment
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID GetAlignment(
...
private:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// ComputeFmtAlignedWidthAndHeight
    ///
    /// @brief   Compute aligned width and aligned height based on width, height, format and usage flags. A warpper of adreno
    ///          util function void compute_fmt_aligned_width_and_height().
    ///
    ...
    /// @param   tileMode                    Linear / Titled
    /// @param   rasterMode                  Raster mode(Based on CB / TW)
    /// @param   padThreshold                Padding threshold above which surface gets padded
    /// @param   pAlignedWidth               Pointer to a location to store the aligned width
    /// @param   pAlignedHeight              Pointer to a location to store the aligned height
    ///
    /// @return  None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID ComputeFmtAlignedWidthAndHeight(
        INT               width,
        INT               height,
        INT               planeId,
        ADRENOPIXELFORMAT format,
        UINT32            numSamples,
        SurfaceTileMode   tileMode,
        SurfaceRasterMode rasterMode,
        INT               padThreshold,
        INT*              pAlignedWidth,
        INT*              pAlignedHeight);
    ...
    /// GetAdrenoFormat
    ///
    /// @brief  Convert CamX Format to ADRENOPIXELFORMAT
    ///
    /// @param  format The Format of the image buffer
    ///
    /// @return Adreno pixel format
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ADRENOPIXELFORMAT GetAdrenoFormat(
        Format format);

    AdrenoInfo(const AdrenoInfo&)            = delete;               ///< Disallow the copy constructor
    AdrenoInfo& operator=(const AdrenoInfo&) = delete;               ///< Disallow assignment operator

    typedef VOID(*PFNCOMPUTEFMTALIGNEDWIDTHANDHEIGHT)(
        INT, INT, INT, ADRENOPIXELFORMAT, UINT32, INT, INT, INT, INT*, INT*); ///< Typedefs for Adreno utils functions.

    PFNCOMPUTEFMTALIGNEDWIDTHANDHEIGHT  m_pfnComputeFmtAlignedWidthAndHeight; ///< Function pointer to compute aligned
                                                                              ///< width and height based on buffer size,
                                                                              ///< and format.
    OSLIBRARYHANDLE                     m_hAdrenoUtilsLib;                    ///< Handle for Adreno utils library
};
...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// ConvertCamxFormatToGrallocFormat
    ///
    /// @brief  Convert Camx format to gralloc format.
    ///
    /// @param  camxFormat         Camx Format
    /// @param  pGrallocFormat     pointer to gralloc format
    ///
    /// @return GRALLOC1_ERROR_NONE on success, GRALLOC1_ERROR_UNSUPPORTED otherwise
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    INT32 ConvertCamxFormatToGrallocFormat(
        CamX::Format camxFormat,
        UINT32*      pGrallocFormat);

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// AllocateGrallocBuffer
    ///
    /// @brief  Method to allocate gralloc buffer
    ///
    /// @param  width               Width of the image buffer
    /// @param  height              Height of the image buffer
    /// @param  grallocFormat       Format of the image buffer
    /// @param  phAllocatedBuffer   Gralloc return pointer
    /// @param  pStride             Stride updated by gralloc
    /// @param  producerFlags       ProducerFlags for gralloc memory allocation
    /// @param  consumerFlags       ConsumerFlags for gralloc memory allocation
    ///
    /// @return CamxResultSuccess on success, CamxResultEFailed otherwise
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CamxResult AllocateGrallocBuffer(
        UINT32           width,
        UINT32           height,
    ...
    /// Destroy
    ///
    /// @brief  Method to Free gralloc buffer
    ///
    /// @param  hAllocatedBuffer   gralloc buffer handle
    ///
    /// @return CamxResultSuccess on success, CamxResultEFailed otherwise
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CamxResult Destroy(
    ...
    /// Retain
    ///
    /// @brief  Method to Retain gralloc buffer
    ///
    /// @param  hAllocatedBuffer   gralloc buffer handle
    ///
    /// @return CamxResultSuccess on success, CamxResultEFailed otherwise
...
private:
    ...
    Gralloc(const Gralloc&) = delete;               ///< Disallow the copy constructor
    Gralloc& operator=(const Gralloc&) = delete;    ///< Disallow assignment operator

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// SetupGralloc1Interface
    ///
    /// @brief  Sets gralloc interface functions.
    ///
    /// @return GRALLOC1_ERROR_NONE on success, GRALLOC1_ERROR_UNSUPPORTED otherwise
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    INT32 SetupGralloc1Interface();

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// SetupGralloc1Device
    ///
    /// @brief  Get gralloc hardware module and open device.
    ///
    /// @return CamxResultSuccess on success, CamxResultEFailed otherwise
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CamxResult SetupGralloc1Device();
};
