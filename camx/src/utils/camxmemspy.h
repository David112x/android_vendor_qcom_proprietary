...
private:
    ...
    /// @param  rpTrackingInfo  A pointer to the tracking data structure associated with the client pointer, if it exists
    /// @param  rpAllocDesc     A pointer to the active allocation descriptor corresponding to the client pointer
    ///
    /// @return CamxResultSuccess if tracking info successfully retrieved; CamxResultEFailed if not found
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CamxResult GetTrackingInfo(
        VOID*                   pClientPtr,
    ...
    // Private Data
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    Hashmap* m_pActiveAllocMap;     ///< List of active allocations
    Hashmap* m_pAllocCallsiteMap;   ///< List of call sites from which allocations occur
