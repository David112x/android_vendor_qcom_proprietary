...
public:
    ...
    CAMX_INLINE VOID InsertToTail(
        LightweightDoublyLinkedListNode* pNodeToInsert)
    {
        CAMX_ASSERT((NULL != pNodeToInsert) && (pNodeToInsert->pPrev == NULL));
        CAMX_ASSERT((NULL != pNodeToInsert) && (pNodeToInsert->pNext == NULL));
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// FreeAllNodesAndTheirClientData
    ///
    /// @brief  Remove all the nodes from list and free the _client_ data and node memory.
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE VOID FreeAllNodesAndTheirClientData()
    {
        if (NULL != m_pHead)
        {
    ...
    /// FreeAllNodes
    ///
    /// @brief  Remove and free all the nodes from list. Note that this does NOT free the client data!
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE VOID FreeAllNodes()
    {
        if (NULL != m_pHead)
        {
            LightweightDoublyLinkedListNode* pNode;
        ...
        ListCompareElements compareFunc)
    {
        ...
        LDLLCompareElement* pNodeArray = static_cast<LDLLCompareElement*>
                                         (CAMX_CALLOC_NO_SPY(m_numNodes * sizeof(LDLLCompareElement)));
        LDLLNode*           pNode      = Head();
        LDLLNode*           pPrev      = NULL;
        INT                 i          = 0;
...
private:
    ...
    INT                              m_numNodes; ///< The number of elements in the list
};
