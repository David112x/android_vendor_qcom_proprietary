...
const UINT32 SCOPEEventSensorNodePrepareStreamOn = 71; ///< SensorNode: PrepareStreamOn
...
const UINT32 SCOPEEventVFE4NodePrepareStreamOn = 74; ///< VFE4Node: PrepareStreamOn
...
const UINT32 SCOPEEventCASDStatsProcessorExecuteProcessRequest = 103; ///< CASDStatsProcessor: ExecuteProcessRequest
const UINT32 SCOPEEventAWBNodeNodeInitialize = 104; ///< StatsProcessingNode: ProcessingNodeInitialize
const UINT32 SCOPEEventAWBNodeExecuteProcessRequest = 105; ///< AutoFocusNode: ExecuteProcessRequest
const UINT32 SCOPEEventHistogramProcessNodeNodeInitialize = 106; ///< HistogramProcessNode: ProcessingNodeInitialize
const UINT32 SCOPEEventHistogramProcessNodeExecuteProcessRequest = 107; ///< HistogramProcessNode: ExecuteProcessRequest
const UINT32 SCOPEEventCSLSetDebugBuffer = 108; ///< CSL: SetDebugBuffer
const UINT32 SCOPEEventAECConvergence = 109; ///< AEC: Convergence
const UINT32 SCOPEEventAFInitialize = 110; ///< AutoFocus: Initialize
const UINT32 SCOPEEventAFStatusUpdate = 111; ///< AutoFocus: Status update
const UINT32 SCOPEEventAFLensPositionUpdate = 112; ///< AutoFocus: Final Lens Position
const UINT32 SCOPEEventAFResult = 113; ///< AutoFocus: AF Result
const UINT32 SCOPEEventAFDeInitialize = 114; ///< AutoFocus: DeInitialize
const UINT32 SCOPEEventSensorAcquire = 115; ///< SensorNode: Acquire
const UINT32 SCOPEEventSubModuleAcquire = 116; ///< SensorNode: SubModuleAcquire
const UINT32 SCOPEEventCSLAcquireHardware = 117; ///< CSL: AcquireDevice
const UINT32 SCOPEEventCSLReleaseHardware = 118; ///< CSL: ReleaseDevice
const UINT32 SCOPEEventCSLDumpRequest = 119; ///< CSL: DumpRequest
...
#define CAMX_IS_TRACE_ENABLED(group)                                                                                          \
    (CamX::g_traceInfo.groupsEnable & group)                                                                                  \
