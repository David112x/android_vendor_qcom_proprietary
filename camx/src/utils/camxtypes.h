...
static const CamxResult CamxResultECancelledRequest = 28;   ///< Flush in progress

// Increment the count below if adding additional result codes.
static const CamxResult CamxResultCount             = 29;   ///< The number of result codes. Not to be used.
...
static const CamxLogGroup CamxLogGroupAFD           = (1 << 0);                         ///< AFD
static const CamxLogGroup CamxLogGroupSensor        = (1 << 1);                         ///< Sensor
static const CamxLogGroup CamxLogGroupTracker       = (1 << 2);                         ///< Tracker
static const CamxLogGroup CamxLogGroupISP           = (1 << 3);                         ///< ISP
static const CamxLogGroup CamxLogGroupPProc         = (1 << 4);                         ///< Post Processor
static const CamxLogGroup CamxLogGroupMemMgr        = (1 << 5);                         ///< MemMgr
static const CamxLogGroup CamxLogGroupPower         = (1 << 6);                         ///< Power (clock, bandwidth related)
...
static const CamxLogGroup CamxLogGroupFormat        = (1 << 15);                        ///< Format
...
static const CamxLogGroup CamxLogGroupCVP           = (1 << 22);                        ///< CVP
...
static const CamxLogGroup CamxLogGroupSWP           = (1 << 28);                        ///< SW Process
static const CamxLogGroup CamxLogGroupHist          = (1 << 29);                        ///< Histogram Process
static const CamxLogGroup CamxLogGroupBPS           = (1 << 30);                        ///< BPS
static const CamxLogGroup CamxLogGroupDebugData     = static_cast<UINT32>((1 << 31));   ///< Debug-Data Framework -
