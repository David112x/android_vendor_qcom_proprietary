...
public:
    ...
    /// IsINT32Odd
    ///
    /// @brief  Check if INT32 is odd number
    ///
    /// @param  input input value to be checked for odd
    ///
    /// @return UINT32 True if input is odd number
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE UINT32 IsINT32Odd(
        INT32 input)
    {
        return ((input & 0x0001) ? TRUE : FALSE);
    }
    ...
    /// IsINT32Even
    ///
    /// @brief  Check if INT32 is Even number
    ///
    /// @param  input input value to be checked for Even
    ///
    /// @return UINT32 True if input is Even number
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE INT32 IsINT32Even(
        INT32 input)
    {
        return ((input & 0x0001) ? FALSE : TRUE);
    }
    ...
    /// OddFloorINT32
    ///
    /// @brief  Floor INT32 to Odd number
    ///
    /// @param  input input value to be rounded down
    ///
    /// @return INT32 Rounded down value of input
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE INT32 OddFloorINT32(
        INT32 input)
    {
        INT32 result;
    ...
    /// EvenFloorINT32
    ///
    /// @brief  Floor INT32 to Even number
    ///
    /// @param  input input value to be rounded down
    ///
    /// @return UINT32 Rounded down value of input
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE INT32 EvenFloorINT32(
        INT32 input)
    {
        return (input & 0xFFFFFFFE);
    }
    ...
    /// OddCeilingINT32
    ///
    /// @brief  Ceil INT32 to Odd number
    ///
    /// @param  input input value to be rounded up
    ///
    /// @return INT32 Rounded up value of input
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE INT32 OddCeilingINT32(
        INT32 input)
    {
        return (input | 0x00000001);
    }
    ...
    /// EvenCeilingINT32
    ///
    /// @brief  Ceil INT32 to Even number
    ///
    /// @param  input input value to be rounded up
    ///
    /// @return UINT32 Rounded up value of input
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE INT32 EvenCeilingINT32(
        INT32 input)
    {
        INT32 result;
    ...
    /// @return TRUE if test passes
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE BOOL IsBitMaskSet64(
        UINT64  number,
        UINT64  mask)
    {
        return ((number & mask) == mask) ? TRUE : FALSE;
    ...
    /// @return TRUE if test passes
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE BOOL IsBitMaskReset64(
        UINT64  number,
        UINT64  mask)
    {
        return ((number & mask) == 0) ? TRUE : FALSE;
    ...
    /// FindAlignment
    ///
    /// @brief  Find the binary alignment of a given input number.
    ///         In essence, this function find the LSB bit position that
    ///         is set in a given input number and returns its alignment.
    ///         I.e., for 6, the return value will be 2 (b00000110 => b00000010)
    ///
    /// @param  value  Number to for which to find alignment.
    ///
    /// @return UINT32 The byte alignment for this number. Returns 1 if number is 0
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static UINT32 FindAlignment(
        UINT32 value)
    {
        UINT32 alignment = 0;

        while ((0 != value) && ((value & 1) == 0))
        {
            alignment++;
            value = value >> 1;
        }
    ...
    /// CalculateAlignment
    ///
    /// @brief  Calculate the Nearest Alignment of two input numbers.
    ///         This function finds that smallest number that can contain
    ///         both of the provided inputs and maintain the highest binary
    ///         bit alignment between them.
    ///         To do this, it first finds the highest number between them and
    ///         and then aligns that number to highest input alignment.
    ///         For instance, when provided with the numbers 68 and 32 it will
    ///         execute the following:
    ///         1) Find the highest number    = 68.
    ///         2) Find the highest alignment = 32  (68 = b01001000, 32 = b00100000)
    ///         3) Align the highest number to the highest binary alignment:
    ///            (68 + 31) & ~(31) = 96
    ///
    /// @param  value0  First value to compare for alignment
    /// @param  value1  Second value to compare for alignment
    ///
    /// @return UINT32 Nearest alignment - highest value aligned to the highest bit alignment
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static UINT32 CalculateAlignment(
        UINT32 value0,
        UINT32 value1)
    {
        UINT32 alignedValue = 0;

        if ((0 != value0) && (0 != value1))
        {
            if (value0 != value1)
            {
                UINT32 maxValue = Utils::MaxUINT32(value0, value1);
                UINT32 alignment = Utils::MaxUINT32(FindAlignment(value0), FindAlignment(value1));

                alignedValue = ((maxValue + (alignment - 1)) & ~(alignment - 1));
            }
            else
            {
                alignedValue = value0;
