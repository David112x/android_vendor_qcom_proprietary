/*============================================================================
  ...
  ===========================================================================*/
#ifndef _SNS_DEVICE_MODE_SKEL_H
#define _SNS_DEVICE_MODE_SKEL_H
...
extern "C" {
#endif
static __inline int _skel_method(int (*_pfn)(char*, uint32_t, uint32_t*), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   char* _in0[1];
   uint32_t _in0Len[1];
   uint32_t _rout1[1];
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(sns_device_mode_skel_invoke)(uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc))
   {
      case 0:
      return _skel_method((void*)__QAIC_IMPL(sns_device_mode_set), _sc, _pra);
   }
