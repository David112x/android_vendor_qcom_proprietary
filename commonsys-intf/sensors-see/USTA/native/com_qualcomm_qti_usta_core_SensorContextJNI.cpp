...
/*Will be called only once.. both for UI and Command line*/
jobjectArray getSensorList(JNIEnv *env, jobject obj)
{
  UNUSED_VAR(env);
  UNUSED_VAR(obj);
  ...
  INFO_LOG(log_instance , "getSensorList Creating UI Instance ");
  gSensorContextInstance[USTA_MODE_TYPE_UI] = SensorCxt::getInstance();
  INFO_LOG(log_instance , "getSensorListCreating COMMAND_LINE Instance  ");
  ...
  javaSensorListArray = (jobjectArray)env->NewObjectArray(sensorListInfo.size(),env->FindClass("com/qualcomm/qti/ustaservice/SensorListInfo"),NULL);
  ...
  for(unsigned int sensor_index = 0; sensor_index < sensorListInfo.size() ; sensor_index++)
  {
    ...
    jclass sensor_info_class = env->FindClass("com/qualcomm/qti/ustaservice/SensorListInfo");
...
jobjectArray getClientProcessors(JNIEnv *env , jobject jOb)
{
  UNUSED_VAR(jOb);
...
jobjectArray getWakeupDeliveryType(JNIEnv *env , jobject jOb)
{
  UNUSED_VAR(jOb);
  jobjectArray javaStringArray;
...
void removeSensors(JNIEnv *env , jobject jOb, jintArray inSensorHandleArray)
{
  UNUSED_VAR(jOb);
  ...
  INFO_LOG(log_instance , "removeSensors for UI Instance ");
  gSensorContextInstance[USTA_MODE_TYPE_UI]->remove_sensors(sensorsToBeRemoved);

  INFO_LOG(log_instance , "removeSensors for COMMAND_LINE Instance ");
...
{
  UNUSED_VAR(obj);
  jclass accessModifier_class = env->FindClass("com/qualcomm/qti/ustaservice/AccessModifier");
  ...
  if(label.compare("required") == 0)
  {
    ...
    fid = env->GetStaticFieldID(accessModifier_class, "REQUIRED" , "Lcom/qualcomm/qti/ustaservice/AccessModifier;");
  }
  else if(label.compare("optional") == 0)
  {
    accessModifier_value = OPTIONAL;
    fid = env->GetStaticFieldID(accessModifier_class, "OPTIONAL" , "Lcom/qualcomm/qti/ustaservice/AccessModifier;");
  }
  else if(label.compare("repeated") == 0)
  {
    accessModifier_value = REPEATED;
    fid = env->GetStaticFieldID(accessModifier_class, "REPEATED" , "Lcom/qualcomm/qti/ustaservice/AccessModifier;");
  }
  if(fid == 0)
    return NULL;
...
{
  UNUSED_VAR(obj);
  jclass datatype_class = env->FindClass("com/qualcomm/qti/ustaservice/DataType");
  ...
  {
    datatype_value = ENUM;
    fid = env->GetStaticFieldID(datatype_class, "ENUM" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  else if(data_type.compare("int32") == 0)
  {
    datatype_value = SIGNED_INTEGER32;
    fid = env->GetStaticFieldID(datatype_class, "SIGNED_INTEGER32" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  else if(data_type.compare("int64") == 0)
  {
    datatype_value = SIGNED_INTEGER64;
    fid = env->GetStaticFieldID(datatype_class, "SIGNED_INTEGER64" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  else if(data_type.compare("uint32") == 0)
  {
    datatype_value = UNSIGNED_INTEGER32;
    fid = env->GetStaticFieldID(datatype_class, "UNSIGNED_INTEGER32" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  else if(data_type.compare("uint64") == 0)
  {
    datatype_value = UNSIGNED_INTEGER64;
    fid = env->GetStaticFieldID(datatype_class, "UNSIGNED_INTEGER64" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  else if(data_type.compare("float") == 0 || data_type.compare("double") == 0)
  {
    datatype_value = FLOAT;
    fid = env->GetStaticFieldID(datatype_class, "FLOAT" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  else if(data_type.compare("bool") == 0)
  {
    datatype_value = BOOLEAN;
    fid = env->GetStaticFieldID(datatype_class, "BOOLEAN" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  else if(data_type.compare("string") == 0)
  {
    datatype_value = STRING;
    fid = env->GetStaticFieldID(datatype_class, "STRING" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  else
  {
    datatype_value = USER_DEFINED;
    fid = env->GetStaticFieldID(datatype_class, "USER_DEFINED" , "Lcom/qualcomm/qti/ustaservice/DataType;");
  }
  if(fid == 0)
    return NULL;
...
{
  UNUSED_VAR(obj);
  jclass nested_msg_class = env->FindClass("com/qualcomm/qti/ustaservice/NestedMsgPayload");
  ...
  javaSensorPayLoadFieldsArray= (jobjectArray)env->NewObjectArray(nested_msg.fields.size(),env->FindClass("com/qualcomm/qti/ustaservice/SensorPayloadField"),NULL);
  ...
  fid = env->GetFieldID(nested_msg_class, "fields", "[Lcom/qualcomm/qti/ustaservice/SensorPayloadField;");
  if (fid == 0)
    return NULL;
...
void getNestedMessageInfo(JNIEnv *env, jobject obj, jobject jNestedReqMsg, send_req_nested_msg_info &nested_msg)
{
  ...
  jfieldID fid = env->GetFieldID(req_msg_class, "fields", "[Lcom/qualcomm/qti/ustaservice/SensorPayloadField;");
  if (fid == 0)
    return;
...
{
  UNUSED_VAR(obj);
  jclass filed_info_class = env->FindClass("com/qualcomm/qti/ustaservice/SensorPayloadField");
  ...
  /*Data type*/
  fid = env->GetFieldID(filed_info_class, "dataType", "Lcom/qualcomm/qti/ustaservice/DataType;");
  if (fid == 0)
    return NULL;
  ...
  /*Lable*/
  fid = env->GetFieldID(filed_info_class, "accessModifier", "Lcom/qualcomm/qti/ustaservice/AccessModifier;");
  if (fid == 0)
    return NULL;
  ...
  if(in_filed_info.is_user_defined_msg == true)
  {
    ...
    javaNestedMsgArray= (jobjectArray)env->NewObjectArray(in_filed_info.nested_msgs.size(),env->FindClass("com/qualcomm/qti/ustaservice/NestedMsgPayload"),NULL);
    ...
    fid = env->GetFieldID(filed_info_class, "nestedMsgs", "[Lcom/qualcomm/qti/ustaservice/NestedMsgPayload;");
    if (fid == 0)
      return NULL;
...
void getFieldInfo(JNIEnv *env, jobject obj, jobject jfieldobject, send_req_field_info &each_field)
{
  ...
  {
    /*NestedMsgPayload[] */
    fid = env->GetFieldID(field_class, "nestedMsgs", "[Lcom/qualcomm/qti/ustaservice/NestedMsgPayload;");
    if (fid == 0)
      return;
  ...
  {
    /*Data type*/
    fid = env->GetFieldID(field_class, "dataType", "Lcom/qualcomm/qti/ustaservice/DataType;");
    if (fid == 0)
      return;
    jobject jdatatype = env->GetObjectField(jfieldobject, fid);
    string dataType = getDataType(env, obj, jdatatype);
    //    /*Lable*/
    fid = env->GetFieldID(field_class, "accessModifier", "Lcom/qualcomm/qti/ustaservice/AccessModifier;");
    if (fid == 0)
      return;
...
jobjectArray getRequestMessages(JNIEnv *env, jobject obj, jint jSensorHandle)
{
  UNUSED_VAR(obj);
  vector<msg_info> request_msgs;
  int sensorHandle = jSensorHandle;

  INFO_LOG(log_instance , "getRequestMessages ");
  gSensorContextInstance[USTA_MODE_TYPE_UI]->get_request_list(sensorHandle, request_msgs);


  jobjectArray javaReqMsgArray;
  javaReqMsgArray= (jobjectArray)env->NewObjectArray(request_msgs.size(),env->FindClass("com/qualcomm/qti/ustaservice/ReqMsgPayload"),NULL);

  for(unsigned int req_msg_index = 0; req_msg_index < request_msgs.size() ; req_msg_index++)
  {
    jclass req_msg_class = env->FindClass("com/qualcomm/qti/ustaservice/ReqMsgPayload");
    if(req_msg_class == NULL)
    {
    ...
    /*Vector of fields*/
    jobjectArray javaSensorPayLoadFieldsArray;
    javaSensorPayLoadFieldsArray= (jobjectArray)env->NewObjectArray(request_msgs[req_msg_index].fields.size(),env->FindClass("com/qualcomm/qti/ustaservice/SensorPayloadField"),NULL);
    ...
    fid = env->GetFieldID(req_msg_class, "fields", "[Lcom/qualcomm/qti/ustaservice/SensorPayloadField;");
    if (fid == 0)
      return NULL;
...
jstring getSensorAttributes(JNIEnv *env, jobject obj,jint jSensorHandle)
{
  UNUSED_VAR(obj);
...
{
  UNUSED_VAR(obj);
  jclass errorCode_class = env->FindClass("com/qualcomm/qti/ustaservice/NativeErrorCodes");
  ...
  {
    fid = env->GetStaticFieldID(errorCode_class, "USTA_MEMORY_ERROR" , "Lcom/qualcomm/qti/ustaservice/NativeErrorCodes;");
  }
  else if(USTA_RC_NO_PROTO == NativeErrorCode)
  {
    fid = env->GetStaticFieldID(errorCode_class, "USTA_PROTOFILES_NOT_FOUND" , "Lcom/qualcomm/qti/ustaservice/NativeErrorCodes;");
  }
  else if(USTA_RC_REQUIIRED_FILEDS_NOT_PRESENT == NativeErrorCode)
  {
    fid = env->GetStaticFieldID(errorCode_class, "USTA_REQUIRED_FIELDS_MISSING" , "Lcom/qualcomm/qti/ustaservice/NativeErrorCodes;");
  }
  else if(USTA_RC_SUCCESS == NativeErrorCode)
  {
    fid = env->GetStaticFieldID(errorCode_class, "USTA_NO_ERROR" , "Lcom/qualcomm/qti/ustaservice/NativeErrorCodes;");
  }
  if(fid == 0)
    return NULL;
...
void destroySensors(JNIEnv *env, jobject obj, jobject inModeType)
{
  ...
  {
    gSensorContextInstance[USTA_MODE_TYPE_UI]->destroy_sensors();
  ...
  {
    gSensorContextInstance[USTA_MODE_TYPE_COMMAND_LINE]->destroy_sensors();
    delete gSensorContextInstance[USTA_MODE_TYPE_COMMAND_LINE];
    gSensorContextInstance[USTA_MODE_TYPE_COMMAND_LINE] = NULL;
  }

  if(gClientProcessor.size() != 0) {
    gClientProcessor.clear();
  }

  if(gWakeupDeliveryType.size() != 0) {
    gWakeupDeliveryType.clear();
  }

  if(samplesBufferPool.size() != 0) {
    samplesBufferPool.clear();
  }

  if(registrySamplesBufferPool.size() != 0) {
...
jint sendDeviceModeIndication(JNIEnv *env, jobject obj, jint device_mode_number , jint device_mode_state)
{
  ...
  set_system_parition(true);
  rpcmem_init();
  vec = (char*)rpcmem_alloc(RPCMEM_DEFAULT_HEAP,RPCMEM_DEFAULT_FLAGS,encoded_request.length());
  if(vec == NULL){
  ...
  rpcmem_free((void *)vec);
  rpcmem_deinit();
#else
  UNUSED_VAR(device_mode_number);
  UNUSED_VAR(device_mode_state);
#endif
...
/*
 * Class and package name - com.qualcomm.qti.ustaservice
 * */
static const char *classPathName = "com/qualcomm/qti/ustaservice/JavaNativeInterfaceAPIs";
...
static JNINativeMethod methods[] = {
    {"getSensorList" , "()[Lcom/qualcomm/qti/ustaservice/SensorListInfo;", (void *)getSensorList},
    {"getClientProcessors" , "()[Ljava/lang/String;", (void *)getClientProcessors},
    {"getWakeupDeliveryType" , "()[Ljava/lang/String;", (void *)getWakeupDeliveryType},
    {"removeSensors" , "([I)V", (void *)removeSensors},
    {"getRequestMessages" , "(I)[Lcom/qualcomm/qti/ustaservice/ReqMsgPayload;", (void *)getRequestMessages},
    {"getSensorAttributes" , "(I)Ljava/lang/String;", (void *)getSensorAttributes},
    {"sendRequest" , "(Lcom/qualcomm/qti/ustaservice/ModeType;ILcom/qualcomm/qti/ustaservice/ReqMsgPayload;Lcom/qualcomm/qti/ustaservice/SendReqStdFields;Ljava/lang/String;)Lcom/qualcomm/qti/ustaservice/NativeErrorCodes;", (void *)sendRequest},
    {"stopRequest" , "(Lcom/qualcomm/qti/ustaservice/ModeType;IZ)V", (void *)stopRequest},
    {"updateLoggingFlag" , "(Z)V", (void *)updateLoggingFlag},
    {"destroySensors" , "(Lcom/qualcomm/qti/ustaservice/ModeType;)V", (void *)destroySensors},
