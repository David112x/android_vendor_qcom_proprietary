...
public:
    ...
    void ssc_configuration(bool is_rt_enable, uint32_t atrace_delay);
    /**
     * @brief set whether bypass worker processing or not
     */
    void ssc_configuration(bool bypass_worker);
