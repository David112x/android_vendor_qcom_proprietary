...
#$(1) *.proto file
#$(2) *.cpp file to be generated
#$(3) protoc_flags to be used
define _compile_proto
$(2): $(1) $(PROTOC)
...
$(foreach src,$(proto_files),$(eval $(call _compile_proto,\
    $(LOCAL_PATH)/$(src),\
    $(patsubst %.proto,$(sns_gen_sources_dir)/%.pb.cpp,$(src)),\
    $(sns_protoc_flags))))
...
$(foreach src,$(proto_files),$(eval $(call _compile_proto,\
    $(LOCAL_PATH)/$(src),\
    $(patsubst %.proto,$(gen_sources_dir)/%.pb.cpp,$(src)),\
    $(protoc_flags))))
...
$(foreach src,$(proto_files),$(eval $(call _compile_proto,\
    $(LOCAL_PATH)/$(src),\
    $(patsubst %.proto,$(gen_sources_dir_system)/%.pb.cpp,$(src)),\
    $(protoc_flags_system))))
