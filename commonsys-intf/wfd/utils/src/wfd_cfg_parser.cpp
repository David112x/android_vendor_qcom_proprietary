...
@par     SIDE EFFECTS:
                           None
*//*==========================================================================*/
void limitCodecParams(uint8& uMaxLevel)
{
...
void parseHWVer()
{
    ...
    switch(mnHW_ID)
    {
        ...
        case 366:
            ...
            break;
        case 434:
            //since both spec has same capabilities
            if(!(strncmp(value, "2", PROPERTY_VALUE_MAX))||
               !(strncmp(value, "3", PROPERTY_VALUE_MAX))){
                mnHW_Ver = 0;
            }
        default:
            break;
