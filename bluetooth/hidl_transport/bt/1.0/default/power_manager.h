...
class PowerManager {
 private:
  ...
  static const int get_bt_reset_gpio_cmd_ = 0xbfaf;
  static const int get_bt_sw_ctrl_gpio_cmd_ = 0xbfb0;
  static const int get_bt_vdd_aon_ldo_cmd_ = 0xbfb1;
  static const int get_bt_vdd_dig_ldo_cmd_ = 0xbfb2;
  static const int get_bt_vdd_rfa1_ldo_cmd_ = 0xbfb3;
  static const int get_bt_vdd_rfa2_ldo_cmd_ = 0xbfb4;
