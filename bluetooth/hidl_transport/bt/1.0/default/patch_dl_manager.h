...
enum {
  MOSELLE_VER_1_0   = QCA_BT_VER(QCA_MOSELLE_SOC_ID_0100, PROD_ID_MOSELLE, MOSELLE_BUILD_VER_0100),
};
...
enum {
  ...
  HSP_VER_1_1   = QCA_BT_VER(QCA_HSP_SOC_ID_0110, PROD_ID_HSP, HSP_BUILD_VER_0100),
