...
private:
    ...
    /// IsMatchingFSMode
    ///
    /// @brief  Method to IsMatching FS mode
    ///
    /// @param  pModeInfo       Pointer to mode information in sensor driver
    ///
    /// @return True if the mode is Default
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static BOOL IsMatchingFSMode(
        const ChiSensorModeInfo* pModeInfo);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static BOOL IsMatchingZZHDRMode(
        const ChiSensorModeInfo* pModeInfo);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// FindClosestDimensionMode
    ///
    /// @brief  Method to find closest mode for fps and dimension
    ///
    /// @param  pAllModes           Pointer to all mode information in sensor driver
    /// @param  modeCount           mode count
    /// @param  pDesiredSensorMode  Pointer to SensorSelectMode as requested by application
    ///
    /// @return True if the mode is IHDR
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static UINT32 FindClosestMode(
    ...
    ///
    /// @param  cameraId           Camera Id
    /// @param  pDesiredSensorMode Pointer to DesiredSensorMode
    ///
    /// @return True if aspect ratio condition matches else false
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
