...
static const UINT ICA20GridTransformWidth                = 35; // 33 for ICA10, 35 for ICA20
static const UINT ICA20GridTransformHeight               = 27; // 25 for ICA10, 27 for ICA20
static const UINT ICA10GridTransformWidth                = 33; // 33 for ICA10, 35 for ICA20
static const UINT ICA10GridTransformHeight               = 25; // 25 for ICA10, 27 for ICA20
static const UINT ICA30GridTransformWidth                = 67; // 67 for ICA30
static const UINT ICA30GridTransformHeight               = 51; // 51 for ICA30

/// @brief IPE ICA Grid Geometry
enum ICAGridGeometry
{
    ICAGeometryCol33Row25 = 0,    /// geometry 33 * 25 for ICA10
    ICAGeometryCol35Row27,        /// geometry 35 * 27 for ICA20
    ICAGeometryCol67Row51,        /// geometry 35 * 27 or 67 * 51 ICA30
...
typedef struct
{
    ...
    ///
    /// Description:   flag to skip alignment matrix adjustment, if needed for forced identity perspective transform cases.
    /// Type:          BOOL
    /// Default Value: 0
    /// Range:         [0-1]
    /// Bit Depth:     1u
...
typedef struct
{
    ...
    ///
    /// Description:   Made up of 825  FLOAT: 33 * 25 entries for ICA10, spanning uniformly across the output image:
    ///                Made up of 945  FLOAT: 35 * 27 entries for ICA20, spanning uniformly across the output image:
    ///                Made up of 3417 FLOAT: 67 * 51 entries for ICA30, spanning uniformly across the output image :
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ICAGridArray gridTransformArray[ICA30GridTransformWidth *
        ICA30GridTransformHeight];
    ...
    /// geometry
    ///
    /// Description:   Grid geometry parameters.
    /// Type:          UINT32
    /// Default Value: 0 for ICA10, 1 for ICA20, 1 or 2 ICA 30.
    /// Range:         [0-2]
    /// Bit Depth:     1u
    /// Conversion:    No Conversion needed
    /// Notes:         None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ICAGridGeometry geometry;
...
typedef struct
{
    ...
    /// Type:          UINT32
    /// Default Value: 0
    /// Range:         [1, ICA30GridTransformWidth]
    /// Bit Depth:     1u
    /// Conversion:    No Conversion needed
    /// Notes:         parameters of forward grid
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /// Bit Depth:     float
    /// Conversion:    No Conversion needed
    /// Notes:         Max size ICA30GridTransformHeight * ICA30GridTransformWidth. parameters of forward grid.
    ...
    /// Type:          UINT32
    /// Default Value: 0
    /// Range:         [1-ICA30GridTransformHeight]
    /// Bit Depth:     1u
    /// Conversion:    No Conversion needed
...
typedef struct
{
    ...
    /// Bit Depth:     float
    /// Conversion:    No Conversion needed
    /// Notes:         Max size ICA30GridTransformHeight * ICA30GridTransformWidth. parameters of inverse grid.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
