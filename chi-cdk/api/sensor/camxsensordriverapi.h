...
#define MAX_REG_CONTROL_EXT_DATA_SIZE   32  ///< Max data size of the additional data from external module
...
typedef struct SensorExposureInfo
{
    ...
    FLOAT   sensitivityCorrectionFactor;   ///< sensitivity correction factor for current sensor mode
} SensorExposureInfo;
...
/// @brief Sensor LTC ratio information to fill LTC ratio reg settings array
typedef struct SensorFillLTCRatioData
{
    UINT32                 inputLTCRatioIndex;
    UINT32                 sensorLTCRatioAddr;
    UINT32                 numberOfLTCRatioRegCount;
}SensorFillLTCRatioData;
...
typedef struct SensorLibraryAPI
{
    ...
    /// @return TRUE if successful else FALSE
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    BOOL (*pFillToneControlSettings)(
        RegSettingsInfo*            pRegSettingsInfo,
        SensorFillLTCRatioData*     pLTCRatioData);               ///< pointer to FillToneControlSettings function
    ...
    /// UpdateMaxAnalogGain
    ///
    /// @brief  Update Max Analog Gain
    ///
    /// @param  inputMaxAnalogGain      maximum analog gain for update
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID (*pUpdateMaxAnalogGain)(
