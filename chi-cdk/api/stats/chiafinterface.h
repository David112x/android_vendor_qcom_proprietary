...
typedef enum
{
    ...
    AFOutputTypeIsDepthFocus,                               ///< Depth focus indicator
                                                            ///  Payload: BOOL
...
typedef enum
{
    ...
    AFGetParamFOVCInfo,                         ///< Payload: FOVCInfo
...
typedef enum
{
    ...
    AFSetParamTypeUnstabilizedFaceROI,                      ///< Uniform Face ROIs in 3A
                                                            ///  Payload: UnstabilizedROIInformation
    AFSetParamTypeTrackROI,                                 ///< Track ROIs in 3A
                                                            ///  Payload: UnstabilizedROIInformation
    AFSetParamTypeDepth16Data,                              ///< Depth16 data input for AF algorithm
                                                            ///  Payload: AFDepth16Stats
    AFSetParamTypeBPSCamera,                                ///< If BPS Realtime usecase is selected
                                                            ///  Payload type: Bool
