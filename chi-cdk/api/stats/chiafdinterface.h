...
typedef struct
{
    ...
    UINT32 sensorWidth;             ///< Sensor Width
} AFDSensorInfo;
...
typedef struct
{
    ...
    AFLensPositionInfo  lensPositionInfo;    ///< info regarding to lens position and movement type
} AFDAFInfo;
...
typedef enum
{
    ...
    AFDAlgoSetParamDumpRowSum,                      ///< Flag to dump row sum stats
                                                    ///  Payload type: BOOL
    AFDAlgoSetParamOverrideSettings,                ///< override setting info
                                                    ///  Payload type: StatisticsAntibanding
    AFDAlgoSetParamFrameId,                         ///< Frame Id
                                                    ///  Payload type: UINT64
    AFDAlgoSetParamBPSCamera,                       ///< If BPS Realtime usecase is selected
                                                    ///  Payload type: Bool
    AFDAlgoSetParamCameraInfo,                      ///< CameraInfo
