...
typedef struct
{
    BOOL isLandscape; ///< Landscape or not
    BOOL isPortrait;  ///< Portrait or not
    BOOL isHDR;       ///< HDR scene or not.
} ASDAlgoSceneInfo;
...
typedef enum
{
    ...
    ASDAlgoSetParamOverrideSettings,             ///< Override Settings
