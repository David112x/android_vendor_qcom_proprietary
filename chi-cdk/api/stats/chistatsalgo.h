...
/// @brief Callback Interface for Chi to call into custom Histogram algorithm.
typedef struct ChiHistogramAlgorithmCallbacks
{
    UINT32                         size;                    ///< Size of this structure.
    ...
    CREATEHISTOGRAMALGOPROCESS     pfnCreate;               ///< Mandatory function to create an instance of the algorithm.
    PFCHISETALGORITHMINTERFACE     pfnSetAlgoInterface;     ///< Mandatory function to set the algo interface functions.
} CHIHISTALGORITHMCALLBACKS;
...
/// @brief Callback Interface for Chi to call into custom ASD algorithm.
typedef struct ChiTrackerAlgorithmCallbacks
{
    UINT32                         size;                    ///< Size of this structure.
    UINT32                         majorVersion;            ///< Major version.
    UINT32                         minorVersion;            ///< Minor version.
    PFNALGORITHMGETCAPABILITIES    pfnGetCapabilities;      ///< Get algorithm Capabilities.
    PFNCHIQUERYVENDORTAG           pfnQueryVendorTag;       ///< Optional function to get the vendor tags supported by node.
    CREATETRACKER                  pfnCreate;               ///< Mandatory function to create an instance of the algorithm.
    PFCHISETALGORITHMINTERFACE     pfnSetAlgoInterface;     ///< Mandatory function to set the algo interface functions.
} CHITRACKERALGORITHMCALLBACKS;
...
/// Histogram Algorithm Callback Function
typedef VOID(*PFHDRCHIALGORITHMENTRY) (CHIHISTALGORITHMCALLBACKS* pHISTOGRAMALGORITHMCallbacks);
...
typedef VOID(*PFTRACKERCHIALGORITHMENTRY) (CHITRACKERALGORITHMCALLBACKS* pTRACKERALGORITHMCallbacks);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// ChiHistogramAlgorithmEntry
///
/// @brief  Entry point called by the Chi driver to initialize the custom Histogram Algorithm.
///
...
/// @return VOID.
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CAMX_VISIBILITY_PUBLIC VOID ChiHistogramAlgorithmEntry(
    CHIHISTALGORITHMCALLBACKS* pAlgorithmCallbacks);
