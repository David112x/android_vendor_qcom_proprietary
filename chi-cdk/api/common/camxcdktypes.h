...
static const CDKResult CDKResultEDisabled         = 27;   ///< Feature disabled
static const CDKResult CDKResultECancelledRequest = 28;   ///< Request is in cancelled state
// Increment the count below if adding additional result codes.
static const CDKResult CDKResultCount             = 29;   ///< The number of result codes. Not to be used.

static const UINT CDKInvalidId                    = 0xFFFFFFFF;   ///< Defining an Invalid Handle

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// CDK_UNREFERENCED_PARAM
///
...
/// @return void
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define CDK_UNREFERENCED_PARAM(param) (void)param
...
enum CameraIdRemapMode
{
    ...
    IdReverseMapCamera = 2,      ///< Remap logic for hal internal camera ID to external camera id
};

/// @brief Type of info to retrieve
enum CDKGetInfoCmd
{
    CDKGetInfoNumPhysicalCameras,       ///< Get the number of physical cameras associated with a given logical cameraId
    CDKGetInfoPhysicalCameraIds,        ///< Get the physical cameraIds for a given logical cameraId
    CDKGetInfoMax
};

/// @brief Data structure for passing camera Id
struct CDKInfoCameraId
{
    UINT32      cameraId;
};

/// @brief Data structure for passing number of cameras
struct CDKInfoNumCameras
{
    UINT        numCameras;
};

/// @brief Data structure for getting list of physical camera Ids
struct CDKInfoPhysicalCameraIds
{
    UINT        numCameras;
    UINT32*     physicalCameraIds;
};
