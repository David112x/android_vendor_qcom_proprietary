...
typedef struct chi_hal_callback_ops {
    ...
    /// chi_get_info
    ///
    /// @brief  Generic interface for retrieving info from the override
    ///
    /// @return CDKResultSuccess, if success.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CDKResult (*chi_get_info)(
    ...
    /// @param  [in] priv               Pointer to the private data for the module.
    ///
    /// @return ChiResultCDKResultSuccess, if success.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CDKResult (*chi_override_flush)(
        const camera3_device_t*     camera3_device);

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// chi_override_dump
    ///
    /// @brief  Allows override processing during HAL dump call
    ///
    /// @param  [in] camera3_device     Pointer to the camera3_device instance of Chi driver.
    /// @param  [in] fd                 file descriptor
    ///
    /// @return Success if dumped, else failure result
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CDKResult (*chi_override_dump)(
        const camera3_device_t*     camera3_device,
        int                         fd);
