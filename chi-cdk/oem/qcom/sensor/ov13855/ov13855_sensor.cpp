...
#define OV13855_MIN_DGAIN               (OV13855_MIN_DGAIN_REG_VAL / 1024.0)
#define OV13855_MAX_DGAIN               (OV13855_MAX_DGAIN_REG_VAL / 1024.0)
    ...
    SensorCalculateExposureData* pCalculateExposureData)
{
    ...
    pExposureInfo->digitalRegisterGain  = OV13855_MIN_DGAIN_REG_VAL; // force sensor's digitial gain to x1
    pExposureInfo->digitalRealGain      = OV13855_MIN_DGAIN;
    ...
    SensorFillExposureData* pExposureData)
{
    ...
    // Please refer to the application notes only.
