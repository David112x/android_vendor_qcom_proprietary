...
/// @return CDKResultSuccess if success or appropriate error code.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CDKResult MemCpyNodeFlushRequest(
    CHINODEFLUSHREQUESTINFO* pInfo)
{
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            ChiMemCpyNode* pNode = static_cast<ChiMemCpyNode*>(pInfo->hNodeSession);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// MemCpyNodeGetFlushResponseTime
///
...
/// @return CDKResultSuccess if success or appropriate error code.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static CDKResult MemCpyNodeGetFlushResponseTime(
    CHINODERESPONSEINFO* pInfo)
{
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            ChiMemCpyNode* pNode = static_cast<ChiMemCpyNode*>(pInfo->hChiSession);
    ...
    CHINODECREATEINFO* pCreateInfo)
{
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            if (NULL != pCreateInfo->pNodeProperties[i].pValue)
            {
                UINT32 instancePropertyCapsMask = static_cast<UINT32>
                    (atoi(static_cast<const CHAR*> (pCreateInfo->pNodeProperties[i].pValue)));

                if (ChiNodeCapsDelayedProcessing & instancePropertyCapsMask)
                {
                    pCreateInfo->nodeFlags.hasDelayedNotification = TRUE;
                    LOG_INFO(CamxLogGroupChi, "Delayed processing notifying enabled");
                }
            }
        }
    }
    ...
    CHINODEQUERYBUFFERINFO* pQueryBufferInfo)
{
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            m_isSinkNoBuffer[outputIndex] = pQueryBufferInfo->pOutputPortQueryInfo[outputIndex].outputPortflags.isSinkNoBuffer;
        }
    }
    ...
    CHINODESETBUFFERPROPERTIESINFO* pSetBufferInfo)
{
    ...
    {
        LOG_ERROR(CamxLogGroupChi, "pSetBufferInfo is NULL");
        result            = CDKResultEFailed;
    }
    ...
    CHINODEPROCESSREQUESTINFO* pProcessRequestInfo)
{
    ...
    if (TRUE == satisfied)
    {
        if ((0 != m_inducedSleepTime) && (!IsRealTime()))
        {
        ...
        for (UINT32 i = 0; ((i < pProcessRequestInfo->outputNum) && (m_isSinkNoBuffer[i] == FALSE)); i++)
        {
    ...
    CHINODEBUFFERHANDLE hInput)
{
    ...
    if (hOutput->numberOfPlanes < hInput->numberOfPlanes )
    {
        result = CDKResultEInvalidArg;
        LOG_ERROR(CamxLogGroupChi, "Invalid argument: output numberOfPlanes is smaller than input");
    }

    if (CDKResultSuccess == result)
    {
        // Input image buffer cache invalidate before read
        g_ChiNodeInterface.pCacheOps(hInput, TRUE, FALSE);
        ...
        // Output image buffer cache clean after write
        g_ChiNodeInterface.pCacheOps(hOutput, FALSE, TRUE);
    }
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// ChiMemCpyNode::FlushRequest
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CDKResult ChiMemCpyNode::FlushRequest(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// ChiMemCpyNode::ComputeResponseTime
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CDKResult ChiMemCpyNode::ComputeResponseTime(
    CHINODERESPONSEINFO* pInfo)
{
