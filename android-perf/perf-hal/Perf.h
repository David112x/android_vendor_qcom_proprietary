...
#ifndef VENDOR_QTI_HARDWARE_PERF_V2_1_PERF_H
#define VENDOR_QTI_HARDWARE_PERF_V2_1_PERF_H

#include <vendor/qti/hardware/perf/2.1/IPerf.h>
...
using ::vendor::qti::hardware::perf::V2_1::IPerf;
...
private:
    ...
    sp<IPerfCallback> mPerfCallback;
public:
    Perf();
    ~Perf();
