...
include $(CLEAR_VARS)
LOCAL_MODULE := init.pixel.vendor.qti.hardware.perf@2.1-service.rc
...
LOCAL_MODULE := vendor.qti.hardware.perf@2.1-service
LOCAL_INIT_RC := vendor.qti.hardware.perf@2.1-service.rc
