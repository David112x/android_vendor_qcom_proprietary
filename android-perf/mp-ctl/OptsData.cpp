...
int OptsData::Init() {
    ...
    init_npubw_hwmon_path();
    init_npu_llcbw_hwmon_path();
...
// npu_llcc_ddr
int OptsData::init_npubw_hwmon_path() {
    int ret = FAILED;
    ...
    get_nodes_folder_path(sysfsnode_path[NPU_START_INDEX + NPU_LLC_DDR_HWMON_SAMPLE_MS], folder_path);
    get_nodes_folder_path(folder_path, folder_path);
    ...
    snprintf(npubw_path, NODE_MAX, "%s%s", DEVFREQ_PATH, d_name);
    snprintf(npubw_hwmon_hyst_count_path, NODE_MAX, "%s/bw_hwmon/hyst_trigger_count", npubw_path);
    snprintf(npubw_hwmon_hyst_length_path, NODE_MAX, "%s/bw_hwmon/hyst_length", npubw_path);
    snprintf(npubw_hwmon_hist_memory_path, NODE_MAX, "%s/bw_hwmon/hist_memory", npubw_path);

    return SUCCESS;
}

int OptsData::init_npu_llcbw_hwmon_path() {
    char d_name[NODE_MAX] = "";
    int ret = FAILED;
    char folder_path[NODE_MAX] = "";
    char *parent = NULL;
    ...
    get_nodes_folder_path(sysfsnode_path[NPU_START_INDEX + NPU_LLCBW_HWMON_SAMPLE_MS], folder_path);
    get_nodes_folder_path(folder_path, folder_path);
    ...
    snprintf(npu_llcbw_path, NODE_MAX, "%s%s", DEVFREQ_PATH, d_name);
    snprintf(npu_llcbw_hwmon_hist_memory_path, NODE_MAX, "%s/bw_hwmon/hist_memory", npu_llcbw_path);
    snprintf(npu_llcbw_hwmon_hyst_length_path, NODE_MAX, "%s/bw_hwmon/hyst_length", npu_llcbw_path);
    snprintf(npu_llcbw_hwmon_hyst_count_path, NODE_MAX, "%s/bw_hwmon/hyst_trigger_count", npu_llcbw_path);
