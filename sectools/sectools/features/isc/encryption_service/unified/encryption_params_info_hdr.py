...
class EncryptionParamsInfoHdr_1_0(object):
    ...
    def _generate_binary_blob(self):
        encryption_params_hdr_blob = struct.pack("=Icccc",
                                                 ...
                                                 chr(EncryptionParamsInfoHdr_1_0.Defines.RSVD_BYTE),
                                                 chr(EncryptionParamsInfoHdr_1_0.Defines.RSVD_BYTE),
                                                 chr(EncryptionParamsInfoHdr_1_0.Defines.RSVD_BYTE))
        for eps in self.eps:
    ...
    def byte_sequence(cls):
        ...
        return struct.pack(
            "=IccccHccI",
            defines.MAGIC_NUM,
            chr(defines.MAX_EPS_SUPPORTED - 1),
            chr(defines.RSVD_BYTE),
            chr(defines.RSVD_BYTE),
            chr(defines.RSVD_BYTE),
            defines.HEADER_SIZE_BYTES,
            chr(defines.MAJOR_VERSION),
            chr(defines.MINOR_VERSION),
            defines.RSVD_BYTE)
