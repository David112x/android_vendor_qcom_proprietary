...
void CommandHandler::SetHandlers()
{
    ...
    m_groupCommandBuilders.insert(make_pair("log_collector", unique_ptr<GroupCommandBuilderBase>(new LogCollectorCommandBuilder())));
    m_groupCommandBuilders.insert(make_pair("pmc", unique_ptr<GroupCommandBuilderBase>(new PmcCommandBuilder())));
    m_groupCommandBuilders.insert(make_pair("host", unique_ptr<GroupCommandBuilderBase>(new HostCommandBuilder())));
    m_groupCommandBuilders.insert(make_pair("access", unique_ptr<GroupCommandBuilderBase>(new AccessCommandBuilder())));
