    ...
    m_argsAreValid(false), m_isVersionRequired(false)
{
    ...
    m_group = args[1];
    transform(m_group.begin(), m_group.end(), m_group.begin(), [](char c) { return static_cast<char>(::tolower(c)); });
    ...
    m_opCode = args[2];
    transform(m_opCode.begin(), m_opCode.end(), m_opCode.begin(), [](char c) { return static_cast<char>(::tolower(c)); });
