...
void LogCollectorSetConfigHandler::HandleRequest(const LogCollectorSetConfigRequest& jsonRequest, LogCollectorSetConfigResponse& jsonResponse)
{
    ...
    {
        LOG_DEBUG << "setting TargetServer to: " << targetServerBoxed << endl;
        Host::GetHost().GetConfiguration().PostLogCollection.TargetServer = targetServerBoxed;
    }
    ...
    if (userNameBoxed.GetState() == JsonValueState::JSON_VALUE_PROVIDED)
    {
        ...
        Host::GetHost().GetConfiguration().PostLogCollection.UserName = userNameBoxed;
    }
    ...
    if (remotePathBoxed.GetState() == JsonValueState::JSON_VALUE_PROVIDED)
    {
        ...
        Host::GetHost().GetConfiguration().PostLogCollection.RemotePath = remotePathBoxed;
    }
