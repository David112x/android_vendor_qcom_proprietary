...
namespace log_collector
{
    ...
    public:
        ...
        OperationStatus StartLogging(const std::string& deviceName, CpuType cpuType, LoggingType loggingType, bool compress, bool upload);
        ...
        OperationStatus EnableDeferredLogging(LoggingType loggingType, bool compress, bool upload);
    ...
    private:
        ...
        bool m_deferredCompress;
        bool m_deferredUpload;
