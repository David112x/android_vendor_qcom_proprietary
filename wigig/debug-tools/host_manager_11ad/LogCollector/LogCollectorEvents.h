...
{
public:
    explicit SerializableLogLine(RawLogLine&& logLine) : RawLogLine(std::move(logLine)) {}
...
{
public:
    NewLogsEvent(const std::string& deviceName, const log_collector::CpuType& cpuType, std::vector<log_collector::RawLogLine>& logLines);
