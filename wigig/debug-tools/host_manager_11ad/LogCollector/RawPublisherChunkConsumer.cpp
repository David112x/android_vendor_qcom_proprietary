...
namespace log_collector
{
    ...
    {
        m_rawLogLinesForEvent.emplace_back(RawLogLine::MISSIG_PARAM_DWORDS, diffDwords);
        LOG_DEBUG << __FUNCTION__ << ": "
            << " Log publishing for: " << m_deviceName
            << " for cpu: " << m_tracerCpuType
            << " Inconsistent wptr position in the middle of a message, diff (DWORDS): " << diffDwords << endl;
    }
    ...
    OperationStatus RawPublisherChunkConsumer::Enable(const module_level_info* moduleLevelInfoArray,
