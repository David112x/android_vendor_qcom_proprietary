...
#define WDS_V01_IDL_MINOR_VERS 0xBC
...
#define QMI_WDS_EMBMS_TA_DATA_LIST_MAX_V01 15
/**
    @}
  */
...
#define QMI_WDS_MASK_REQ_SETTINGS_SNSSAI_PDN_INFO_V01 ((wds_req_settings_mask_v01)0x00800000)
...
typedef struct {
  ...
  /**<   TMGI
    */
}wds_tuneaway_data_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t sd[WDS_MAX_SD_LEN_V01];
  /**<   Slice differentiator; value "FFFFFF" indicates
       no SD associated with this SST. */

  uint8_t mapping_sst_present;
  /**<   Flag indicating whether the mapped SST is present. */

  uint8_t mapped_sst;
  /**<   SST value for the HPLMN to which the SST value is mapped. */

  uint8_t mapped_sd[WDS_MAX_SD_LEN_V01];
  /**<   SD value for the HPLMN to which the SD value is mapped.
       Value "FFFFFF" indicates no SD associated with the mapped SST. */
}wds_snssai_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t snssai_info_is_valid;
  /**<   Indicates whether SNSSAI information is present.
  */

  wds_snssai_info_type_v01 snssai_info;
  /**<   SNSSAI information.
  */

  uint8_t is_snssai_resolved;
 ...
 */
  ...
  uint32_t rat_mask;
  /**<   RAT mask indicating the type of technology.
  ...
  */
  ...
  uint32_t so_mask;
  /**<   SO mask indicating the service option or type of
       application.
...
typedef struct {
  ...
  */
  ...
  uint8_t report_v2x_config_change_valid;  /**< Must be set to true if report_v2x_config_change is being passed */
  uint8_t report_v2x_config_change;
  /**<    Values: \n
       - 0 -- Do not report \n
  ...
  */
  ...
  uint8_t report_v2x_config_file_content_valid;  /**< Must be set to true if report_v2x_config_file_content is being passed */
  uint8_t report_v2x_config_file_content;
  /**<    Values: \n
       - 0 -- Do not report \n
...
typedef struct {
  ...
  wds_snssai_pdn_type_v01 snssai_pdn_info;
  /**<   SNSSAI PDN information.
  */

  char active_apn[QMI_WDS_APN_NAME_MAX_V01 + 1];
  /**<   Active APN.
  */

  uint8_t is_apn_resolved;
  /**<   Indicates whether the APN name is resolved by the network.
  */
}wds_handoff_context_ex_type_v01;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /**<   Values: \n
      ...
      - WDS_APN_TYPE_UT (12) --  APN type for UT
 ...
 */
  ...
  */
  ...
  /**<   Values: \n
      ...
      - WDS_APN_TYPE_MASK_UT (0x400) --  APN type for UT
      - WDS_APN_TYPE_MASK_MCX (0x800) --  APN type for mission critical service
 */

  /* Optional */
  /*  Extended Handoff Context */
  uint8_t handoff_context_ex_valid;  /**< Must be set to true if handoff_context_ex is being passed */
  wds_handoff_context_ex_type_v01 handoff_context_ex;
  /**<   \n
     Additional context information needed if the TE is handing off a call to the modem.
    */
...
typedef enum {
  ...
  WDS_VCER_INTERNAL_NON_PREFERRED_CLIENT_V01 = 0x10D,
 ...
 */
 ...
 Indicates whether SDUs detected as erroneous are delivered. Values: \n
...
typedef enum {
  ...
  WDS_ADDR_ALLOC_PREF_NAS_V01 = 0x00, /**<  Use NAS signaling for address allocation \n           */
  WDS_ADDR_ALLOC_PREF_DHCP_V01 = 0x01, /**<  Use DHCP for address allocation  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  SNSSAI PDN Information */
  uint8_t snssai_pdn_info_valid;  /**< Must be set to true if snssai_pdn_info is being passed */
  wds_snssai_pdn_type_v01 snssai_pdn_info;
  /**<
  */
...
typedef enum {
  ...
  WDS_SIO_PORT_ID_V01 = 0, /**<  Use the data_port field \n  */
  WDS_END_POINT_ID_V01 = 1, /**<  Use the ep_type, iface_id, and mux_id fields   */
...
typedef struct {
  ...
  */
  ...
  /**<     Values  \n
       - 0x00 -- Do not query the lte_attach failure information capability \n
       - 0x01 -- Query for lte_attach failure information capability.
 ...
 */
  ...
  uint8_t lte_attach_failure_info_capability;
  /**<     Values  \n
       - 0x00 -- LTE attach failure information capability is not supported on the modem\n
       - 0x01 -- LTE attach failure information capability is supported on the modem.
...
typedef struct {
  ...
  /**<   Indicates whether silent redial is required. Values: \n
       - 0 -- Not required \n
       - 1 -- Required.
    */
 ...
 */
  ...
  /* Optional */
  /*   Next activity Time */
  uint8_t next_activity_time_valid;  /**< Must be set to true if next_activity_time is being passed */
  uint8_t next_activity_time;
  /**<   \n Time value in seconds after which there will be data activity */
...
typedef struct {
  ...
  /**<   Indicates whether SPLMN is valid. If SPLMN is enabled,
...
typedef struct {
  ...
  /**<   Indicates whether the APN rate control applies
       to the MO exception.
  */
  ...
  */
  ...
  /**<   Indicate whether the APN rate control has been exceeded
...
typedef struct {
  ...
  /*  PLMN ID */
  uint8_t plmn_id[QMI_WDS_PLMN_ID_MAX_V01];
  /**<   The current registered PLMN ID that got rejected
       during the attach.
  */
  ...
  */
  ...
  /* Optional */
  /*  Primary PLMN */
  uint8_t primary_plmn_id_valid;  /**< Must be set to true if primary_plmn_id is being passed */
  uint8_t primary_plmn_id[QMI_WDS_PLMN_ID_MAX_V01];
  /**<   Primary PLMN for shared network.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether uplink data prioritization is enabled.
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Retrieves information of the packet data connection. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Retrieves information of the packet data connection. */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Requests the modem to allocate a PDU session ID. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wds_allocate_pdu_session_id_req_msg_v01;
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Requests the modem to allocate a PDU session ID. */
typedef struct {
  ...
  /* Optional */
  /*  PDU Session ID */
  uint8_t pdu_session_id_valid;  /**< Must be set to true if pdu_session_id is being passed */
  uint8_t pdu_session_id;
  /**<   PDU session ID.
  */
}wds_allocate_pdu_session_id_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Sets the WWAN PDU session ID during handoff. */
typedef struct {
  ...
  /**<   PDU session ID.
  */
}wds_set_handoff_wwan_pdu_session_id_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Sets the WWAN PDU session ID during handoff. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}wds_set_handoff_wwan_pdu_session_id_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Frees the PDU session ID. */
typedef struct {
  ...
  /**<   PDU session ID.
  */
}wds_free_pdu_session_id_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Frees the PDU session ID. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}wds_free_pdu_session_id_resp_msg_v01;  /* Message */
/**
    @}
  */

typedef uint64_t wds_v2x_file_source_mask_v01;
#define WDS_V2X_FILE_SOURCE_UNSPECIFIED_V01 ((wds_v2x_file_source_mask_v01)0x00ull) /**<  Source not specified  \n      */
#define WDS_V2X_FILE_SOURCE_PRECONFIG_V01 ((wds_v2x_file_source_mask_v01)0x01ull) /**<  Preconfigured on the modem \n      */
#define WDS_V2X_FILE_SOURCE_SIM_V01 ((wds_v2x_file_source_mask_v01)0x02ull) /**<  SIM card       \n             */
#define WDS_V2X_FILE_SOURCE_OMA_DM_V01 ((wds_v2x_file_source_mask_v01)0x04ull) /**<  OMA-DM                        */
/** @addtogroup wds_qmi_enums
    @{
  */
typedef enum {
  WDS_V2X_CONFIG_FILE_OPER_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WDS_V2X_CONFIG_FILE_OPER_CHANGED_V01 = 0x00, /**<  Configuration file changed (Default)  */
  WDS_V2X_CONFIG_FILE_OPER_EXPIRED_V01 = 0x01, /**<  Configuration file expired      */
  WDS_V2X_CONFIG_FILE_OPER_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wds_v2x_config_file_oper_enum_v01;
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates when the V2X configuration file has changed on the modem. */
typedef struct {

  /* Mandatory */
  /*  File Source */
  wds_v2x_file_source_mask_v01 file_source;
  /**<   Indicates where the V2X configuration file is provided from.
 It can be provided from more than one source.
 Values: \n
      - WDS_V2X_FILE_SOURCE_UNSPECIFIED (0x00) --  Source not specified  \n
      - WDS_V2X_FILE_SOURCE_PRECONFIG (0x01) --  Preconfigured on the modem \n
      - WDS_V2X_FILE_SOURCE_SIM (0x02) --  SIM card       \n
      - WDS_V2X_FILE_SOURCE_OMA_DM (0x04) --  OMA-DM
 */
 ...
 */
  ...
  wds_v2x_config_file_oper_enum_v01 operation;
  /**<   Values: \n
      - WDS_V2X_CONFIG_FILE_OPER_CHANGED (0x00) --  Configuration file changed (Default)
      - WDS_V2X_CONFIG_FILE_OPER_EXPIRED (0x01) --  Configuration file expired
 */
}wds_v2x_config_changed_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Retrieves the V2X configuration file from the modem. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wds_v2x_get_config_file_req_msg_v01;
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Retrieves the V2X configuration file from the modem. */
typedef struct {
  ...
  uint8_t tx_id;
  /**<   Transaction ID; starts at 1. */
}wds_v2x_get_config_file_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Sends the V2X configuration file to the registered control point. */
typedef struct {
 ...
 */
  ...
  /* Optional */
  /*  Configuration File Content */
  uint8_t cfg_file_content_valid;  /**< Must be set to true if cfg_file_content is being passed */
  uint32_t cfg_file_content_len;  /**< Must be set to # of elements in cfg_file_content */
  uint8_t cfg_file_content[QMI_WDS_V2X_CONFIG_FILE_CONTENT_MAX_V01];
  /**<   Byte array for configuration file content. */
}wds_v2x_config_file_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Query for EMBMS Tuneaway Information. */
typedef struct {
  ...
  /**<   eMBMS transaction ID for the request.
  */
}wds_embms_get_tuneaway_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Query for EMBMS Tuneaway Information. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}wds_embms_get_tuneaway_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates EMBMS Tuneaway Counter information. */
typedef struct {

  /* Mandatory */
  /*  Transction Information */
  uint32_t tx_id;
  /**<   eMBMS transaction ID that was sent in the corresponding
        QMI_WDS_EMBMS_GET_TUNEAWAY_INFO request.
  */

  /* Optional */
  /*  Tuneaway Data List */
  uint8_t list_valid;  /**< Must be set to true if list is being passed */
  uint32_t list_len;  /**< Must be set to # of elements in list */
  wds_tuneaway_data_info_type_v01 list[QMI_WDS_EMBMS_TA_DATA_LIST_MAX_V01];
}wds_embms_tuneaway_info_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_WDS_ALLOCATE_PDU_SESSION_ID_V01
...
//#define REMOVE_QMI_WDS_EMBMS_GET_TUNEAWAY_INFO_V01
...
//#define REMOVE_QMI_WDS_EMBMS_TUNEAWAY_INFO_IND_V01
...
//#define REMOVE_QMI_WDS_FREE_PDU_SESSION_ID_V01
...
//#define REMOVE_QMI_WDS_SET_HANDOFF_WWAN_PDU_SESSION_ID_V01
...
//#define REMOVE_QMI_WDS_V2X_CONFIG_CHANGED_IND_V01
//#define REMOVE_QMI_WDS_V2X_CONFIG_FILE_IND_V01
//#define REMOVE_QMI_WDS_V2X_GET_CAPABILITY_INFO_V01
//#define REMOVE_QMI_WDS_V2X_GET_CONFIG_FILE_V01
...
#define QMI_WDS_ALLOCATE_PDU_SESSION_ID_REQ_V01 0x0106
#define QMI_WDS_ALLOCATE_PDU_SESSION_ID_RESP_V01 0x0106
#define QMI_WDS_SET_HANDOFF_WWAN_PDU_SESSION_ID_REQ_V01 0x0107
#define QMI_WDS_SET_HANDOFF_WWAN_PDU_SESSION_ID_RESP_V01 0x0107
#define QMI_WDS_FREE_PDU_SESSION_ID_REQ_V01 0x0108
#define QMI_WDS_FREE_PDU_SESSION_ID_RESP_V01 0x0108
#define QMI_WDS_V2X_CONFIG_CHANGED_IND_V01 0x0109
#define QMI_WDS_V2X_GET_CONFIG_FILE_REQ_V01 0x010A
#define QMI_WDS_V2X_GET_CONFIG_FILE_RESP_V01 0x010A
#define QMI_WDS_V2X_CONFIG_FILE_IND_V01 0x010B
#define QMI_WDS_EMBMS_GET_TUNEAWAY_INFO_REQ_V01 0x010C
#define QMI_WDS_EMBMS_GET_TUNEAWAY_INFO_RESP_V01 0x010C
#define QMI_WDS_EMBMS_TUNEAWAY_INFO_IND_V01 0x010C
