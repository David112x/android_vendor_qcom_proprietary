...
ifeq ($(call is-board-platform-in-list,msm8996 msm8937 msm8953 msm8998 apq8098_latv sdm660 sdm845 sdm710 qcs605 sdmshrike msmnile $(MSMSTEPPE) $(TRINKET) kona lito bengal),true)
...
#ifeq ($(call is-board-platform-in-list,msmnile sdmshrike $(MSMSTEPPE) kona lito),true)
...
ifeq ($(call is-board-platform-in-list,msmnile sdmshrike $(MSMSTEPPE) $(TRINKET) kona lito bengal),true)
