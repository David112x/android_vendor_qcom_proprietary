...
ifeq ($(call is-board-platform-in-list,msm8960 msm8974 msm8226 msm8610 apq8084 msm8994 msm8992 msm8916 msm8909 msm8996 msm8952 msm8937 thorium msm8953 msmgold msm8998 apq8098_latv sdm450 sdm660 sdm845 sdm710 qcs605 sdmshrike msmnile $(MSMSTEPPE) $(TRINKET) kona lito bengal),true)
...
ifeq ($(call is-board-platform-in-list,kona lito atoll bengal),true)
...
include $(CLEAR_VARS)
LOCAL_MODULE       := ftm_test_config_lito-lagoonmtp-snd-card
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_OWNER := qti
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES    := config/lito/ftm_test_config_lito-lagoonmtp-snd-card
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := ftm_test_config_lito-lagoonqrd-snd-card
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_OWNER := qti
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES    := config/lito/ftm_test_config_lito-lagoonqrd-snd-card
include $(BUILD_PREBUILT)
endif
...
include $(CLEAR_VARS)
LOCAL_MODULE       := ftm_test_config_bengal-scubaidp-snd-card
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_OWNER := qti
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES    := config/bengal/ftm_test_config_bengal-scubaidp-snd-card
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := ftm_test_config_bengal-scubaqrd-snd-card
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_OWNER := qti
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES    := config/bengal/ftm_test_config_bengal-scubaqrd-snd-card
include $(BUILD_PREBUILT)
endif
