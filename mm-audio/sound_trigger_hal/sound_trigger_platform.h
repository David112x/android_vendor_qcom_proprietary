...
#define platform_stdev_ext_hw_plugin_usecase_start(a, b, c) (0)
#define platform_stdev_ext_hw_plugin_usecase_stop(a) (0)
#define platform_stdev_ext_hw_plugin_init(a) (0)
#define platform_stdev_ext_hw_plugin_deinit(a) (0)
#else
...
void* platform_stdev_ext_hw_plugin_init
(
    struct sound_trigger_device *stdev
);
int platform_stdev_ext_hw_plugin_deinit
(
    void *plugin
);
#endif
