...
public class PermissionsUtil {
    ...
    public static boolean hasPermissions(Context context) {
        String[] permissions = getPermissions(context.getPackageManager());
    ...
    public static String[] getPermissions(PackageManager packageManager) {
    ...
    public static String[] getRequireGrantPermissions(Context context){
        final ArrayList<String> unsatisfiedPermissions = new ArrayList<>();
        for (String permission : getPermissions(context.getPackageManager())) {
            if (!hasPermission(context, permission)) {
