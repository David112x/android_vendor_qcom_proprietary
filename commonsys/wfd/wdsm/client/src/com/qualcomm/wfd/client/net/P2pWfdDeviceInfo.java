...
public class P2pWfdDeviceInfo {
    ...
    public P2pWfdDeviceInfo() {
        ...
        wfdR2DeviceInfo = DEVICETYPE_INVALID;
    };
    ...
    public P2pWfdDeviceInfo(String wfdSubelems) throws IllegalArgumentException {
        ...
        Log.e(TAG, "Received elements " + wfdSubelems);
        int val = 0;
        ...
        if (wfdSubelems.length() > 6) {//first octet is identifier
            ...
            coupledSinkStatus = NOT_COUPLED_AVAILABLE;
            if (wfdSubelems.length() > 16) {//R2 Info Present
                Log.e(TAG, "R2 Subelem info present");
                wfdR2DeviceInfo = (Integer.parseInt(wfdSubelems.substring(16,20),16));
            }
        }
    ...
    /* WFD R2 device information*/
    public int wfdR2DeviceInfo;
 ...
 /** Mac Address of intended Address */
    ...
    public P2pWfdDeviceInfo(P2pWfdDeviceInfo source) {
        if (source != null) {
            ...
            wfdR2DeviceInfo = source.wfdR2DeviceInfo;
    ...
    public String toString() {
        ...
        if(wfdR2DeviceInfo != WFDR2DeviceType.R2_UNSUPPORTED.getCode())
            sbuf.append("\n WFD R2 Device Info: ").append(wfdR2DeviceInfo);
