    ...
    * underlying WFD service is a single state machine
    ...
    private WfdDevice createWFDDevice(String iface, WfdEnums.WFDDeviceType type) {
        ...
        if (type == WfdEnums.WFDDeviceType.SOURCE) {
            ...
            Log.d(TAG, "WFDR2SourceInfo is: " + WFDR2Info);
            if(WFDR2Info==0 || WFDR2Info==1){
                wfdDevice.extSupport = 0;
            }
            else if(WFDR2Info==2 || WFDR2Info==3){
            ...
            Log.d(TAG, "WFDR2SinkInfo is: " + WFDR2Info);
            if(WFDR2Info==0 || WFDR2Info==2){
                wfdDevice.extSupport = 0;
            }
            else if(WFDR2Info==1 || WFDR2Info==3){
                wfdDevice.extSupport = 1;
            }
