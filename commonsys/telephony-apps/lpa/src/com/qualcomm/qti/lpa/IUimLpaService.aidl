...
int uimLpaSetSrvAddr(in int slot, in int token, in String smdp);
    ...
    /**
     * uimLpaConfirmationcodeReq request to send Confirmation Code
     *
     * @param slot
     *    UIM_LPA_SLOT0  = 0;
     *    UIM_LPA_SLOT1  = 1;
     ...
     *    UIM_LPA_ERROR         = 1;
     */
    int uimLpaConfirmationcodeReq(in int slot, in int token, in String confirmationCode);

    /**
     * uimLpaUserConsent_1_1 request to send user consent with nok_reason
     *
     * @param slot
     *    UIM_LPA_SLOT0  = 0;
     *    UIM_LPA_SLOT1  = 1;
     ...
     *
     *    nok_reason
     *    UIM_LPA_PROFILE_END_USER_REJECTED  = 0;
     *    UIM_LPA_PROFILE_END_USER_POSTPONED = 1;
     *
     * @return
     *    UIM_LPA_USER_NOT_OK  = 0;
     *    UIM_LPA_USER_OK      = 1;
     */
    int uimLpaUserConsent_1_1(in int slot, in int token, in boolean userOk ,in int nok_reason);
}
