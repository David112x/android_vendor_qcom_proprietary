...
public class MessageId {
     ...
     * MsgType: REQUEST
     *
     * Description:Request to dial call composer call
     */
    ...
    /**
     * UNSOL_RETRIEVE_GEO_LOCATION_DATA_STATUS
     *
     * MsgType: INDICATION
     *
     * Description: Indication if modem is unable to go forward to register over IMS
     * due to inability to get the geo location infomration which is required for VoWiFi
     * registration for specific operators.
     *
     */

    public static final int UNSOL_RETRIEVE_GEO_LOCATION_DATA_STATUS = 233;
     /**
     *  UNSOL_AUTO_CALL_COMPOSER_CALL_REJECTION_IND
     *
     * MsgType: INDICATION
     *
     * Description: Indication of auto call rejections with call composer elements.
     *
     */
     public static final int UNSOL_AUTO_CALL_COMPOSER_CALL_REJECTION_IND = 234;

    /**
     * UNSOL_CALL_COMPOSER_INFO_AVAILABLE_IND
     *
     * MsgType: INDICATION
     *
     * Description: Indication of call composer elements
     *
     */
     public static final int UNSOL_CALL_COMPOSER_INFO_AVAILABLE_IND = 235;
}
