...
public class ImsServiceSub extends MmTelFeature
    ...
    private final int EVENT_GEO_LOCATION_DATA_STATUS = 40;
    ...
    private static int convertQtiImsTransferTypeToImsQmiType(int type) {
        switch(type) {
    ...
    private void handleCallComposer(AsyncResult ar) {
        if ((ar != null) && (ar.exception == null) && (ar.result != null)) {
            final Bundle b = (Bundle) ar.result;
            if (mTracker != null) {
                mTracker.onCallComposerDataAvailable(b);
            }
        } else {
    ...
    private void handleCallAutoReject(AsyncResult ar) {
        ...
        if (ccInfo != null) {
            Bundle ccBundle = CallComposerInfoUtils.toBundle(ccInfo, mPhoneId,
                    CallComposerInfo.INVALID_CALLID);
        ...
        rejectedCall.callDetails.call_type, extras, new ImsStreamMediaProfile());
