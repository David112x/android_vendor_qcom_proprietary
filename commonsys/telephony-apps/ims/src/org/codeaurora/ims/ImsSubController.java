/*
 * Copyright (c) 2015-2016, 2019-2020 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
public class ImsSubController implements ImsSenderRxr.ImsRadioServiceListener {
            ...
            try {
                switch (msg.what) {
                    ...
                    case EVENT_IMS_SERVICE_UP:
                        ...
                        if (mTm != null && mTm.getPhoneCount() > 1) {
                            registerSubConfigChanged(phoneId);
                        } else {
    ...
    private void registerSubConfigChanged(int phoneId) {
