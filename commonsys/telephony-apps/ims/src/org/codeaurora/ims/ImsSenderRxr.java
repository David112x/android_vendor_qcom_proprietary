...
public class ImsSenderRxr extends ImsPhoneBaseCommands {
    ...
    class ImsRadioIndication extends vendor.qti.hardware.radio.ims.V1_6.IImsRadioIndication.Stub {
        ...
        public void onIncomingCallComposerCallAutoRejected(
            ...
            if (callComposerInfo == null) {
                Log.e(this, "onIncomingCallComposerCallAutoRejected: callComposerInfo is null");
            ...
            Log.v(this, "onIncomingCallComposerCallAutoRejected :: Call auto rejected from : "
                    + rejectInfo.number);
        ...
        */
        ...
        public void onCallComposerInfoAvailable(
            ...
            Bundle extra = CallComposerInfoUtils.toBundle(info, mPhoneId,
                    callComposerInfo.callId);
            mCallComposerInfoRegistrants.notifyRegistrants(new AsyncResult(null, extra, null));
        }
        ...
        public void onRetrievingGeoLocationDataStatus(int geoLocationDataStatus) {
            ...
            if (mGeoLocationDataStatusRegistrants != null) {
                mGeoLocationDataStatusRegistrants.notifyRegistrants(new AsyncResult(null,
                        ImsRadioUtilsV16.geoLocationDataStatusFromHal(geoLocationDataStatus),
                        null));
            }
        }
    }
    ...
    dial(String address, EmergencyCallInfo eInfo, int clirMode, CallDetails callDetails,
        ...
        dial(address, eInfo, clirMode, callDetails, isEncrypted, null, result);
    }

    public void
    dial(String address, EmergencyCallInfo eInfo, int clirMode, CallDetails callDetails,
            boolean isEncrypted, CallComposerInfo ccInfo, Message result) {
        ...
        } else if (ccInfo != null && imsRadioV16() != null) {
