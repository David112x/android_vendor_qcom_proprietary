...
public class ImsCallSessionImpl extends ImsCallSessionImplBase {
    ...
    private void updateImsCallProfile(DriverCallIms dc) {
        ...
        if (verstatInfo != null) {
            mCallProfile = ImsCallUtils.toImsCallProfile(verstatInfo, mCallProfile);
    ...
    public void start(String callee, ImsCallProfile profile) {
        ...
        if (SystemProperties.getInt(PROPERTY_DBG_ENCRYPTION_OVERRIDE,
            ...
            if (callExtras != null) {
                ...
                if(callExtras.containsKey(QtiCallConstants.EXTRA_CALL_COMPOSER_INFO)) {
                    composerInfo = CallComposerInfoUtils.buildCallComposerInfo(callExtras);
                }
            }
        }
