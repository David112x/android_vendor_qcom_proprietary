...
import com.qualcomm.qti.uceservice.V2_2.IOptionsListener;
...
public class OptionsListener extends IOptionsListener.Stub
{
    ...
    public void sipResponseReceived_2_2 (String uri, OptionsSipResponse sipResponse,
                com.qualcomm.qti.uceservice.V2_2.OptionsCapabilityInfo capInfo)
                throws RemoteException {
        OptionsListenerRunnable runnable = new OptionsListenerRunnable();
        translateToAidlObj = new HidlToAidlTranslator();
        ...
        runnable.m_cdSipResponse = new com.android.ims.internal.uce.options.OptionsSipResponse();
        runnable.m_CDCapInfo = new com.android.ims.internal.uce.options.OptionsCapInfo();
        runnable.m_cdSipResponse = translateToAidlObj.getAidlOptionsSipResponse(sipResponse);
        runnable.m_CDCapInfo = translateToAidlObj.getAidlOptionsCapInfo_2_2(capInfo);
        runnable.methodName = "sipResponseReceived";
    ...
    public void cmdStatus_2_2(com.qualcomm.qti.uceservice.V2_2.OptionsCmdStatus CdCMDStatus) {
        OptionsListenerRunnable runnable = new OptionsListenerRunnable();
        translateToAidlObj = new HidlToAidlTranslator();

        runnable.mAidlOptionsListener = mAidlOptionsServiceListener;
        runnable.m_CdCMDStatus = new com.android.ims.internal.uce.options.OptionsCmdStatus();
        runnable.m_CdCMDStatus = translateToAidlObj.getAidlOptionsCmdStatus_2_2(CdCMDStatus);
        runnable.methodName = "cmdStatus";
    ...
    public void incomingOptions_2_2(String sUri,
                                com.qualcomm.qti.uceservice.V2_2.OptionsCapabilityInfo CDCapInfo,
                                short tID) {
        OptionsListenerRunnable runnable = new OptionsListenerRunnable();
        translateToAidlObj = new HidlToAidlTranslator();
        ...
        runnable.m_tID = (int)tID;
        runnable.m_CDCapInfo = new com.android.ims.internal.uce.options.OptionsCapInfo();
        runnable.m_CDCapInfo = translateToAidlObj.getAidlOptionsCapInfo_2_2(CDCapInfo);
        runnable.methodName = "incomingOptions";
