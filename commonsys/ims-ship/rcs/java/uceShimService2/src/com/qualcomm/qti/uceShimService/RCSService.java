...
public class RCSService extends Service {
    ...
    public static com.qualcomm.qti.uceservice.V2_2.IUceService mHidlService_2_2 = null;
   ...
   private Handler mHandler;
    ...
    private IHwBinder.DeathRecipient mDeathRecipient = new IHwBinder.DeathRecipient() {
        ...
        public void serviceDied(long cookie) {
            ...
            if (cookie == mDeathBinderCookie) {
                try {
                    if (mHidlService_2_2 != null) {
                        mHidlService_2_2.unlinkToDeath(mDeathRecipient);
                    } else if (mHidlService_2_1 != null) {
    ...
    synchronized private void startService() {
        if (!isServiceStarted) {
            Log.i(logTAG, "Attempting to get HIDL-IUceService V2_2");
            try {
                mHidlService_2_2 = com.qualcomm.qti.uceservice.V2_2.IUceService.getService(
            ...
            if(mHidlService_2_2 != null) {
                ...
                Log.i(logTAG, "Received HIDL-UCEService V2_2");
                if (objQRCSServiceStub != null && objQRCSServiceStub.setHidlUceSerice(mHidlService_2_2)) {
                    try {
                        mHidlService_2_2.addUceListener(mHidlUceListener);
                    ...
                    try{
                        ...
                        boolean isLinkSuccesful= mHidlService_2_2.linkToDeath(mDeathRecipient,
                                                                     mDeathBinderCookie);
    ...
    BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(INTENT_SIM_STATE_CHANGED_STR)) {
                ...
                if (objQRCSServiceStub != null && (subId != -1) &&
                    (objQRCSServiceStub.getDefaultSubId() != -1) &&
                    (subId != objQRCSServiceStub.getDefaultSubId())) {
                     Log.d(logTAG, "SIM State Changed Event Received for non default subId ["+subId+"], ignoring");
                     return;
                }
                Log.d(logTAG, "SIM State Changed Event Received for subId ["+subId+"]");
