...
public class RCSServiceStub extends UceServiceBase { //extend AIDL- IUCEService
    ...
    private com.qualcomm.qti.uceservice.V2_2.IUceService mhidlUceService_2_2 = null;
    ...
    public boolean setHidlUceSerice(com.qualcomm.qti.uceservice.V2_2.IUceService hidlService) {
        mhidlUceService_2_2 = hidlService;
        return (getDefaultIccId());
    }
    ...
    private boolean getDefaultIccId() {
        ...
        if (defaultSubInfo != null) {
            ...
            Log.i(logTAG, "getDefaultIccId default mIccId [" + mIccId +"] mDefaultSubId [" +mDefaultSubId+"]");
            retval = true;
        }
    ...
    protected int onCreateOptionsService(IOptionsListener optionsListener,
       ...
       try {
           if (mhidlUceService_2_2 != null) {
               hidlUceStatus = mhidlUceService_2_2.createOptionsService(hidlOptionLister,
                                                                hidlOptionsSrvcListenerHdl,
                                                                iccId);
           } else if (mhidlUceService_2_1 != null) {
    ...
    protected void onDestroyOptionsService(int optionsServiceHandle) {
        ...
        try {
            if (mhidlUceService_2_2 != null) {
                mhidlUceService_2_2.destroyOptionsService(optionsServiceHandle);
            } else if (mhidlUceService_2_1 != null) {
    ...
    protected int onCreatePresService(IPresenceListener presServiceListener,
        ...
        try {
            if (mhidlUceService_2_2 != null) {
                Log.d(logTAG, "createPresenceService_2_2");
                hidlUceStatus = mhidlUceService_2_2.createPresenceService_2_2(hidlPresListener,
    ...
    protected void onDestroyPresService(int pPresServiceHdl) {
        ...
        try {
            if (mhidlUceService_2_2 != null) {
                mhidlUceService_2_2.destroyPresenceService(pPresServiceHdl);
            } else if (mhidlUceService_2_1 != null) {
    ...
    private class OptionsListenerDeathRecipient implements IBinder.DeathRecipient{
        ...
        public void binderDied(){
            ...
            try{
                if (serviceHandle != 0){
                    if (mhidlUceService_2_2 != null) {
                        mhidlUceService_2_2.destroyOptionsService(serviceHandle);
                    } else if (mhidlUceService_2_1 != null) {
    ...
    private class PresenceListenerDeathRecipient implements IBinder.DeathRecipient{
        ...
        public void binderDied(){
            ...
            try{
                if (serviceHandle != 0){
                    if (mhidlUceService_2_2 != null) {
                        mhidlUceService_2_2.destroyPresenceService(serviceHandle);
                    } else if (mhidlUceService_2_1 != null) {
