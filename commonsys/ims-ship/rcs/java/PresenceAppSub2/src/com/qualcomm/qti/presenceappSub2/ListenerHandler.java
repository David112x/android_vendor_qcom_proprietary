            ...
            Runnable show_UI = new Runnable()
            {
                public void run()
                {
                    try
                    {
                        ...
                        boolean m_networkType5GNR = ContactInfo.networkType5GNR;
                        boolean m_vopsEnabled5GNR = ContactInfo.vopsEnabled5GNR;
                        ...
                        ContactInfo.networkType5GNR = false;
                        ContactInfo.vopsEnabled5GNR = false;
                        ...
                        switch (publishTrigger.getPublishTrigeerType()) {
                            case PresPublishTriggerType.UCE_PRES_PUBLISH_TRIGGER_ETAG_EXPIRED: {
                                ...
                                ContactInfo.networkType5GNR = m_networkType5GNR;
                                ContactInfo.vopsEnabled5GNR = m_vopsEnabled5GNR;
                            ...
                            case PresPublishTriggerType.UCE_PRES_PUBLISH_TRIGGER_MOVE_TO_NR5G_VOPS_ENABLED:
                            {
                                ...
                                Log.d(TAG, "Status is CLOSED");
                                ContactInfo.networkType5GNR = true;
                                ContactInfo.vopsEnabled5GNR = true;
                                ContactInfo.networkTypeLTE = false;
                                ContactInfo.vopsEnabled = true;
                                ContactInfo.networkTypeEHRPD = false;
                                ContactInfo.networkType5GNR = true;
            ...
            switch (msg.what) {
                ...
                case PRESENCE_IMS_UNSOL_PUBLISH_TRIGGER:
                {
                    ...
                    switch (val.getPublishTrigeerType())
                    {
                        ...
                        case PresPublishTriggerType.UCE_PRES_PUBLISH_TRIGGER_MOVE_TO_NR5G_VOPS_ENABLED:
                        {
                            Log.d(TAG, "IMSP_RAT_CHANGE_NR5G");
                            Toast.makeText(mContext,
                                    "Publish trigger for IMSP_RAT_CHANGE_NR5G_VOPS_ENABLED",
                                    Toast.LENGTH_SHORT).show();
                            ContactInfo.networkType5GNR = true;
                            ContactInfo.vopsEnabled5GNR = true;
                            ContactInfo.networkTypeLTE = true;
                        ...
                        {
                            Toast.makeText(mContext,
                                    "Publish trigger for IMSP_RAT_CHANGE_NR5G_VOPS_DISABLED",
                                    Toast.LENGTH_SHORT).show();
                            ContactInfo.networkType5GNR = true;
                            ContactInfo.vopsEnabled5GNR = false;
                            ContactInfo.networkTypeLTE = true;
