...
public class SecureCamera2API {
    ...
    private static boolean dualstreamsupported = false;
    ...
    public Boolean stop() {
        ...
        if (null != secureCamera2Surface_) {
            Log.d(cameraActivity_.getLogTag(), "SecureCamera2API::stop - Camera #" + cameraId_ + ": Release test1 Secure Camera Surface");
            if (dualstreamsupported || (previewSurfaceView_ == null)) {
