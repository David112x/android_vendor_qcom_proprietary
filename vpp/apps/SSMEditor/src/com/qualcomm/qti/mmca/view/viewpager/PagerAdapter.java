...
package com.qualcomm.qti.mmca.view.viewpager;
...
public abstract class PagerAdapter {
     ...
     *
     * @param container The containing View in which the page will be shown. Should not be null.
     ...
     *
     * @param container The containing View from which the page will be removed. Should not be null.
     * @param position The page position to be removed.
     * @param object The same object that was returned by. Should not be null.
     ...
     *
     * @param view Page View to check for association with <code>object</code>. Should not be null.
     * @param object Object to check for association with <code>view</code>. Should not be null.
     ...
     *               {@link #instantiateItem(View, int)}. Should not be null.
