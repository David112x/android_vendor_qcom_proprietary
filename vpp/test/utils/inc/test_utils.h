...
struct test_ctx {
    ...
    void *pPrivateCtx;
    struct vpp_port_param port_param;       // can be used for both input and output if the same
    struct vpp_port_param port_param_out;   // if test needs a different output configuration
    t_StVppCallback cb;
