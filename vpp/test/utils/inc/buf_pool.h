...
#define INPUT_FILEPATH_TEMPLATE "/data/vendor/vpp/input/"
#define OUTPUT_FILEPATH_TEMPLATE "/data/vendor/vpp/output/"
...
enum buffer_format {
    ...
    /*! BGRA8888, no padding */
    FILE_FORMAT_BGRA8,
    /*! RGBA8888 compressed, UBWC format */
    FILE_FORMAT_RGBA8_UBWC,
    /*! BGRA8888 compressed, UBWC format */
    FILE_FORMAT_BGRA8_UBWC,
    /*! RGB565 compressed, UBWC format */
    FILE_FORMAT_RGB565_UBWC,
    /*! BGR565 compressed, UBWC format */
    FILE_FORMAT_BGR565_UBWC,
};
...
struct buf_pool_params {
    ...
    uint32_t bDisableExtraData;
    uint32_t bDisableGralloc;

    t_StMetaData stMetaData;
};
...
struct buf_pool {
    ...
    t_StVppIonBuf *pstIonMemMd; // ptr to array of ion buffer structures (meta data)
