...
////// Tuning parameters data buffer definition, which is identical to the one defined in HCP_HFI
/**
    * @struct     t_StSysTuneParam
    * @brief    Tuning parameters
    */
typedef struct vpp_svc_hdr_t vpp_svc_hdr_t;
struct vpp_svc_hdr_t {
   unsigned int u32Id;
   unsigned int u32Len;
};
typedef struct vpp_svc_systuneparam_t vpp_svc_systuneparam_t;
struct vpp_svc_systuneparam_t {
   vpp_svc_hdr_t hdr;
   unsigned int u32Bdy[1];
};
/**
    * @struct     t_StSysTune
    * @brief    Tuning parameters
    */
typedef struct vpp_svc_systune_t vpp_svc_systune_t;
struct vpp_svc_systune_t {
   unsigned int u32NumTuneParams;
   unsigned int u32Bdy[1];
};
/////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
...
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(vpp_svc_get_num_tuning_params)(remote_handle64 _h, unsigned int func_id, unsigned int* pNum) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(vpp_svc_get_tuning_params)(remote_handle64 _h, unsigned int func_id, unsigned char* pBuf, int pBufLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(vpp_svc_apply_tuning_params_frombuff)(remote_handle64 _h, unsigned int func_id, const unsigned int* pRawBuf, int pRawBufLen) __QAIC_HEADER_ATTRIBUTE;
