...
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(vpp_svc_prepare_ctx)(remote_handle64 _h, unsigned int frame_size_bytes, unsigned int flag, unsigned int size, unsigned int diag_size) __QAIC_HEADER_ATTRIBUTE;
