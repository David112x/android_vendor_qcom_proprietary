...
#define UIM_V01_IDL_MINOR_VERS 0x60
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x0075
/**
    @}
  */
...
#define QMI_UIM_PERSO_NUM_LOCK_CODES_MAX_V01 255
...
typedef struct {
  ...
  uim_perso_feature_enum_v01 feature[QMI_UIM_PERSO_FEATURE_MAX_V01];
}uim_perso_ever_locked_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Is perso ever locked */
  uint8_t is_perso_ever_locked_valid;  /**< Must be set to true if is_perso_ever_locked is being passed */
  uint32_t is_perso_ever_locked_len;  /**< Must be set to # of elements in is_perso_ever_locked */
  uim_perso_ever_locked_type_v01 is_perso_ever_locked[QMI_UIM_EXTENDED_CARDS_MAX_V01];
  /**<   Indicates whether the device was ever perso locked.
       Valid values:\n
         - 0 -- Device never perso locked \n
         - 1 -- Device perso locked now or was locked earlier
     If this TLV is not present then perso was NOT locked ever.
     If TLV is present then the list of features in the TLV are the features that were ever perso locked.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   \n Extended card status containing information about the logical state.\n
       In the existing TLV, only the card physical status was provided.
       Here the logical error state is captured whenever applicable when the card is present.
  */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_LOCK_CODE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_LOCK_CODE_TYPE_WHITELIST_V01 = 0x00, /**<  lock code type whitelist.\n  */
  UIM_LOCK_CODE_TYPE_BLACKLIST_V01 = 0x01, /**<  lock code type blacklist.  */
  UIM_LOCK_CODE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_lock_code_type_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t slot_valid;  /**< Must be set to true if slot is being passed */
  uim_slot_enum_v01 slot;
  /**<   Indicates the slot to use. Valid values:\n
      - UIM_SLOT_1 (0x01) --  Slot 1 \n 
      - UIM_SLOT_2 (0x02) --  Slot 2 \n 
      - UIM_SLOT_3 (0x03) --  Slot 3 \n 
      - UIM_SLOT_4 (0x04) --  Slot 4 \n 
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Lock Code type */
  uint8_t code_type_valid;  /**< Must be set to true if code_type is being passed */
  uim_lock_code_type_v01 code_type;
  /**<   Indicates if lock codes need to be added in whitelist/blacklist.
 Valid values:\n
      - UIM_LOCK_CODE_TYPE_WHITELIST (0x00) --  lock code type whitelist.\n 
      - UIM_LOCK_CODE_TYPE_BLACKLIST (0x01) --  lock code type blacklist. 
 */

  /* Optional */
  /*  GW Network Personalization with support for 255 lock codes */
  uint8_t feature_gw_network_ext_perso_valid;  /**< Must be set to true if feature_gw_network_ext_perso is being passed */
  uint32_t feature_gw_network_ext_perso_len;  /**< Must be set to # of elements in feature_gw_network_ext_perso */
  uim_network_perso_type_v01 feature_gw_network_ext_perso[QMI_UIM_PERSO_NUM_LOCK_CODES_MAX_V01];

  /* Optional */
  /*  GW Network Subset Personalization with support for 255 lock codes */
  uint8_t feature_gw_network_subset_ext_perso_valid;  /**< Must be set to true if feature_gw_network_subset_ext_perso is being passed */
  uint32_t feature_gw_network_subset_ext_perso_len;  /**< Must be set to # of elements in feature_gw_network_subset_ext_perso */
  uim_gw_network_subset_perso_type_v01 feature_gw_network_subset_ext_perso[QMI_UIM_PERSO_NUM_LOCK_CODES_MAX_V01];

  /* Optional */
  /*  GW Service Provider Personalization with 8 bytes GID and support for 255 lock codes */
  uint8_t feature_gw_sp_ext_v5_perso_valid;  /**< Must be set to true if feature_gw_sp_ext_v5_perso is being passed */
  uint32_t feature_gw_sp_ext_v5_perso_len;  /**< Must be set to # of elements in feature_gw_sp_ext_v5_perso */
  uim_gw_sp_ext2_perso_type_v01 feature_gw_sp_ext_v5_perso[QMI_UIM_PERSO_NUM_LOCK_CODES_MAX_V01];

  /* Optional */
  /*  GW Corporate Personalization with 8 bytes GID and support for 255 lock codes */
  uint8_t feature_gw_corporate_ext_v5_perso_valid;  /**< Must be set to true if feature_gw_corporate_ext_v5_perso is being passed */
  uint32_t feature_gw_corporate_ext_v5_perso_len;  /**< Must be set to # of elements in feature_gw_corporate_ext_v5_perso */
  uim_gw_corporate_ext2_perso_type_v01 feature_gw_corporate_ext_v5_perso[QMI_UIM_PERSO_NUM_LOCK_CODES_MAX_V01];
...
typedef enum {
   ...
   */
  UIM_PROFILE_CONFIRMATION_CODE_REQUIRED_V01 = 0x06, /**<  Confirmation code is required for processing
       with download/installation of profile.
   */
...
typedef enum {
   ...
   */
  UIM_DOWNLOAD_ERROR_CAUSE_END_USER_REJECTION_V01 = 0x07, /**<  Profile download error end user rejection \n
   */
  UIM_DOWNLOAD_ERROR_CAUSE_END_USER_POSTPONED_V01 = 0x08, /**<  Profile download error end user postponed
   */
 ...
 */
  ...
  /**<   Indicates the stage of profile download and install. Valid values:\n
      ...
      - UIM_PROFILE_CONFIRMATION_CODE_REQUIRED (0x06) --  Confirmation code is required for processing
       with download/installation of profile.
 ...
 */
  ...
  /**<   Indicates the cause of the download error. Valid values:\n
      ...
      - UIM_DOWNLOAD_ERROR_CAUSE_END_USER_REJECTION (0x07) --  Profile download error end user rejection \n
  
      - UIM_DOWNLOAD_ERROR_CAUSE_END_USER_POSTPONED (0x08) --  Profile download error end user postponed
 ...
 */
  ...
  */
  ...
  uint32_t profile_name_len;  /**< Must be set to # of elements in profile_name */
  char profile_name[QMI_UIM_EUICC_PROFILE_NAME_MAX_V01];
  /**<   \n Indicates the profile name for which confirmation code is requested.
       This TLV is only required when confirmation code need to be requested and
     profile name to be sent to the control point, with Profile Download Status
     set as UIM_PROFILE_CONFIRMATION_CODE_REQUIRED.
  */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_PROFILE_USER_NOK_REASON_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_PROFILE_END_USER_REJECTION_V01 = 0x00, /**<  End user rejected profile download operation \n  */
  UIM_PROFILE_END_USER_POSTPONED_V01 = 0x01, /**<  End user postoned profile download operation  */
  UIM_PROFILE_USER_NOK_REASON_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_profile_user_nok_reason_type_v01;
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  User Not OK reason */
  uint8_t nok_reason_valid;  /**< Must be set to true if nok_reason is being passed */
  uim_profile_user_nok_reason_type_v01 nok_reason;
  /**<   Indicates the reason for sending Not OK. Valid values:\n
      - UIM_PROFILE_END_USER_REJECTION (0x00) --  End user rejected profile download operation \n 
      - UIM_PROFILE_END_USER_POSTPONED (0x01) --  End user postoned profile download operation 
 */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Sends the eCall START/STOP command to the card. */
typedef struct {
 ...
 */
  ...
  /**<   Indicates the eCall command to send to the card. Valid values:\n
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Sends the eCall START/STOP command to the card. */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Sends the confirmation code provided by service provider. */
typedef struct {

  /* Mandatory */
  /*  Slot */
  uim_slot_enum_v01 slot;
  /**<   Indicates the slot for confirmation code. Valid values:\n
      - UIM_SLOT_1 (0x01) --  Slot 1 \n 
      - UIM_SLOT_2 (0x02) --  Slot 2 \n 
      - UIM_SLOT_3 (0x03) --  Slot 3 \n 
      - UIM_SLOT_4 (0x04) --  Slot 4 \n 
 ...
 */
  ...
  /**<   Indicates the confirmation code required for downloading
       the profile.
  */
}uim_profile_confirmation_code_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Sends the confirmation code provided by service provider. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:\n
       ...
       qmi_error_type  -- Error code. Possible error code values are described
                          ...
                          definition.
  */
}uim_profile_confirmation_code_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_UIM_PROFILE_CONFIRMATION_CODE_V01 
...
#define QMI_UIM_PROFILE_CONFIRMATION_CODE_REQ_V01 0x0075
#define QMI_UIM_PROFILE_CONFIRMATION_CODE_RESP_V01 0x0075
/**
    @}
  */
